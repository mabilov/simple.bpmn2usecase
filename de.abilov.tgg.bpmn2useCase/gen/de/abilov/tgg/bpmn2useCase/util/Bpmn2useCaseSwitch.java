...
public class Bpmn2useCaseSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case Bpmn2useCasePackage.FN2F: {
			FN2F fn2F = (FN2F) theEObject;
			T result = caseFN2F(fn2F);
			if (result == null)
				result = caseAbstractCorrespondence(fn2F);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case Bpmn2useCasePackage.GW2S: {
			GW2S gw2S = (GW2S) theEObject;
			T result = caseGW2S(gw2S);
			if (result == null)
				result = caseAbstractCorrespondence(gw2S);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>FN2F</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>FN2F</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFN2F(FN2F object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>GW2S</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>GW2S</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGW2S(GW2S object) {
		return null;
	}
