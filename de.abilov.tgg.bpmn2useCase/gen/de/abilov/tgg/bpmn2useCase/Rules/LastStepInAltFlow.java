...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Last Step In Alt Flow</b></em>'.
 * <!-- end-user-doc -->
 *
 *
 * @see de.abilov.tgg.bpmn2useCase.Rules.RulesPackage#getLastStepInAltFlow()
 * @model
 * @generated
 */
public interface LastStepInAltFlow extends EObject, AbstractRule {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model
	 * @generated
	 */
	boolean isAppropriate_FWD(Match match, de.abilov.bpmn.Process process, Gateway gw, Gateway gcw, FlowNode node,
			SequenceFlow sf);
	 ...
	 * @generated
	 */
	void registerObjectsToMatch_FWD(Match match, de.abilov.bpmn.Process process, Gateway gw, Gateway gcw, FlowNode node,
			SequenceFlow sf);
	 ...
	 * @generated
	 */
	CSP isAppropriate_solveCsp_FWD(Match match, de.abilov.bpmn.Process process, Gateway gw, Gateway gcw, FlowNode node,
			SequenceFlow sf);
	 ...
	 * @generated
	 */
	EObjectContainer isAppropriate_BWD_EMoflonEdge_158(EMoflonEdge _edge___hasContinue);
	 ...
	 * @generated
	 */
	EObjectContainer isAppropriate_BWD_EMoflonEdge_159(EMoflonEdge _edge___last);
