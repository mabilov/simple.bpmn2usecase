 ...
 * <ul>
 *   <li>{@link SimpleUseCase.impl.StepAlternativeImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link SimpleUseCase.impl.StepAlternativeImpl#getContinuation <em>Continuation</em>}</li>
 *   <li>{@link SimpleUseCase.impl.StepAlternativeImpl#get__hasContinue <em>has Continue</em>}</li>
 *   <li>{@link SimpleUseCase.impl.StepAlternativeImpl#getCondition <em>Condition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StepAlternativeImpl extends EObjectImpl implements StepAlternative {
	...
	protected EClass eStaticClass() {
		return SimpleUseCasePackage.Literals.STEP_ALTERNATIVE;
	}
			...
			if (ref != oldRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							SimpleUseCasePackage.STEP_ALTERNATIVE__REF, oldRef, ref));
			}
		}
		return ref;
	}
	...
	public void setRef(AlternativeFlow newRef) {
		...
		ref = newRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleUseCasePackage.STEP_ALTERNATIVE__REF, oldRef,
					ref));
	}
	...
	public Step getContinuation() {
		if (continuation != null && continuation.eIsProxy()) {
			...
			if (continuation != oldContinuation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							SimpleUseCasePackage.STEP_ALTERNATIVE__CONTINUATION, oldContinuation, continuation));
			}
		}
		return continuation;
	}
	...
	public void setContinuation(Step newContinuation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleUseCasePackage.STEP_ALTERNATIVE__CONTINUATION,
	...
	public ChoiceStep get__hasContinue() {
		if (__hasContinue != null && __hasContinue.eIsProxy()) {
			...
			if (__hasContinue != old__hasContinue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							SimpleUseCasePackage.STEP_ALTERNATIVE__HAS_CONTINUE, old__hasContinue, __hasContinue));
			}
		}
	...
	public void set__hasContinue(ChoiceStep new__hasContinue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleUseCasePackage.STEP_ALTERNATIVE__HAS_CONTINUE,
	...
	public void setCondition(String newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleUseCasePackage.STEP_ALTERNATIVE__CONDITION,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SimpleUseCasePackage.STEP_ALTERNATIVE__REF:
			if (resolve)
				return getRef();
			return basicGetRef();
		case SimpleUseCasePackage.STEP_ALTERNATIVE__CONTINUATION:
			if (resolve)
				return getContinuation();
			return basicGetContinuation();
		case SimpleUseCasePackage.STEP_ALTERNATIVE__HAS_CONTINUE:
			if (resolve)
				return get__hasContinue();
			return basicGet__hasContinue();
		case SimpleUseCasePackage.STEP_ALTERNATIVE__CONDITION:
			return getCondition();
		}
