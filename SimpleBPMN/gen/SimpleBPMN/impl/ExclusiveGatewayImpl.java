 ...
 * <ul>
 *   <li>{@link SimpleBPMN.impl.ExclusiveGatewayImpl#getDefault <em>Default</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExclusiveGatewayImpl extends GatewayImpl implements ExclusiveGateway {
	...
	protected EClass eStaticClass() {
		return SimpleBPMNPackage.Literals.EXCLUSIVE_GATEWAY;
	}
			...
			if (default_ != oldDefault) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							SimpleBPMNPackage.EXCLUSIVE_GATEWAY__DEFAULT, oldDefault, default_));
			}
		}
		return default_;
	}
	...
	public void setDefault(SequenceFlow newDefault) {
		...
		default_ = newDefault;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleBPMNPackage.EXCLUSIVE_GATEWAY__DEFAULT,
					oldDefault, default_));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SimpleBPMNPackage.EXCLUSIVE_GATEWAY__DEFAULT:
			if (resolve)
				return getDefault();
