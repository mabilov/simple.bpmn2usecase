 ...
 * <ul>
 *   <li>{@link de.abilov.bpmn.impl.FlowElementImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class FlowElementImpl extends EObjectImpl implements FlowElement {
	...
	protected EClass eStaticClass() {
		return BpmnPackage.Literals.FLOW_ELEMENT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BpmnPackage.FLOW_ELEMENT__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case BpmnPackage.FLOW_ELEMENT__ID:
			return getId();
		}
