 ...
 * <ul>
 *   <li>{@link de.abilov.useCase.impl.FlowImpl#getSteps <em>Steps</em>}</li>
 *   <li>{@link de.abilov.useCase.impl.FlowImpl#getFinalState <em>Final State</em>}</li>
 *   <li>{@link de.abilov.useCase.impl.FlowImpl#get__last <em>last</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class FlowImpl extends EObjectImpl implements Flow {
	...
	public EList<Step> getSteps() {
		if (steps == null) {
			steps = new EObjectContainmentEList<Step>(Step.class, this, UseCasePackage.FLOW__STEPS);
		}
		return steps;
	}
	...
	public NotificationChain basicSetFinalState(UCCondition newFinalState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					UseCasePackage.FLOW__FINAL_STATE, oldFinalState, newFinalState);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newFinalState != finalState) {
			...
			if (finalState != null)
				msgs = ((InternalEObject) finalState).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - UseCasePackage.FLOW__FINAL_STATE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, UseCasePackage.FLOW__FINAL_STATE, newFinalState,
					newFinalState));
	}
	...
	public Step get__last() {
		if (__last != null && __last.eIsProxy()) {
			...
			if (__last != old__last) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UseCasePackage.FLOW__LAST, old__last,
							__last));
			}
		}
		return __last;
	...
	public void set__last(Step new__last) {
		...
		__last = new__last;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UseCasePackage.FLOW__LAST, old__last, __last));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case UseCasePackage.FLOW__STEPS:
			return ((InternalEList<?>) getSteps()).basicRemove(otherEnd, msgs);
		case UseCasePackage.FLOW__FINAL_STATE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case UseCasePackage.FLOW__LAST:
			if (resolve)
				return get__last();
