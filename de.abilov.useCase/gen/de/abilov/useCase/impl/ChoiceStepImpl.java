 ...
 * <ul>
 *   <li>{@link de.abilov.useCase.impl.ChoiceStepImpl#getStepAlternatives <em>Step Alternatives</em>}</li>
 *   <li>{@link de.abilov.useCase.impl.ChoiceStepImpl#get__lastInDef <em>last In Def</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ChoiceStepImpl extends StepImpl implements ChoiceStep {
	...
	protected EClass eStaticClass() {
		return UseCasePackage.Literals.CHOICE_STEP;
	}
	...
	public EList<StepAlternative> getStepAlternatives() {
		if (stepAlternatives == null) {
			stepAlternatives = new EObjectContainmentEList<StepAlternative>(StepAlternative.class, this,
					UseCasePackage.CHOICE_STEP__STEP_ALTERNATIVES);
		}
		...
		if (__lastInDef != null && __lastInDef.eIsProxy()) {
			...
			if (__lastInDef != old__lastInDef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UseCasePackage.CHOICE_STEP__LAST_IN_DEF,
	...
	public void set__lastInDef(Step new__lastInDef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UseCasePackage.CHOICE_STEP__LAST_IN_DEF,
					old__lastInDef, __lastInDef));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case UseCasePackage.CHOICE_STEP__STEP_ALTERNATIVES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case UseCasePackage.CHOICE_STEP__LAST_IN_DEF:
			if (resolve)
