...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>PG2 Parallel Step After Def EG</b></em>'.
 * <!-- end-user-doc -->
 *
 *
 * @see Bpmn2UseCase.Rules.RulesPackage#getPG2ParallelStepAfterDefEG()
 * @model
 * @generated
 */
public interface PG2ParallelStepAfterDefEG extends EObject, AbstractRule {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model
	...
	CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ExclusiveGateway prevNode, ChoiceStep cStep,
			GW2S eg2cs, SequenceFlow sf1, Flow flow, SimpleBPMN.Process process, ParallelGateway pgw,
	...
	void registerObjects_FWD(PerformRuleResult ruleresult, EObject prevNode, EObject cStep, EObject eg2cs, EObject sf1,
			EObject step, EObject flow, EObject process, EObject pgw, EObject pcgwToStep, EObject pgwToStep,
			EObject pcgw);
	 ...
	 * @generated
	 */
	boolean isAppropriate_BWD(Match match, ChoiceStep cStep, ParallelStep step, Flow flow);
	 ...
	 * @generated
	 */
	void registerObjectsToMatch_BWD(Match match, ChoiceStep cStep, ParallelStep step, Flow flow);
	 ...
	 * @generated
	 */
	CSP isAppropriate_solveCsp_BWD(Match match, ChoiceStep cStep, ParallelStep step, Flow flow);
	...
	CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ExclusiveGateway prevNode, ChoiceStep cStep,
			GW2S eg2cs, ParallelStep step, Flow flow, SimpleBPMN.Process process);
	 ...
	 * @generated
	 */
	EObjectContainer isAppropriate_FWD_EMoflonEdge_401(EMoflonEdge _edge_sourceRef);
	 ...
	 * @generated
	 */
	EObjectContainer isAppropriate_FWD_EMoflonEdge_402(EMoflonEdge _edge_outgoing);
	 ...
	 * @generated
	 */
	EObjectContainer isAppropriate_FWD_EMoflonEdge_403(EMoflonEdge _edge_default);
	 ...
	 * @generated
	 */
	EObjectContainer isAppropriate_FWD_EMoflonEdge_404(EMoflonEdge _edge_flowElements);
	 ...
	 * @generated
	 */
	EObjectContainer isAppropriate_FWD_EMoflonEdge_405(EMoflonEdge _edge_flowElements);
	 ...
	 * @generated
	 */
	EObjectContainer isAppropriate_FWD_EMoflonEdge_406(EMoflonEdge _edge_flowElements);
	 ...
	 * @generated
	 */
	EObjectContainer isAppropriate_FWD_EMoflonEdge_407(EMoflonEdge _edge_targetRef);
	 ...
	 * @generated
	 */
	EObjectContainer isAppropriate_FWD_EMoflonEdge_408(EMoflonEdge _edge_incoming);
	 ...
	 * @generated
	 */
	EObjectContainer isAppropriate_FWD_EMoflonEdge_409(EMoflonEdge _edge___conv);
	...
	CSP isApplicable_solveCsp_CC(IsApplicableMatchCC isApplicableMatch, ExclusiveGateway prevNode, ChoiceStep cStep,
			GW2S eg2cs, SequenceFlow sf1, ParallelStep step, Flow flow, SimpleBPMN.Process process, ParallelGateway pgw,
