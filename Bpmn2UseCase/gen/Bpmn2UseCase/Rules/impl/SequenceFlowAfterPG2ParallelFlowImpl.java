 ...
 * @generated
 */
public class SequenceFlowAfterPG2ParallelFlowImpl extends AbstractRuleImpl
		implements SequenceFlowAfterPG2ParallelFlow {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, ParallelGateway pgw,
			SequenceFlow sf, SimpleBPMN.Process process) {
		// initial bindings
		Object[] result1_black = SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_0_1_blackBBBBB(this,
		...
		Object[] result2_bindingAndBlack = SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_0_2_bindingAndBlackFBBBBB(
						this, match, pgw, sf, process);
		...
		if (SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_0_3_expressionFBB(
						this, csp)) {

			// collect elements to be translated
			Object[] result4_black = SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_0_4_blackBBBB(
							match, pgw, sf, process);
			...
			SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_0_4_greenBBBBFFF(
							match, pgw, sf, process);
			...
			Object[] result5_black = SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_0_5_blackBBBB(
							match, pgw, sf, process);
			...
			SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_0_5_greenBBBF(
							match, pgw, process);
			// EMoflonEdge process__pgw____flowElements = (EMoflonEdge) result5_green[3];

			// register objects to match
			SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_0_6_expressionBBBBB(
							this, match, pgw, sf, process);
			return SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_0_7_expressionF();
		} else {
			return SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_0_8_expressionF();
		}
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_1_1_bindingAndBlackFFFFFFFBFB(
		...
		Object[] result2_black = SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_1_2_blackBBB(sf,
						flow, _sf2pf);
		...
		Object[] result2_green = SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_1_2_greenFBBB(sf,
						flow, _sf2pf);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		// bookkeeping for edges
		Object[] result3_black = SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_1_3_blackBBBBBBBBBB(
						ruleresult, pgw, step, _pg2ps, sf, process, useCase,
						_p2uc, flow, _sf2pf);
		...
		SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_1_3_greenBBBBBBBBFFFFFFF(
						ruleresult, pgw, step, sf, process, useCase, flow,
						_sf2pf);
		...
		// register objects
		SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_1_5_expressionBBBBBBBBBBB(
						this, ruleresult, pgw, step, _pg2ps, sf, process,
						useCase, _p2uc, flow, _sf2pf);
		return SequenceFlowAfterPG2ParallelFlowImpl
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_2_2_blackBFFBBFFB(
						pgw, sf, process, match)) {
			...
			for (Object[] result3_black : SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_2_3_blackBBBBBBB(
							pgw, step, _pg2ps, sf, process, useCase, _p2uc)) {
				Object[] result3_green = SequenceFlowAfterPG2ParallelFlowImpl
						.pattern_SequenceFlowAfterPG2ParallelFlow_2_3_greenBBBBBBBFFFFFFFFF(
								pgw, step, _pg2ps, sf, process, useCase, _p2uc);
				...
				Object[] result4_bindingAndBlack = SequenceFlowAfterPG2ParallelFlowImpl
						.pattern_SequenceFlowAfterPG2ParallelFlow_2_4_bindingAndBlackFBBBBBBBBB(
								this, isApplicableMatch, pgw, step, _pg2ps, sf,
				...
				// check CSP
				if (SequenceFlowAfterPG2ParallelFlowImpl
						.pattern_SequenceFlowAfterPG2ParallelFlow_2_5_expressionFBB(
								this, csp)) {

					// add match to rule result
					Object[] result6_black = SequenceFlowAfterPG2ParallelFlowImpl
							.pattern_SequenceFlowAfterPG2ParallelFlow_2_6_blackBB(
					...
					SequenceFlowAfterPG2ParallelFlowImpl
							.pattern_SequenceFlowAfterPG2ParallelFlow_2_6_greenBB(
									ruleresult, isApplicableMatch);
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, ParallelGateway pgw,
			SequenceFlow sf, SimpleBPMN.Process process) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, ParallelGateway pgw,
			SequenceFlow sf, SimpleBPMN.Process process) {// Create CSP
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject pgw,
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, ParallelStep step,
			UseCase useCase, ParallelFlow flow) {
		// initial bindings
		Object[] result1_black = SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_10_1_blackBBBBB(this,
		...
		// Solve CSP
		Object[] result2_bindingAndBlack = SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_10_2_bindingAndBlackFBBBBB(
						this, match, step, useCase, flow);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [Solve CSP] failed."
							+ " Variables: " + "[this] = " + this + ", "
		...
		// Check CSP
		if (SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_10_3_expressionFBB(
						this, csp)) {

			// collect elements to be translated
			Object[] result4_black = SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_10_4_blackBBBB(
							match, step, useCase, flow);
			if (result4_black == null) {
				throw new RuntimeException(
						"Pattern matching in node [collect elements to be translated] failed."
			...
			SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_10_4_greenBBBBFF(
							match, step, useCase, flow);
			...
			// collect context elements
			Object[] result5_black = SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_10_5_blackBBBB(
							match, step, useCase, flow);
			if (result5_black == null) {
				throw new RuntimeException(
						"Pattern matching in node [collect context elements] failed."
			...
			SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_10_5_greenBBB(
							match, step, useCase);

			// register objects to match
			SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_10_6_expressionBBBBB(
							this, match, step, useCase, flow);
			return SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_10_7_expressionF();
		} else {
			return SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_10_8_expressionF();
		}
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		// perform transformation
		Object[] result1_bindingAndBlack = SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_11_1_bindingAndBlackFFFFFFFBFB(
						this, isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [perform transformation] failed."
		...
		// collect translated elements
		Object[] result2_black = SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_11_2_blackBBB(sf,
						flow, _sf2pf);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching in node [collect translated elements] failed."
		...
		Object[] result2_green = SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_11_2_greenFBBB(sf,
						flow, _sf2pf);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		// bookkeeping for edges
		Object[] result3_black = SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_11_3_blackBBBBBBBBBB(
						ruleresult, pgw, step, _pg2ps, sf, process, useCase,
						_p2uc, flow, _sf2pf);
		if (result3_black == null) {
			throw new RuntimeException(
		...
		SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_11_3_greenBBBBBBBBFFFFFFF(
						ruleresult, pgw, step, sf, process, useCase, flow,
						_sf2pf);
		// EMoflonEdge sf__pgw____sourceRef = (EMoflonEdge) result3_green[8];
		// EMoflonEdge pgw__sf____outgoing = (EMoflonEdge) result3_green[9];
		...
		// register objects
		SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_11_5_expressionBBBBBBBBBBB(
						this, ruleresult, pgw, step, _pg2ps, sf, process,
						useCase, _p2uc, flow, _sf2pf);
		return SequenceFlowAfterPG2ParallelFlowImpl
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_12_2_blackFBFFBFBB(
						step, useCase, flow, match)) {
			...
			// ForEach find context
			for (Object[] result3_black : SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_12_3_blackBBBBBBB(
							pgw, step, _pg2ps, process, useCase, _p2uc, flow)) {
				Object[] result3_green = SequenceFlowAfterPG2ParallelFlowImpl
						.pattern_SequenceFlowAfterPG2ParallelFlow_12_3_greenBBBBBBBFFFFFFFF(
								pgw, step, _pg2ps, process, useCase, _p2uc,
								flow);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				...
				// solve CSP
				Object[] result4_bindingAndBlack = SequenceFlowAfterPG2ParallelFlowImpl
						.pattern_SequenceFlowAfterPG2ParallelFlow_12_4_bindingAndBlackFBBBBBBBBB(
								this, isApplicableMatch, pgw, step, _pg2ps,
								process, useCase, _p2uc, flow);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException(
							"Pattern matching in node [solve CSP] failed."
									+ " Variables: " + "[this] = "
				...
				// check CSP
				if (SequenceFlowAfterPG2ParallelFlowImpl
						.pattern_SequenceFlowAfterPG2ParallelFlow_12_5_expressionFBB(
								this, csp)) {

					// add match to rule result
					Object[] result6_black = SequenceFlowAfterPG2ParallelFlowImpl
							.pattern_SequenceFlowAfterPG2ParallelFlow_12_6_blackBB(
									ruleresult, isApplicableMatch);
					if (result6_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [add match to rule result] failed."
					...
					SequenceFlowAfterPG2ParallelFlowImpl
							.pattern_SequenceFlowAfterPG2ParallelFlow_12_6_greenBB(
									ruleresult, isApplicableMatch);
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, ParallelStep step,
			UseCase useCase, ParallelFlow flow) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, ParallelStep step,
			UseCase useCase, ParallelFlow flow) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject pgw,
			EObject step, EObject _pg2ps, EObject sf, EObject process,
			EObject useCase, EObject _p2uc, EObject flow, EObject _sf2pf) {
		ruleresult.registerObject("pgw", pgw);
		ruleresult.registerObject("step", step);
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_280(
		...
		for (Object[] result2_black : SequenceFlowAfterPG2ParallelFlowImpl
			...
			if (SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_20_3_expressionFBBBBB(
							this, match, pgw, sf, process)) {
				// Ensure that the correct types of elements are matched
				if (SequenceFlowAfterPG2ParallelFlowImpl
						.pattern_SequenceFlowAfterPG2ParallelFlow_20_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = SequenceFlowAfterPG2ParallelFlowImpl
							.pattern_SequenceFlowAfterPG2ParallelFlow_20_5_blackBBB(
					...
					SequenceFlowAfterPG2ParallelFlowImpl
							.pattern_SequenceFlowAfterPG2ParallelFlow_20_5_greenBBB(
									match, __performOperation, __result);
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_281(
		...
		for (Object[] result2_black : SequenceFlowAfterPG2ParallelFlowImpl
			...
			// bookkeeping with generic isAppropriate method
			if (SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_21_3_expressionFBBBBB(
							this, match, pgw, sf, process)) {
				// Ensure that the correct types of elements are matched
				if (SequenceFlowAfterPG2ParallelFlowImpl
						.pattern_SequenceFlowAfterPG2ParallelFlow_21_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = SequenceFlowAfterPG2ParallelFlowImpl
							.pattern_SequenceFlowAfterPG2ParallelFlow_21_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					SequenceFlowAfterPG2ParallelFlowImpl
							.pattern_SequenceFlowAfterPG2ParallelFlow_21_5_greenBBB(
									match, __performOperation, __result);
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_84(
		...
		for (Object[] result2_black : SequenceFlowAfterPG2ParallelFlowImpl
			...
			// bookkeeping with generic isAppropriate method
			if (SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_22_3_expressionFBBBBB(
							this, match, step, useCase, flow)) {
				// Ensure that the correct types of elements are matched
				if (SequenceFlowAfterPG2ParallelFlowImpl
						.pattern_SequenceFlowAfterPG2ParallelFlow_22_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = SequenceFlowAfterPG2ParallelFlowImpl
							.pattern_SequenceFlowAfterPG2ParallelFlow_22_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					SequenceFlowAfterPG2ParallelFlowImpl
							.pattern_SequenceFlowAfterPG2ParallelFlow_22_5_greenBBB(
									match, __performOperation, __result);
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_282(
		...
		for (Object[] result2_black : SequenceFlowAfterPG2ParallelFlowImpl
			...
			// bookkeeping with generic isAppropriate method
			if (SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_23_3_expressionFBBBBB(
							this, match, pgw, sf, process)) {
				// Ensure that the correct types of elements are matched
				if (SequenceFlowAfterPG2ParallelFlowImpl
						.pattern_SequenceFlowAfterPG2ParallelFlow_23_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = SequenceFlowAfterPG2ParallelFlowImpl
							.pattern_SequenceFlowAfterPG2ParallelFlow_23_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					SequenceFlowAfterPG2ParallelFlowImpl
							.pattern_SequenceFlowAfterPG2ParallelFlow_23_5_greenBBB(
									match, __performOperation, __result);
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_85(
		...
		for (Object[] result2_black : SequenceFlowAfterPG2ParallelFlowImpl
			...
			// bookkeeping with generic isAppropriate method
			if (SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_24_3_expressionFBBBBB(
							this, match, step, useCase, flow)) {
				// Ensure that the correct types of elements are matched
				if (SequenceFlowAfterPG2ParallelFlowImpl
						.pattern_SequenceFlowAfterPG2ParallelFlow_24_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = SequenceFlowAfterPG2ParallelFlowImpl
							.pattern_SequenceFlowAfterPG2ParallelFlow_24_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					SequenceFlowAfterPG2ParallelFlowImpl
							.pattern_SequenceFlowAfterPG2ParallelFlow_24_5_greenBBB(
									match, __performOperation, __result);
	...
	public AttributeConstraintsRuleResult checkAttributes_FWD(
		...
		SimpleUseCase.ParallelFlow flow = (SimpleUseCase.ParallelFlow) matchForFlow
				.get().getNode();

		Optional<TripleMatchNodeMapping> matchFor_sf2pf = tripleMatch
				.getNodeMappings().stream()
				.filter(nm -> nm.getNodeName().equals("_sf2pf")).findAny();
		Bpmn2UseCase.SF2F _sf2pf = (Bpmn2UseCase.SF2F) matchFor_sf2pf.get()
				.getNode();
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch,
		...
		Object[] result2_binding = SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_27_2_bindingFFFFFFBB(
		...
		for (Object[] result2_black : SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_27_2_blackBBFBBBFBBB(
						pgw, step, sf, process, useCase, flow, sourceMatch,
						targetMatch)) {
			PG2PS _pg2ps = (PG2PS) result2_black[2];
			P2UC _p2uc = (P2UC) result2_black[6];
			Object[] result2_green = SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_27_2_greenBBBBBBBBBFB(
							pgw, step, _pg2ps, sf, process, useCase, _p2uc,
			...
			Object[] result3_bindingAndBlack = SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_27_3_bindingAndBlackFBBBBBBBBBBBB(
							this, isApplicableMatch, pgw, step, _pg2ps, sf,
							process, useCase, _p2uc, flow, sourceMatch,
							targetMatch);
			if (result3_bindingAndBlack != null) {
				...
				Object[] result4_black = SequenceFlowAfterPG2ParallelFlowImpl
						.pattern_SequenceFlowAfterPG2ParallelFlow_27_4_blackBB(
				...
				SequenceFlowAfterPG2ParallelFlowImpl
						.pattern_SequenceFlowAfterPG2ParallelFlow_27_4_greenBB(
								result, isApplicableMatch);
		...
		return SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_27_5_expressionFB(result);
	}
	...
	public CSP isApplicable_solveCsp_CC(IsApplicableMatchCC isApplicableMatch,
			ParallelGateway pgw, ParallelStep step, PG2PS _pg2ps,
			SequenceFlow sf, SimpleBPMN.Process process, UseCase useCase,
			P2UC _p2uc, ParallelFlow flow, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public PerformRuleResult perform_CC(IsApplicableMatchCC isApplicableMatch) {
		...
		Object[] result2_green = SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_30_2_greenBBFF(sf,
						flow);
		PerformRuleResult result = (PerformRuleResult) result2_green[2];
		// SF2F _sf2pf = (SF2F) result2_green[3];

		return SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_30_3_expressionFB(result);
	}
	...
	public ModelgeneratorRuleResult generateModel(
		...
		for (Object[] result2_black : SequenceFlowAfterPG2ParallelFlowImpl
				.pattern_SequenceFlowAfterPG2ParallelFlow_31_2_blackFFFFFFFBB(
			...
			// solve CSP
			Object[] result3_bindingAndBlack = SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_31_3_bindingAndBlackFBBBBBBBBB(
							this, isApplicableMatch, pgw, step, _pg2ps,
							process, useCase, _p2uc, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException(
						"Pattern matching in node [solve CSP] failed."
								+ " Variables: " + "[this] = "
			...
			// check CSP
			if (SequenceFlowAfterPG2ParallelFlowImpl
					.pattern_SequenceFlowAfterPG2ParallelFlow_31_4_expressionFBB(
							this, csp)) {
				// check nacs
				Object[] result5_black = SequenceFlowAfterPG2ParallelFlowImpl
						.pattern_SequenceFlowAfterPG2ParallelFlow_31_5_blackBBBBBB(
								pgw, step, _pg2ps, process, useCase, _p2uc);
				if (result5_black != null) {

					// perform
					Object[] result6_black = SequenceFlowAfterPG2ParallelFlowImpl
							.pattern_SequenceFlowAfterPG2ParallelFlow_31_6_blackBBBBBBB(
									pgw, step, _pg2ps, process, useCase, _p2uc,
									ruleResult);
					if (result6_black == null) {
						throw new RuntimeException(
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		case RulesPackage.SEQUENCE_FLOW_AFTER_PG2_PARALLEL_FLOW___IS_APPROPRIATE_FWD__MATCH_PARALLELGATEWAY_SEQUENCEFLOW_PROCESS:
			return isAppropriate_FWD((Match) arguments.get(0),
					...
					(SimpleBPMN.Process) arguments.get(3));
		...
		case RulesPackage.SEQUENCE_FLOW_AFTER_PG2_PARALLEL_FLOW___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_PARALLELGATEWAY_PARALLELSTEP_PG2PS_SEQUENCEFLOW_PROCESS_USECASE_P2UC:
			return isApplicable_solveCsp_FWD(
					...
					(ParallelGateway) arguments.get(1),
					(ParallelStep) arguments.get(2), (PG2PS) arguments.get(3),
					(SequenceFlow) arguments.get(4),
					(SimpleBPMN.Process) arguments.get(5),
					(UseCase) arguments.get(6), (P2UC) arguments.get(7));
		...
		case RulesPackage.SEQUENCE_FLOW_AFTER_PG2_PARALLEL_FLOW___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_PARALLELGATEWAY_PARALLELSTEP_PG2PS_PROCESS_USECASE_P2UC_PARALLELFLOW:
			return isApplicable_solveCsp_BWD(
					...
					(UseCase) arguments.get(5), (P2UC) arguments.get(6),
		...
		case RulesPackage.SEQUENCE_FLOW_AFTER_PG2_PARALLEL_FLOW___IS_APPLICABLE_SOLVE_CSP_CC__ISAPPLICABLEMATCHCC_PARALLELGATEWAY_PARALLELSTEP_PG2PS_SEQUENCEFLOW_PROCESS_USECASE_P2UC_PARALLELFLOW_MATCH_MATCH:
			return isApplicable_solveCsp_CC(
					...
					(SimpleBPMN.Process) arguments.get(5),
					(UseCase) arguments.get(6), (P2UC) arguments.get(7),
					(ParallelFlow) arguments.get(8), (Match) arguments.get(9),
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_0_2_bindingFBBBBB(
			SequenceFlowAfterPG2ParallelFlow _this, Match match,
			ParallelGateway pgw, SequenceFlow sf, SimpleBPMN.Process process) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_FWD(match, pgw, sf,
				process);
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_0_2_blackB(
			CSP csp) {
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_0_2_bindingAndBlackFBBBBB(
		...
		if (result_pattern_SequenceFlowAfterPG2ParallelFlow_0_2_binding != null) {
			...
			Object[] result_pattern_SequenceFlowAfterPG2ParallelFlow_0_2_black = pattern_SequenceFlowAfterPG2ParallelFlow_0_2_blackB(csp);
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_0_4_blackBBBB(
			Match match, ParallelGateway pgw, SequenceFlow sf,
			SimpleBPMN.Process process) {
		return new Object[] { match, pgw, sf, process };
	}

	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_0_4_greenBBBBFFF(
			Match match, ParallelGateway pgw, SequenceFlow sf,
			SimpleBPMN.Process process) {
		EMoflonEdge sf__pgw____sourceRef = TGGRuntimeFactory.eINSTANCE
				.createEMoflonEdge();
		EMoflonEdge pgw__sf____outgoing = TGGRuntimeFactory.eINSTANCE
				.createEMoflonEdge();
		...
		return new Object[] { match, pgw, sf, process, sf__pgw____sourceRef,
				pgw__sf____outgoing, process__sf____flowElements };
	}

	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_0_5_blackBBBB(
			Match match, ParallelGateway pgw, SequenceFlow sf,
			SimpleBPMN.Process process) {
		return new Object[] { match, pgw, sf, process };
	}

	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_0_5_greenBBBF(
			Match match, ParallelGateway pgw, SimpleBPMN.Process process) {
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_1_1_blackBBBBBBBBFB(
			ParallelGateway pgw, ParallelStep step, PG2PS _pg2ps,
			SequenceFlow sf, SimpleBPMN.Process process, UseCase useCase,
			P2UC _p2uc, SequenceFlowAfterPG2ParallelFlow _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { pgw, step, _pg2ps, sf, process, useCase,
						_p2uc, _this, csp, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_1_1_bindingAndBlackFFFFFFFBFB(
			...
			IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_SequenceFlowAfterPG2ParallelFlow_1_1_binding = pattern_SequenceFlowAfterPG2ParallelFlow_1_1_bindingFFFFFFFB(isApplicableMatch);
		if (result_pattern_SequenceFlowAfterPG2ParallelFlow_1_1_binding != null) {
			...
			Object[] result_pattern_SequenceFlowAfterPG2ParallelFlow_1_1_black = pattern_SequenceFlowAfterPG2ParallelFlow_1_1_blackBBBBBBBBFB(
					pgw, step, _pg2ps, sf, process, useCase, _p2uc, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_1_2_blackBBB(
			SequenceFlow sf, ParallelFlow flow, SF2F _sf2pf) {
		return new Object[] { sf, flow, _sf2pf };
	}

	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_1_2_greenFBBB(
			SequenceFlow sf, ParallelFlow flow, SF2F _sf2pf) {
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_1_3_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject pgw, EObject step,
			EObject _pg2ps, EObject sf, EObject process, EObject useCase,
			EObject _p2uc, EObject flow, EObject _sf2pf) {
		if (!pgw.equals(step)) {
			if (!pgw.equals(sf)) {
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_1_3_greenBBBBBBBBFFFFFFF(
			PerformRuleResult ruleresult, EObject pgw, EObject step,
			EObject sf, EObject process, EObject useCase, EObject flow,
			EObject _sf2pf) {
		EMoflonEdge sf__pgw____sourceRef = TGGRuntimeFactory.eINSTANCE
				.createEMoflonEdge();
		EMoflonEdge pgw__sf____outgoing = TGGRuntimeFactory.eINSTANCE
				.createEMoflonEdge();
		EMoflonEdge step__flow____invokedFlows = TGGRuntimeFactory.eINSTANCE
				.createEMoflonEdge();
		EMoflonEdge process__sf____flowElements = TGGRuntimeFactory.eINSTANCE
				.createEMoflonEdge();
		EMoflonEdge useCase__flow____flows = TGGRuntimeFactory.eINSTANCE
				.createEMoflonEdge();
		EMoflonEdge _sf2pf__sf____source = TGGRuntimeFactory.eINSTANCE
				.createEMoflonEdge();
		EMoflonEdge _sf2pf__flow____target = TGGRuntimeFactory.eINSTANCE
				.createEMoflonEdge();
		...
		sf__pgw____sourceRef.setName(sf__pgw____sourceRef_name_prime);
		pgw__sf____outgoing.setName(pgw__sf____outgoing_name_prime);
		step__flow____invokedFlows
				.setName(step__flow____invokedFlows_name_prime);
		process__sf____flowElements
				.setName(process__sf____flowElements_name_prime);
		...
		return new Object[] { ruleresult, pgw, step, sf, process, useCase,
				flow, _sf2pf, sf__pgw____sourceRef, pgw__sf____outgoing,
				step__flow____invokedFlows, process__sf____flowElements,
				useCase__flow____flows, _sf2pf__sf____source,
				_sf2pf__flow____target };
	}
	...
	public static final void pattern_SequenceFlowAfterPG2ParallelFlow_1_5_expressionBBBBBBBBBBB(
			...
			EObject _pg2ps, EObject sf, EObject process, EObject useCase,
			EObject _p2uc, EObject flow, EObject _sf2pf) {
		_this.registerObjects_FWD(ruleresult, pgw, step, _pg2ps, sf, process,
				useCase, _p2uc, flow, _sf2pf);
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_2_1_blackFBB(
			EClass eClass, SequenceFlowAfterPG2ParallelFlow _this) {
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_2_1_bindingAndBlackFFB(
			SequenceFlowAfterPG2ParallelFlow _this) {
		Object[] result_pattern_SequenceFlowAfterPG2ParallelFlow_2_1_binding = pattern_SequenceFlowAfterPG2ParallelFlow_2_1_bindingFB(_this);
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_2_1_greenBF(
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_2_2_bindingFFFB(
			Match match) {
			...
			for (PG2PS _pg2ps : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (step != null) {
					for (P2UC _p2uc : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (useCase != null) {
							_result.add(new Object[] { pgw, step, _pg2ps, sf,
									process, useCase, _p2uc, match });
						}
							...
							if (process.equals(_p2uc.getSource())) {
								if (useCase.equals(_p2uc.getTarget())) {
									...
									if (Boolean.valueOf(pgwisDiverging).equals(
										...
										_result.add(new Object[] { pgw, step,
												_pg2ps, sf, process, useCase,
												_p2uc });
									}
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_2_3_greenBBBBBBBFFFFFFFFF(
			ParallelGateway pgw, ParallelStep step, PG2PS _pg2ps,
			SequenceFlow sf, SimpleBPMN.Process process, UseCase useCase,
			P2UC _p2uc) {
		...
		return new Object[] { pgw, step, _pg2ps, sf, process, useCase, _p2uc,
				isApplicableMatch, sf__pgw____sourceRef, pgw__sf____outgoing,
				_pg2ps__pgw____source, _pg2ps__step____target,
				process__pgw____flowElements, process__sf____flowElements,
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_2_4_bindingFBBBBBBBBB(
			SequenceFlowAfterPG2ParallelFlow _this,
			IsApplicableMatch isApplicableMatch, ParallelGateway pgw,
			ParallelStep step, PG2PS _pg2ps, SequenceFlow sf,
			SimpleBPMN.Process process, UseCase useCase, P2UC _p2uc) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(
				isApplicableMatch, pgw, step, _pg2ps, sf, process, useCase,
				_p2uc);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, pgw, step,
					_pg2ps, sf, process, useCase, _p2uc };
		}
		return null;
	}

	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_2_4_blackB(
			CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_2_4_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_SequenceFlowAfterPG2ParallelFlow_2_4_binding = pattern_SequenceFlowAfterPG2ParallelFlow_2_4_bindingFBBBBBBBBB(
				_this, isApplicableMatch, pgw, step, _pg2ps, sf, process,
				useCase, _p2uc);
		if (result_pattern_SequenceFlowAfterPG2ParallelFlow_2_4_binding != null) {
			...
			Object[] result_pattern_SequenceFlowAfterPG2ParallelFlow_2_4_black = pattern_SequenceFlowAfterPG2ParallelFlow_2_4_blackB(csp);
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_2_6_blackBB(
			IsApplicableRuleResult ruleresult,
			IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_2_6_greenBB(
			IsApplicableRuleResult ruleresult,
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_10_2_blackB(
			CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_10_2_bindingAndBlackFBBBBB(
		...
		if (result_pattern_SequenceFlowAfterPG2ParallelFlow_10_2_binding != null) {
			...
			Object[] result_pattern_SequenceFlowAfterPG2ParallelFlow_10_2_black = pattern_SequenceFlowAfterPG2ParallelFlow_10_2_blackB(csp);
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_10_4_blackBBBB(
			Match match, ParallelStep step, UseCase useCase, ParallelFlow flow) {
		return new Object[] { match, step, useCase, flow };
	}

	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_10_4_greenBBBBFF(
			Match match, ParallelStep step, UseCase useCase, ParallelFlow flow) {
		EMoflonEdge step__flow____invokedFlows = TGGRuntimeFactory.eINSTANCE
				.createEMoflonEdge();
		EMoflonEdge useCase__flow____flows = TGGRuntimeFactory.eINSTANCE
		...
		useCase__flow____flows.setName(useCase__flow____flows_name_prime);
		return new Object[] { match, step, useCase, flow,
				step__flow____invokedFlows, useCase__flow____flows };
	}

	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_10_5_blackBBBB(
			Match match, ParallelStep step, UseCase useCase, ParallelFlow flow) {
		return new Object[] { match, step, useCase, flow };
	}

	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_10_5_greenBBB(
			Match match, ParallelStep step, UseCase useCase) {
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_11_1_blackBBBBBBBBFB(
			ParallelGateway pgw, ParallelStep step, PG2PS _pg2ps,
			SimpleBPMN.Process process, UseCase useCase, P2UC _p2uc,
			ParallelFlow flow, SequenceFlowAfterPG2ParallelFlow _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { pgw, step, _pg2ps, process, useCase,
						_p2uc, flow, _this, csp, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_11_1_bindingAndBlackFFFFFFFBFB(
			SequenceFlowAfterPG2ParallelFlow _this,
			IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_SequenceFlowAfterPG2ParallelFlow_11_1_binding = pattern_SequenceFlowAfterPG2ParallelFlow_11_1_bindingFFFFFFFB(isApplicableMatch);
		if (result_pattern_SequenceFlowAfterPG2ParallelFlow_11_1_binding != null) {
			...
			Object[] result_pattern_SequenceFlowAfterPG2ParallelFlow_11_1_black = pattern_SequenceFlowAfterPG2ParallelFlow_11_1_blackBBBBBBBBFB(
					pgw, step, _pg2ps, process, useCase, _p2uc, flow, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_11_2_greenFBBB(
			SequenceFlow sf, ParallelFlow flow, SF2F _sf2pf) {
		PerformRuleResult ruleresult = TGGRuntimeFactory.eINSTANCE
				.createPerformRuleResult();
	...
	public static final void pattern_SequenceFlowAfterPG2ParallelFlow_11_5_expressionBBBBBBBBBBB(
			...
			EObject _pg2ps, EObject sf, EObject process, EObject useCase,
			EObject _p2uc, EObject flow, EObject _sf2pf) {
		_this.registerObjects_BWD(ruleresult, pgw, step, _pg2ps, sf, process,
				useCase, _p2uc, flow, _sf2pf);
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_12_1_blackFBB(
			EClass eClass, SequenceFlowAfterPG2ParallelFlow _this) {
		for (EOperation performOperation : eClass.getEOperations()) {
			String performOperationname = performOperation.getName();
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_12_1_bindingAndBlackFFB(
			SequenceFlowAfterPG2ParallelFlow _this) {
		Object[] result_pattern_SequenceFlowAfterPG2ParallelFlow_12_1_binding = pattern_SequenceFlowAfterPG2ParallelFlow_12_1_bindingFB(_this);
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_12_1_greenBF(
			EOperation performOperation) {
		IsApplicableRuleResult ruleresult = TGGRuntimeFactory.eINSTANCE
				.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = false;
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_12_2_bindingFFFB(
			Match match) {
	...
	public static final Iterable<Object[]> pattern_SequenceFlowAfterPG2ParallelFlow_12_2_blackFBFFBFBB(
		...
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		for (PG2PS _pg2ps : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(step, PG2PS.class, "target")) {
			...
			if (pgw != null) {
				...
				if (Boolean.valueOf(pgwisDiverging).equals(
						Boolean.valueOf(true))) {
					for (P2UC _p2uc : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(useCase, P2UC.class,
									"target")) {
						SimpleBPMN.Process process = _p2uc.getSource();
						if (process != null) {
							_result.add(new Object[] { pgw, step, _pg2ps,
									process, useCase, _p2uc, flow, match });
						}
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_12_3_greenBBBBBBBFFFFFFFF(
			ParallelGateway pgw, ParallelStep step, PG2PS _pg2ps,
			SimpleBPMN.Process process, UseCase useCase, P2UC _p2uc,
			ParallelFlow flow) {
		IsApplicableMatch isApplicableMatch = TGGRuntimeFactory.eINSTANCE
		...
		return new Object[] { pgw, step, _pg2ps, process, useCase, _p2uc, flow,
				isApplicableMatch, step__flow____invokedFlows,
				_pg2ps__pgw____source, _pg2ps__step____target,
				process__pgw____flowElements, useCase__flow____flows,
				_p2uc__process____source, _p2uc__useCase____target };
	}
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_12_4_bindingFBBBBBBBBB(
			SequenceFlowAfterPG2ParallelFlow _this,
			IsApplicableMatch isApplicableMatch, ParallelGateway pgw,
			ParallelStep step, PG2PS _pg2ps, SimpleBPMN.Process process,
			UseCase useCase, P2UC _p2uc, ParallelFlow flow) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(
				isApplicableMatch, pgw, step, _pg2ps, process, useCase, _p2uc,
				flow);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, pgw, step,
					_pg2ps, process, useCase, _p2uc, flow };
		}
		return null;
	}

	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_12_4_blackB(
			CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_12_4_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_SequenceFlowAfterPG2ParallelFlow_12_4_binding = pattern_SequenceFlowAfterPG2ParallelFlow_12_4_bindingFBBBBBBBBB(
				_this, isApplicableMatch, pgw, step, _pg2ps, process, useCase,
				_p2uc, flow);
		if (result_pattern_SequenceFlowAfterPG2ParallelFlow_12_4_binding != null) {
			...
			Object[] result_pattern_SequenceFlowAfterPG2ParallelFlow_12_4_black = pattern_SequenceFlowAfterPG2ParallelFlow_12_4_blackB(csp);
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_20_1_blackFBB(
			EClass __eClass, SequenceFlowAfterPG2ParallelFlow _this) {
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_20_1_bindingAndBlackFFB(
			SequenceFlowAfterPG2ParallelFlow _this) {
		Object[] result_pattern_SequenceFlowAfterPG2ParallelFlow_20_1_binding = pattern_SequenceFlowAfterPG2ParallelFlow_20_1_bindingFB(_this);
					...
					if (Boolean.valueOf(pgwisDiverging).equals(
						...
						for (SimpleBPMN.Process process : org.moflon.core.utilities.eMoflonEMFUtil
								.getOppositeReferenceTyped(sf,
										...
										"flowElements")) {
							if (process.getFlowElements().contains(pgw)) {
								_result.add(new Object[] { pgw, sf, process,
										_edge_sourceRef });
							}
						}
					}
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_20_2_greenFB(
			EClass __eClass) {
	...
	public static final boolean pattern_SequenceFlowAfterPG2ParallelFlow_20_3_expressionFBBBBB(
			SequenceFlowAfterPG2ParallelFlow _this, Match match,
			ParallelGateway pgw, SequenceFlow sf, SimpleBPMN.Process process) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, pgw, sf,
				process);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_20_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_20_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_21_1_blackFBB(
			EClass __eClass, SequenceFlowAfterPG2ParallelFlow _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_21_1_bindingAndBlackFFB(
			SequenceFlowAfterPG2ParallelFlow _this) {
		Object[] result_pattern_SequenceFlowAfterPG2ParallelFlow_21_1_binding = pattern_SequenceFlowAfterPG2ParallelFlow_21_1_bindingFB(_this);
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_21_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_21_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_21_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_22_1_blackFBB(
			EClass __eClass, SequenceFlowAfterPG2ParallelFlow _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_22_1_bindingAndBlackFFB(
			SequenceFlowAfterPG2ParallelFlow _this) {
		Object[] result_pattern_SequenceFlowAfterPG2ParallelFlow_22_1_binding = pattern_SequenceFlowAfterPG2ParallelFlow_22_1_bindingFB(_this);
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_22_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_22_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_22_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_23_1_blackFBB(
			EClass __eClass, SequenceFlowAfterPG2ParallelFlow _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_23_1_bindingAndBlackFFB(
			SequenceFlowAfterPG2ParallelFlow _this) {
		Object[] result_pattern_SequenceFlowAfterPG2ParallelFlow_23_1_binding = pattern_SequenceFlowAfterPG2ParallelFlow_23_1_bindingFB(_this);
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_23_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_23_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_23_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_24_1_blackFBB(
			EClass __eClass, SequenceFlowAfterPG2ParallelFlow _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_BWD")) {
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_24_1_bindingAndBlackFFB(
			SequenceFlowAfterPG2ParallelFlow _this) {
		Object[] result_pattern_SequenceFlowAfterPG2ParallelFlow_24_1_binding = pattern_SequenceFlowAfterPG2ParallelFlow_24_1_bindingFB(_this);
	...
	public static final Iterable<Object[]> pattern_SequenceFlowAfterPG2ParallelFlow_24_2_blackFFFB(
		...
		if (tmpUseCase instanceof UseCase) {
			...
			if (tmpFlow instanceof ParallelFlow) {
				ParallelFlow flow = (ParallelFlow) tmpFlow;
				if (useCase.getFlows().contains(flow)) {
					for (ParallelStep step : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(flow,
									ParallelStep.class, "invokedFlows")) {
						if (pattern_SequenceFlowAfterPG2ParallelFlow_24_2_black_nac_0BB(
								flow, step) == null) {
							_result.add(new Object[] { step, useCase, flow,
									_edge_flows });
						}
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_24_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_24_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_24_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_27_2_bindingFFFFFFBB(
				...
				if (tmpSf instanceof SequenceFlow) {
					...
					if (tmpProcess instanceof SimpleBPMN.Process) {
						...
						if (tmpUseCase instanceof UseCase) {
							...
							if (tmpFlow instanceof ParallelFlow) {
								ParallelFlow flow = (ParallelFlow) tmpFlow;
								return new Object[] { pgw, step, sf, process,
										useCase, flow, sourceMatch, targetMatch };
							}
						}
					}
				}
	...
	public static final Iterable<Object[]> pattern_SequenceFlowAfterPG2ParallelFlow_27_2_blackBBFBBBFBBB(
			ParallelGateway pgw, ParallelStep step, SequenceFlow sf,
			SimpleBPMN.Process process, UseCase useCase, ParallelFlow flow,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_27_2_greenBBBBBBBBBFB(
			ParallelGateway pgw, ParallelStep step, PG2PS _pg2ps,
			SequenceFlow sf, SimpleBPMN.Process process, UseCase useCase,
		...
		isApplicableMatch.setRuleName(isApplicableMatch_ruleName_prime);
		return new Object[] { pgw, step, _pg2ps, sf, process, useCase, _p2uc,
				flow, sourceMatch, isApplicableMatch, targetMatch };
	}

	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_27_3_bindingFBBBBBBBBBBBB(
			SequenceFlowAfterPG2ParallelFlow _this,
			IsApplicableMatchCC isApplicableMatch, ParallelGateway pgw,
			ParallelStep step, PG2PS _pg2ps, SequenceFlow sf,
			SimpleBPMN.Process process, UseCase useCase, P2UC _p2uc,
		...
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, pgw, step,
					_pg2ps, sf, process, useCase, _p2uc, flow, sourceMatch,
					targetMatch };
		}
		return null;
	}

	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_27_3_blackB(
			CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_27_3_bindingAndBlackFBBBBBBBBBBBB(
		...
		if (result_pattern_SequenceFlowAfterPG2ParallelFlow_27_3_binding != null) {
			...
			Object[] result_pattern_SequenceFlowAfterPG2ParallelFlow_27_3_black = pattern_SequenceFlowAfterPG2ParallelFlow_27_3_blackB(csp);
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_27_4_blackBB(
			IsApplicableRuleResult result, IsApplicableMatch isApplicableMatch) {
		return new Object[] { result, isApplicableMatch };
	}

	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_27_4_greenBB(
			IsApplicableRuleResult result, IsApplicableMatch isApplicableMatch) {
						...
						if (tmpProcess instanceof SimpleBPMN.Process) {
							...
							if (tmpUseCase instanceof UseCase) {
								...
								if (tmp_p2uc instanceof P2UC) {
									...
									if (tmpFlow instanceof ParallelFlow) {
										ParallelFlow flow = (ParallelFlow) tmpFlow;
										return new Object[] { pgw, step,
												_pg2ps, sf, process, useCase,
												_p2uc, flow, isApplicableMatch };
									}
								}
							}
						}
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_30_2_blackBBBBBBBBB(
			ParallelGateway pgw, ParallelStep step, PG2PS _pg2ps,
			SequenceFlow sf, SimpleBPMN.Process process, UseCase useCase,
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_30_2_bindingAndBlackFFFFFFFFB(
			IsApplicableMatchCC isApplicableMatch) {
		Object[] result_pattern_SequenceFlowAfterPG2ParallelFlow_30_2_binding = pattern_SequenceFlowAfterPG2ParallelFlow_30_2_bindingFFFFFFFFB(isApplicableMatch);
		if (result_pattern_SequenceFlowAfterPG2ParallelFlow_30_2_binding != null) {
			...
			Object[] result_pattern_SequenceFlowAfterPG2ParallelFlow_30_2_black = pattern_SequenceFlowAfterPG2ParallelFlow_30_2_blackBBBBBBBBB(
					pgw, step, _pg2ps, sf, process, useCase, _p2uc, flow,
					isApplicableMatch);
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_30_2_greenBBFF(
			SequenceFlow sf, ParallelFlow flow) {
				...
				if (tmp_pg2ps instanceof PG2PS) {
					...
					if (pgw != null) {
						...
						if (step != null) {
							...
							if (Boolean.valueOf(pgwisDiverging).equals(
									Boolean.valueOf(true))) {
								if (pattern_SequenceFlowAfterPG2ParallelFlow_31_2_black_nac_1BB(
										ruleResult, _pg2ps) == null) {
									if (pattern_SequenceFlowAfterPG2ParallelFlow_31_2_black_nac_0BB(
											ruleResult, pgw) == null) {
										if (pattern_SequenceFlowAfterPG2ParallelFlow_31_2_black_nac_2BB(
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_31_3_bindingFBBBBBBBBB(
			...
			IsApplicableMatch isApplicableMatch, ParallelGateway pgw,
			ParallelStep step, PG2PS _pg2ps, SimpleBPMN.Process process,
			UseCase useCase, P2UC _p2uc, ModelgeneratorRuleResult ruleResult) {
		...
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, pgw, step,
					_pg2ps, process, useCase, _p2uc, ruleResult };
		}
		return null;
	}

	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_31_3_blackB(
			CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_31_3_bindingAndBlackFBBBBBBBBB(
		...
		if (result_pattern_SequenceFlowAfterPG2ParallelFlow_31_3_binding != null) {
			...
			Object[] result_pattern_SequenceFlowAfterPG2ParallelFlow_31_3_black = pattern_SequenceFlowAfterPG2ParallelFlow_31_3_blackB(csp);
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_31_5_blackBBBBBB(
			ParallelGateway pgw, ParallelStep step, PG2PS _pg2ps,
			SimpleBPMN.Process process, UseCase useCase, P2UC _p2uc) {
		boolean pgwisDiverging = pgw.isIsDiverging();
		if (Boolean.valueOf(pgwisDiverging).equals(Boolean.valueOf(true))) {
	...
	public static final Object[] pattern_SequenceFlowAfterPG2ParallelFlow_31_6_blackBBBBBBB(
			ParallelGateway pgw, ParallelStep step, PG2PS _pg2ps,
			SimpleBPMN.Process process, UseCase useCase, P2UC _p2uc,
			ModelgeneratorRuleResult ruleResult) {
		boolean pgwisDiverging = pgw.isIsDiverging();
