...
public class Process2UseCaseImpl extends AbstractRuleImpl implements Process2UseCase {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_322(EMoflonEdge _edge_flowElements) {
		// prepare return value
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_101(EMoflonEdge _edge_flows) {
		// prepare return value
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_102(EMoflonEdge _edge_precondition) {
		// prepare return value
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.PROCESS2_USE_CASE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_322__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_322((EMoflonEdge) arguments.get(0));
		case RulesPackage.PROCESS2_USE_CASE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_323__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_323((EMoflonEdge) arguments.get(0));
		case RulesPackage.PROCESS2_USE_CASE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_101__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_101((EMoflonEdge) arguments.get(0));
		case RulesPackage.PROCESS2_USE_CASE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_102__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_102((EMoflonEdge) arguments.get(0));
		case RulesPackage.PROCESS2_USE_CASE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_324__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_324((EMoflonEdge) arguments.get(0));
		case RulesPackage.PROCESS2_USE_CASE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_325__EMOFLONEDGE:
	...
	public static final Object[] pattern_Process2UseCase_22_2_black_nac_0BB(UCCondition cond, UseCase useCase) {
		for (UseCase __DEC_cond_precondition_779253 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(cond, UseCase.class, "precondition")) {
			if (!useCase.equals(__DEC_cond_precondition_779253)) {
	...
	public static final Object[] pattern_Process2UseCase_22_2_black_nac_1BB(UCCondition cond, BasicFlow flow) {
		for (Flow __DEC_cond_finalState_930448 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(cond, Flow.class, "finalState")) {
			if (!flow.equals(__DEC_cond_finalState_930448)) {
	...
	public static final Object[] pattern_Process2UseCase_23_2_black_nac_0BB(UCCondition cond, UseCase useCase) {
		for (UseCase __DEC_cond_precondition_629980 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(cond, UseCase.class, "precondition")) {
			if (!useCase.equals(__DEC_cond_precondition_629980)) {
				return new Object[] { cond, useCase };
			}
		}
		return null;
	...
	public static final Object[] pattern_Process2UseCase_23_2_black_nac_1BB(UCCondition cond, BasicFlow flow) {
		for (Flow __DEC_cond_finalState_490930 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(cond, Flow.class, "finalState")) {
			if (!flow.equals(__DEC_cond_finalState_490930)) {
				return new Object[] { cond, flow };
			}
		}
		return null;
