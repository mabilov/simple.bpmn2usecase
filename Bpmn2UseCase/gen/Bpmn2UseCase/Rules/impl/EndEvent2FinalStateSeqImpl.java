...
public class EndEvent2FinalStateSeqImpl extends AbstractRuleImpl implements EndEvent2FinalStateSeq {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, FlowNode node, SimpleBPMN.Process process, SequenceFlow inFlow,
			EndEvent event) {
		// initial bindings
		...
		Object[] result2_bindingAndBlack = EndEvent2FinalStateSeqImpl
				.pattern_EndEvent2FinalStateSeq_0_2_bindingAndBlackFBBBBBB(this, match, node, process, inFlow, event);
		...
		if (EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_0_3_expressionFBB(this, csp)) {
			...
			EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_0_4_greenBBBBFFF(match, process, inFlow, event);
			...
			EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_0_5_greenBBBBFFFF(match, node, process, inFlow);
			...
			EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_0_6_expressionBBBBBB(this, match, node, process,
					inFlow, event);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		FN2S _n2s = (FN2S) result1_bindingAndBlack[3];
		...
		SF2F _if2f = (SF2F) result1_bindingAndBlack[6];
		EndEvent event = (EndEvent) result1_bindingAndBlack[7];
		CSP csp = (CSP) result1_bindingAndBlack[9];
		Object[] result1_green = EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_1_1_greenBBBFFB(step, flow,
				event, csp);
		UCCondition state = (UCCondition) result1_green[3];
		...
		Object[] result3_black = EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_1_3_blackBBBBBBBBBBB(
				ruleresult, step, node, flow, _n2s, process, inFlow, _if2f, event, state, _e2s);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching in node [bookkeeping for edges] failed." + " Variables: "
					+ "[ruleresult] = " + ruleresult + ", " + "[step] = " + step + ", " + "[node] = " + node + ", "
					+ "[flow] = " + flow + ", " + "[_n2s] = " + _n2s + ", " + "[process] = " + process + ", "
					+ "[inFlow] = " + inFlow + ", " + "[_if2f] = " + _if2f + ", " + "[event] = " + event + ", "
					+ "[state] = " + state + ", " + "[_e2s] = " + _e2s + ".");
		}
		EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_1_3_greenBBBBBBBBFFFFFFF(ruleresult, step, flow,
				process, inFlow, event, state, _e2s);
				// EMoflonEdge flow__step______last = (EMoflonEdge) result3_green[8];
				...
				// EMoflonEdge _e2s__event____source = (EMoflonEdge) result3_green[13];
				// EMoflonEdge _e2s__state____target = (EMoflonEdge) result3_green[14];

		// perform postprocessing story node is empty
		// register objects
		EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_1_5_expressionBBBBBBBBBBBB(this, ruleresult, step,
				node, flow, _n2s, process, inFlow, _if2f, event, state, _e2s);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_2_2_blackFBFFBBFBB(node,
				process, inFlow, event, match)) {
			Step step = (Step) result2_black[0];
			Flow flow = (Flow) result2_black[2];
			FN2S _n2s = (FN2S) result2_black[3];
			SF2F _if2f = (SF2F) result2_black[6];
			// ForEach find context
			for (Object[] result3_black : EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_2_3_blackBBBBBBBB(
					step, node, flow, _n2s, process, inFlow, _if2f, event)) {
				Object[] result3_green = EndEvent2FinalStateSeqImpl
						.pattern_EndEvent2FinalStateSeq_2_3_greenBBBBBBBBFFFFFFFFFFFFF(step, node, flow, _n2s, process,
								inFlow, _if2f, event);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[8];
				// EMoflonEdge flow__step____steps = (EMoflonEdge) result3_green[9];
				// EMoflonEdge _n2s__node____source = (EMoflonEdge) result3_green[10];
				// EMoflonEdge _n2s__step____target = (EMoflonEdge) result3_green[11];
				...
				// EMoflonEdge _if2f__inFlow____source = (EMoflonEdge) result3_green[17];
				// EMoflonEdge _if2f__flow____target = (EMoflonEdge) result3_green[18];
				// EMoflonEdge inFlow__node____sourceRef = (EMoflonEdge) result3_green[19];
				// EMoflonEdge node__inFlow____outgoing = (EMoflonEdge) result3_green[20];
				...
				Object[] result4_bindingAndBlack = EndEvent2FinalStateSeqImpl
						.pattern_EndEvent2FinalStateSeq_2_4_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch, step,
								node, flow, _n2s, process, inFlow, _if2f, event);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching in node [solve CSP] failed." + " Variables: "
							+ "[this] = " + this + ", " + "[isApplicableMatch] = " + isApplicableMatch + ", "
							+ "[step] = " + step + ", " + "[node] = " + node + ", " + "[flow] = " + flow + ", "
							+ "[_n2s] = " + _n2s + ", " + "[process] = " + process + ", " + "[inFlow] = " + inFlow
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, FlowNode node, SimpleBPMN.Process process, SequenceFlow inFlow,
			EndEvent event) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, FlowNode node, SimpleBPMN.Process process, SequenceFlow inFlow,
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Step step, FlowNode node, Flow flow,
			FN2S _n2s, SimpleBPMN.Process process, SequenceFlow inFlow, SF2F _if2f, EndEvent event) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject step, EObject node, EObject flow,
			EObject _n2s, EObject process, EObject inFlow, EObject _if2f, EObject event, EObject state, EObject _e2s) {
	...
	public boolean isAppropriate_BWD(Match match, Step step, Flow flow, UCCondition state) {
		...
		if (EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_10_3_expressionFBB(this, csp)) {
			...
			EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_10_4_greenBBBBFF(match, step, flow, state);
			// EMoflonEdge flow__step______last = (EMoflonEdge) result4_green[4];
			...
			EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_10_5_greenBBBF(match, step, flow);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		CSP csp = (CSP) result1_bindingAndBlack[9];
		Object[] result1_green = EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_11_1_greenBBFBFB(process,
				inFlow, state, csp);
		...
		EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_11_3_greenBBBBBBBBFFFFFFF(ruleresult, step, flow,
				process, inFlow, event, state, _e2s);
				// EMoflonEdge flow__step______last = (EMoflonEdge) result3_green[8];
				// EMoflonEdge process__event____flowElements = (EMoflonEdge) result3_green[9];
				// EMoflonEdge inFlow__event____targetRef = (EMoflonEdge) result3_green[10];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_12_2_blackBFBFFFBB(step,
			...
			for (Object[] result3_black : EndEvent2FinalStateSeqImpl
					.pattern_EndEvent2FinalStateSeq_12_3_blackBBBBFBBB(step, node, flow, _n2s, inFlow, _if2f, state)) {
				SimpleBPMN.Process process = (SimpleBPMN.Process) result3_black[4];
				Object[] result3_green = EndEvent2FinalStateSeqImpl
						.pattern_EndEvent2FinalStateSeq_12_3_greenBBBBBBBBFFFFFFFFFFFF(step, node, flow, _n2s, process,
								inFlow, _if2f, state);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[8];
				// EMoflonEdge flow__step______last = (EMoflonEdge) result3_green[9];
				// EMoflonEdge flow__step____steps = (EMoflonEdge) result3_green[10];
				// EMoflonEdge _n2s__node____source = (EMoflonEdge) result3_green[11];
				// EMoflonEdge _n2s__step____target = (EMoflonEdge) result3_green[12];
				// EMoflonEdge process__inFlow____flowElements = (EMoflonEdge) result3_green[13];
				// EMoflonEdge process__node____flowElements = (EMoflonEdge) result3_green[14];
				// EMoflonEdge flow__state____finalState = (EMoflonEdge) result3_green[15];
				// EMoflonEdge _if2f__inFlow____source = (EMoflonEdge) result3_green[16];
				// EMoflonEdge _if2f__flow____target = (EMoflonEdge) result3_green[17];
				// EMoflonEdge inFlow__node____sourceRef = (EMoflonEdge) result3_green[18];
				// EMoflonEdge node__inFlow____outgoing = (EMoflonEdge) result3_green[19];

				// solve CSP
				Object[] result4_bindingAndBlack = EndEvent2FinalStateSeqImpl
						.pattern_EndEvent2FinalStateSeq_12_4_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch, step,
								node, flow, _n2s, process, inFlow, _if2f, state);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching in node [solve CSP] failed." + " Variables: "
							+ "[this] = " + this + ", " + "[isApplicableMatch] = " + isApplicableMatch + ", "
							+ "[step] = " + step + ", " + "[node] = " + node + ", " + "[flow] = " + flow + ", "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Step step, FlowNode node, Flow flow,
			FN2S _n2s, SimpleBPMN.Process process, SequenceFlow inFlow, SF2F _if2f, UCCondition state) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_125(EMoflonEdge _edge___last) {
		// prepare return value
		Object[] result1_bindingAndBlack = EndEvent2FinalStateSeqImpl
		...
		for (Object[] result2_black : EndEvent2FinalStateSeqImpl
			...
			if (EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_20_3_expressionFBBBBB(this, match, step, flow,
					state)) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_382(EMoflonEdge _edge_flowElements) {
		// prepare return value
		Object[] result1_bindingAndBlack = EndEvent2FinalStateSeqImpl
		...
		// ForEach test core match and DECs
		for (Object[] result2_black : EndEvent2FinalStateSeqImpl
				.pattern_EndEvent2FinalStateSeq_21_2_blackFFFFB(_edge_flowElements)) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_383(EMoflonEdge _edge_targetRef) {
		// prepare return value
		Object[] result1_bindingAndBlack = EndEvent2FinalStateSeqImpl
		...
		// ForEach test core match and DECs
		for (Object[] result2_black : EndEvent2FinalStateSeqImpl
				.pattern_EndEvent2FinalStateSeq_22_2_blackFFFFB(_edge_targetRef)) {
			FlowNode node = (FlowNode) result2_black[0];
			SimpleBPMN.Process process = (SimpleBPMN.Process) result2_black[1];
			SequenceFlow inFlow = (SequenceFlow) result2_black[2];
			EndEvent event = (EndEvent) result2_black[3];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_384(EMoflonEdge _edge_incoming) {
		// prepare return value
		Object[] result1_bindingAndBlack = EndEvent2FinalStateSeqImpl
		...
		// ForEach test core match and DECs
		for (Object[] result2_black : EndEvent2FinalStateSeqImpl
				.pattern_EndEvent2FinalStateSeq_23_2_blackFFFFB(_edge_incoming)) {
			FlowNode node = (FlowNode) result2_black[0];
			SimpleBPMN.Process process = (SimpleBPMN.Process) result2_black[1];
			SequenceFlow inFlow = (SequenceFlow) result2_black[2];
			EndEvent event = (EndEvent) result2_black[3];
			...
			// bookkeeping with generic isAppropriate method
			if (EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_23_3_expressionFBBBBBB(this, match, node,
					process, inFlow, event)) {
				// Ensure that the correct types of elements are matched
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_126(EMoflonEdge _edge_finalState) {
		// prepare return value
		Object[] result1_bindingAndBlack = EndEvent2FinalStateSeqImpl
		...
		// ForEach test core match and DECs
		for (Object[] result2_black : EndEvent2FinalStateSeqImpl
				.pattern_EndEvent2FinalStateSeq_24_2_blackFFFB(_edge_finalState)) {
			Step step = (Step) result2_black[0];
			Flow flow = (Flow) result2_black[1];
			UCCondition state = (UCCondition) result2_black[2];
			...
			// bookkeeping with generic isAppropriate method
			if (EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_24_3_expressionFBBBBB(this, match, step, flow,
					state)) {
				// Ensure that the correct types of elements are matched
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		// prepare
		Object[] result1_black = EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_27_1_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException(
		...
		Object[] result2_binding = EndEvent2FinalStateSeqImpl
				.pattern_EndEvent2FinalStateSeq_27_2_bindingFFFFFFFBB(targetMatch, sourceMatch);
		if (result2_binding == null) {
		...
		for (Object[] result2_black : EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_27_2_blackBBBFBBFBBBB(
				step, node, flow, process, inFlow, event, state, sourceMatch, targetMatch)) {
			FN2S _n2s = (FN2S) result2_black[3];
			SF2F _if2f = (SF2F) result2_black[6];
			Object[] result2_green = EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_27_2_greenBBBBBBBBBBFB(
					step, node, flow, _n2s, process, inFlow, _if2f, event, state, sourceMatch, targetMatch);
			...
			Object[] result3_bindingAndBlack = EndEvent2FinalStateSeqImpl
					.pattern_EndEvent2FinalStateSeq_27_3_bindingAndBlackFBBBBBBBBBBBBB(this, isApplicableMatch, step,
							node, flow, _n2s, process, inFlow, _if2f, event, state, sourceMatch, targetMatch);
			if (result3_bindingAndBlack != null) {
				// CSP csp = (CSP) result3_bindingAndBlack[0];

				// add to returned result
				Object[] result4_black = EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_27_4_blackBB(result,
						isApplicableMatch);
				if (result4_black == null) {
					throw new RuntimeException(
				...
				EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_27_4_greenBB(result, isApplicableMatch);

			} else {
			}

		}
		return EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_27_5_expressionFB(result);
	}
	...
	public CSP isApplicable_solveCsp_CC(IsApplicableMatchCC isApplicableMatch, Step step, FlowNode node, Flow flow,
			FN2S _n2s, SimpleBPMN.Process process, SequenceFlow inFlow, SF2F _if2f, EndEvent event, UCCondition state,
	...
	public PerformRuleResult perform_CC(IsApplicableMatchCC isApplicableMatch) {
		...
		Object[] result2_bindingAndBlack = EndEvent2FinalStateSeqImpl
				.pattern_EndEvent2FinalStateSeq_30_2_bindingAndBlackFFFFFFFFFB(isApplicableMatch);
		if (result2_bindingAndBlack == null) {
		...
		// FN2S _n2s = (FN2S) result2_bindingAndBlack[3];
		// SimpleBPMN.Process process = (SimpleBPMN.Process) result2_bindingAndBlack[4];
		// SequenceFlow inFlow = (SequenceFlow) result2_bindingAndBlack[5];
		// SF2F _if2f = (SF2F) result2_bindingAndBlack[6];
		EndEvent event = (EndEvent) result2_bindingAndBlack[7];
		UCCondition state = (UCCondition) result2_bindingAndBlack[8];
		Object[] result2_green = EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_30_2_greenBBFF(event, state);
		PerformRuleResult result = (PerformRuleResult) result2_green[2];
		// EE2FS _e2s = (EE2FS) result2_green[3];

		return EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_30_3_expressionFB(result);
	}
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer, SF2F _if2fParameter) {
		// create result
		Object[] result1_black = EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_31_1_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException(
					"Pattern matching in node [create result] failed." + " Variables: " + "[this] = " + this + ".");
		}
		Object[] result1_green = EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_31_1_greenFF();
		IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result1_green[0];
		ModelgeneratorRuleResult ruleResult = (ModelgeneratorRuleResult) result1_green[1];

		// ForEach is applicable core
		for (Object[] result2_black : EndEvent2FinalStateSeqImpl
				.pattern_EndEvent2FinalStateSeq_31_2_blackFFFFFFFFBB(ruleEntryContainer, ruleResult)) {
			...
			// solve CSP
			Object[] result3_bindingAndBlack = EndEvent2FinalStateSeqImpl
					.pattern_EndEvent2FinalStateSeq_31_3_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch, step, node,
							flow, _n2s, process, inFlow, _if2f, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching in node [solve CSP] failed." + " Variables: " + "[this] = "
						+ this + ", " + "[isApplicableMatch] = " + isApplicableMatch + ", " + "[step] = " + step + ", "
						+ "[node] = " + node + ", " + "[flow] = " + flow + ", " + "[_n2s] = " + _n2s + ", "
						+ "[process] = " + process + ", " + "[inFlow] = " + inFlow + ", " + "[_if2f] = " + _if2f + ", "
						+ "[ruleResult] = " + ruleResult + ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// check CSP
			if (EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_31_4_expressionFBB(this, csp)) {
				// check nacs
				Object[] result5_black = EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_31_5_blackBBBBBBB(
						step, node, flow, _n2s, process, inFlow, _if2f);
				if (result5_black != null) {

					// perform
					Object[] result6_black = EndEvent2FinalStateSeqImpl
							.pattern_EndEvent2FinalStateSeq_31_6_blackBBBBBBBB(step, node, flow, _n2s, process, inFlow,
									_if2f, ruleResult);
					if (result6_black == null) {
					...
					EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_31_6_greenBBBBFFFBB(step, flow, process,
							inFlow, ruleResult, csp);
					// EndEvent event = (EndEvent) result6_green[4];
					// UCCondition state = (UCCondition) result6_green[5];
					// EE2FS _e2s = (EE2FS) result6_green[6];
		...
		return EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_31_7_expressionFB(ruleResult);
	}
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Step step, FlowNode node, Flow flow,
			FN2S _n2s, SimpleBPMN.Process process, SequenceFlow inFlow, SF2F _if2f,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.END_EVENT2_FINAL_STATE_SEQ___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_STEP_FLOWNODE_FLOW_FN2S_PROCESS_SEQUENCEFLOW_SF2F_ENDEVENT:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Step) arguments.get(1),
					...
					(SimpleBPMN.Process) arguments.get(5), (SequenceFlow) arguments.get(6), (SF2F) arguments.get(7),
		...
		case RulesPackage.END_EVENT2_FINAL_STATE_SEQ___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_STEP_FLOWNODE_FLOW_FN2S_PROCESS_SEQUENCEFLOW_SF2F_UCCONDITION:
		...
		case RulesPackage.END_EVENT2_FINAL_STATE_SEQ___IS_APPROPRIATE_BWD_EMOFLON_EDGE_125__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_125((EMoflonEdge) arguments.get(0));
		case RulesPackage.END_EVENT2_FINAL_STATE_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_382__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_382((EMoflonEdge) arguments.get(0));
		case RulesPackage.END_EVENT2_FINAL_STATE_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_383__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_383((EMoflonEdge) arguments.get(0));
		case RulesPackage.END_EVENT2_FINAL_STATE_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_384__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_384((EMoflonEdge) arguments.get(0));
		case RulesPackage.END_EVENT2_FINAL_STATE_SEQ___IS_APPROPRIATE_BWD_EMOFLON_EDGE_126__EMOFLONEDGE:
		...
		case RulesPackage.END_EVENT2_FINAL_STATE_SEQ___IS_APPLICABLE_SOLVE_CSP_CC__ISAPPLICABLEMATCHCC_STEP_FLOWNODE_FLOW_FN2S_PROCESS_SEQUENCEFLOW_SF2F_ENDEVENT_UCCONDITION_MATCH_MATCH:
		...
		case RulesPackage.END_EVENT2_FINAL_STATE_SEQ___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_STEP_FLOWNODE_FLOW_FN2S_PROCESS_SEQUENCEFLOW_SF2F_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_0_1_blackBBBBBB(EndEvent2FinalStateSeq _this,
			Match match, FlowNode node, SimpleBPMN.Process process, SequenceFlow inFlow, EndEvent event) {
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_0_4_greenBBBBFFF(Match match,
			SimpleBPMN.Process process, SequenceFlow inFlow, EndEvent event) {
							...
							if (tmpInFlow instanceof SequenceFlow) {
								...
								if (tmp_if2f instanceof SF2F) {
									...
									if (tmpEvent instanceof EndEvent) {
										...
										return new Object[] { step, node, flow, _n2s, process, inFlow, _if2f, event,
												isApplicableMatch };
									}
								}
							}
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_1_1_blackBBBBBBBBBFB(Step step, FlowNode node,
			Flow flow, FN2S _n2s, SimpleBPMN.Process process, SequenceFlow inFlow, SF2F _if2f, EndEvent event,
			EndEvent2FinalStateSeq _this, IsApplicableMatch isApplicableMatch) {
		if (!event.equals(node)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { step, node, flow, _n2s, process, inFlow, _if2f, event, _this, csp,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_1_1_bindingAndBlackFFFFFFFFBFB(
		...
		if (result_pattern_EndEvent2FinalStateSeq_1_1_binding != null) {
			...
			FN2S _n2s = (FN2S) result_pattern_EndEvent2FinalStateSeq_1_1_binding[3];
			...
			SF2F _if2f = (SF2F) result_pattern_EndEvent2FinalStateSeq_1_1_binding[6];
			...
			Object[] result_pattern_EndEvent2FinalStateSeq_1_1_black = pattern_EndEvent2FinalStateSeq_1_1_blackBBBBBBBBBFB(
					step, node, flow, _n2s, process, inFlow, _if2f, event, _this, isApplicableMatch);
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_1_1_greenBBBFFB(Step step, Flow flow, EndEvent event,
			CSP csp) {
		...
		return new Object[] { step, flow, event, state, _e2s, csp };
	}
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_1_3_blackBBBBBBBBBBB(PerformRuleResult ruleresult,
			EObject step, EObject node, EObject flow, EObject _n2s, EObject process, EObject inFlow, EObject _if2f,
								...
								if (!flow.equals(inFlow)) {
									if (!flow.equals(state)) {
										if (!_n2s.equals(step)) {
											if (!_n2s.equals(node)) {
												if (!_n2s.equals(flow)) {
													if (!_n2s.equals(process)) {
														if (!_n2s.equals(inFlow)) {
															if (!_n2s.equals(event)) {
																if (!_n2s.equals(state)) {
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_1_3_greenBBBBBBBBFFFFFFF(PerformRuleResult ruleresult,
			EObject step, EObject flow, EObject process, EObject inFlow, EObject event, EObject state, EObject _e2s) {
		...
		return new Object[] { ruleresult, step, flow, process, inFlow, event, state, _e2s, flow__step______last,
				process__event____flowElements, inFlow__event____targetRef, event__inFlow____incoming,
				flow__state____finalState, _e2s__event____source, _e2s__state____target };
	}

	public static final void pattern_EndEvent2FinalStateSeq_1_5_expressionBBBBBBBBBBBB(EndEvent2FinalStateSeq _this,
			PerformRuleResult ruleresult, EObject step, EObject node, EObject flow, EObject _n2s, EObject process,
			EObject inFlow, EObject _if2f, EObject event, EObject state, EObject _e2s) {
		_this.registerObjects_FWD(ruleresult, step, node, flow, _n2s, process, inFlow, _if2f, event, state, _e2s);
	...
	public static final Iterable<Object[]> pattern_EndEvent2FinalStateSeq_2_2_blackFBFFBBFBB(FlowNode node,
			SimpleBPMN.Process process, SequenceFlow inFlow, EndEvent event, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!event.equals(node)) {
			for (FN2S _n2s : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(node, FN2S.class,
					"source")) {
				Step step = _n2s.getTarget();
				if (step != null) {
					for (SF2F _if2f : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(inFlow,
							SF2F.class, "source")) {
						Flow flow = _if2f.getTarget();
						if (flow != null) {
							_result.add(new Object[] { step, node, flow, _n2s, process, inFlow, _if2f, event, match });
						}
										...
										if (inFlow.equals(_if2f.getSource())) {
											if (flow.equals(_if2f.getTarget())) {
												if (node.equals(inFlow.getSourceRef())) {
													_result.add(new Object[] { step, node, flow, _n2s, process, inFlow,
															_if2f, event });
												}
											}
										}
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_2_3_greenBBBBBBBBFFFFFFFFFFFFF(Step step, FlowNode node,
			Flow flow, FN2S _n2s, SimpleBPMN.Process process, SequenceFlow inFlow, SF2F _if2f, EndEvent event) {
		...
		inFlow__node____sourceRef.setName(inFlow__node____sourceRef_name_prime);
		node__inFlow____outgoing.setName(node__inFlow____outgoing_name_prime);
		return new Object[] { step, node, flow, _n2s, process, inFlow, _if2f, event, isApplicableMatch,
				flow__step____steps, _n2s__node____source, _n2s__step____target, process__inFlow____flowElements,
				process__event____flowElements, process__node____flowElements, inFlow__event____targetRef,
				event__inFlow____incoming, _if2f__inFlow____source, _if2f__flow____target, inFlow__node____sourceRef,
				node__inFlow____outgoing };
	}

	public static final Object[] pattern_EndEvent2FinalStateSeq_2_4_bindingFBBBBBBBBBB(EndEvent2FinalStateSeq _this,
			IsApplicableMatch isApplicableMatch, Step step, FlowNode node, Flow flow, FN2S _n2s,
			SimpleBPMN.Process process, SequenceFlow inFlow, SF2F _if2f, EndEvent event) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, step, node, flow, _n2s, process,
				inFlow, _if2f, event);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, step, node, flow, _n2s, process, inFlow, _if2f,
					event };
		}
		return null;
	}
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_2_4_bindingAndBlackFBBBBBBBBBB(
			...
			FN2S _n2s, SimpleBPMN.Process process, SequenceFlow inFlow, SF2F _if2f, EndEvent event) {
		Object[] result_pattern_EndEvent2FinalStateSeq_2_4_binding = pattern_EndEvent2FinalStateSeq_2_4_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, step, node, flow, _n2s, process, inFlow, _if2f, event);
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_10_4_greenBBBBFF(Match match, Step step, Flow flow,
			UCCondition state) {
		EMoflonEdge flow__step______last = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge flow__state____finalState = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		flow__step______last.setName(flow__step______last_name_prime);
		flow__state____finalState.setName(flow__state____finalState_name_prime);
		return new Object[] { match, step, flow, state, flow__step______last, flow__state____finalState };
	}
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_10_5_greenBBBF(Match match, Step step, Flow flow) {
		EMoflonEdge flow__step____steps = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
							...
							if (tmpInFlow instanceof SequenceFlow) {
								...
								if (tmp_if2f instanceof SF2F) {
									...
									if (tmpState instanceof UCCondition) {
										...
										return new Object[] { step, node, flow, _n2s, process, inFlow, _if2f, state,
												isApplicableMatch };
									}
								}
							}
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_11_1_blackBBBBBBBBBFB(Step step, FlowNode node,
			Flow flow, FN2S _n2s, SimpleBPMN.Process process, SequenceFlow inFlow, SF2F _if2f, UCCondition state,
			EndEvent2FinalStateSeq _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { step, node, flow, _n2s, process, inFlow, _if2f, state, _this, csp,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_11_1_bindingAndBlackFFFFFFFFBFB(
		...
		if (result_pattern_EndEvent2FinalStateSeq_11_1_binding != null) {
			...
			FN2S _n2s = (FN2S) result_pattern_EndEvent2FinalStateSeq_11_1_binding[3];
			SimpleBPMN.Process process = (SimpleBPMN.Process) result_pattern_EndEvent2FinalStateSeq_11_1_binding[4];
			SequenceFlow inFlow = (SequenceFlow) result_pattern_EndEvent2FinalStateSeq_11_1_binding[5];
			SF2F _if2f = (SF2F) result_pattern_EndEvent2FinalStateSeq_11_1_binding[6];
			...
			Object[] result_pattern_EndEvent2FinalStateSeq_11_1_black = pattern_EndEvent2FinalStateSeq_11_1_blackBBBBBBBBBFB(
					step, node, flow, _n2s, process, inFlow, _if2f, state, _this, isApplicableMatch);
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_11_1_greenBBFBFB(SimpleBPMN.Process process,
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_11_3_greenBBBBBBBBFFFFFFF(PerformRuleResult ruleresult,
			EObject step, EObject flow, EObject process, EObject inFlow, EObject event, EObject state, EObject _e2s) {
		EMoflonEdge flow__step______last = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge process__event____flowElements = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge inFlow__event____targetRef = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final void pattern_EndEvent2FinalStateSeq_11_5_expressionBBBBBBBBBBBB(EndEvent2FinalStateSeq _this,
			PerformRuleResult ruleresult, EObject step, EObject node, EObject flow, EObject _n2s, EObject process,
			EObject inFlow, EObject _if2f, EObject event, EObject state, EObject _e2s) {
		_this.registerObjects_BWD(ruleresult, step, node, flow, _n2s, process, inFlow, _if2f, event, state, _e2s);
		...
		for (FN2S _n2s : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(step, FN2S.class,
			...
			if (node != null) {
				for (SF2F _if2f : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(flow, SF2F.class,
					...
					if (inFlow != null) {
						_result.add(new Object[] { step, node, flow, _n2s, inFlow, _if2f, state, match });
					}
	...
	public static final Iterable<Object[]> pattern_EndEvent2FinalStateSeq_12_3_blackBBBBFBBB(Step step, FlowNode node,
			Flow flow, FN2S _n2s, SequenceFlow inFlow, SF2F _if2f, UCCondition state) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_12_3_greenBBBBBBBBFFFFFFFFFFFF(Step step, FlowNode node,
		...
		inFlow__node____sourceRef.setName(inFlow__node____sourceRef_name_prime);
		node__inFlow____outgoing.setName(node__inFlow____outgoing_name_prime);
		return new Object[] { step, node, flow, _n2s, process, inFlow, _if2f, state, isApplicableMatch,
				flow__step______last, flow__step____steps, _n2s__node____source, _n2s__step____target,
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_12_4_bindingFBBBBBBBBBB(EndEvent2FinalStateSeq _this,
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, step, node, flow, _n2s, process,
				inFlow, _if2f, state);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, step, node, flow, _n2s, process, inFlow, _if2f,
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_12_4_bindingAndBlackFBBBBBBBBBB(
			EndEvent2FinalStateSeq _this, IsApplicableMatch isApplicableMatch, Step step, FlowNode node, Flow flow,
			FN2S _n2s, SimpleBPMN.Process process, SequenceFlow inFlow, SF2F _if2f, UCCondition state) {
		Object[] result_pattern_EndEvent2FinalStateSeq_12_4_binding = pattern_EndEvent2FinalStateSeq_12_4_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, step, node, flow, _n2s, process, inFlow, _if2f, state);
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_20_2_black_nac_0B(UCCondition state) {
		for (UseCase __DEC_state_precondition_942631 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_20_2_black_nac_1BB(UCCondition state, Flow flow) {
		for (Flow __DEC_state_finalState_973109 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(state, Flow.class, "finalState")) {
			if (!flow.equals(__DEC_state_finalState_973109)) {
	...
	public static final Iterable<Object[]> pattern_EndEvent2FinalStateSeq_20_2_blackFFFB(EMoflonEdge _edge___last) {
		...
		if (tmpFlow instanceof Flow) {
			...
			if (tmpStep instanceof Step) {
				...
				if (step.equals(flow.get__last())) {
					if (flow.getSteps().contains(step)) {
						for (UCCondition state : flow.getFinalState()) {
							if (pattern_EndEvent2FinalStateSeq_20_2_black_nac_0B(state) == null) {
								if (pattern_EndEvent2FinalStateSeq_20_2_black_nac_1BB(state, flow) == null) {
									_result.add(new Object[] { step, flow, state, _edge___last });
								}
							}
						}
					}
	...
	public static final Iterable<Object[]> pattern_EndEvent2FinalStateSeq_21_2_blackFFFFB(
							...
							if (event.equals(inFlow.getTargetRef())) {
								...
								if (node != null) {
									if (!event.equals(node)) {
										if (process.getFlowElements().contains(node)) {
											_result.add(
													new Object[] { node, process, inFlow, event, _edge_flowElements });
										}
									}
								}
	...
	public static final Iterable<Object[]> pattern_EndEvent2FinalStateSeq_22_2_blackFFFFB(EMoflonEdge _edge_targetRef) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Iterable<Object[]> pattern_EndEvent2FinalStateSeq_23_2_blackFFFFB(EMoflonEdge _edge_incoming) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_24_2_black_nac_0B(UCCondition state) {
		for (UseCase __DEC_state_precondition_915099 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(state, UseCase.class, "precondition")) {
			return new Object[] { state };
		}
		return null;
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_24_2_black_nac_1BB(UCCondition state, Flow flow) {
		for (Flow __DEC_state_finalState_216146 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(state, Flow.class, "finalState")) {
			if (!flow.equals(__DEC_state_finalState_216146)) {
				return new Object[] { state, flow };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_EndEvent2FinalStateSeq_24_2_blackFFFB(EMoflonEdge _edge_finalState) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		...
		if (tmpFlow instanceof Flow) {
			...
			if (tmpState instanceof UCCondition) {
				...
				if (flow.getFinalState().contains(state)) {
					...
					if (step != null) {
						if (flow.getSteps().contains(step)) {
							if (pattern_EndEvent2FinalStateSeq_24_2_black_nac_0B(state) == null) {
								if (pattern_EndEvent2FinalStateSeq_24_2_black_nac_1BB(state, flow) == null) {
	...
	public static final boolean pattern_EndEvent2FinalStateSeq_24_3_expressionFBBBBB(EndEvent2FinalStateSeq _this,
			Match match, Step step, Flow flow, UCCondition state) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, step, flow, state);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_27_1_blackB(EndEvent2FinalStateSeq _this) {
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_27_2_bindingFFFFFFFBB(Match targetMatch,
			Match sourceMatch) {
		...
		EObject _localVariable_4 = sourceMatch.getObject("inFlow");
					...
					if (tmpProcess instanceof SimpleBPMN.Process) {
						...
						if (tmpInFlow instanceof SequenceFlow) {
							...
							if (tmpEvent instanceof EndEvent) {
								...
								if (tmpState instanceof UCCondition) {
									UCCondition state = (UCCondition) tmpState;
									return new Object[] { step, node, flow, process, inFlow, event, state, targetMatch,
											sourceMatch };
								}
							}
						}
	...
	public static final Iterable<Object[]> pattern_EndEvent2FinalStateSeq_27_2_blackBBBFBBFBBBB(Step step,
			FlowNode node, Flow flow, SimpleBPMN.Process process, SequenceFlow inFlow, EndEvent event,
												...
												for (FN2S _n2s : org.moflon.core.utilities.eMoflonEMFUtil
													...
													if (step.equals(_n2s.getTarget())) {
														for (SF2F _if2f : org.moflon.core.utilities.eMoflonEMFUtil
																.getOppositeReferenceTyped(inFlow, SF2F.class,
																		"source")) {
															if (flow.equals(_if2f.getTarget())) {
																_result.add(new Object[] { step, node, flow, _n2s,
																		process, inFlow, _if2f, event, state,
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_27_2_greenBBBBBBBBBBFB(Step step, FlowNode node,
			Flow flow, FN2S _n2s, SimpleBPMN.Process process, SequenceFlow inFlow, SF2F _if2f, EndEvent event,
			UCCondition state, Match sourceMatch, Match targetMatch) {
		...
		isApplicableMatch.getAllContextElements().add(_if2f);
		isApplicableMatch.setRuleName(isApplicableMatch_ruleName_prime);
		return new Object[] { step, node, flow, _n2s, process, inFlow, _if2f, event, state, sourceMatch,
				isApplicableMatch, targetMatch };
	}

	public static final Object[] pattern_EndEvent2FinalStateSeq_27_3_bindingFBBBBBBBBBBBBB(EndEvent2FinalStateSeq _this,
			IsApplicableMatchCC isApplicableMatch, Step step, FlowNode node, Flow flow, FN2S _n2s,
			SimpleBPMN.Process process, SequenceFlow inFlow, SF2F _if2f, EndEvent event, UCCondition state,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_CC(isApplicableMatch, step, node, flow, _n2s, process,
				inFlow, _if2f, event, state, sourceMatch, targetMatch);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, step, node, flow, _n2s, process, inFlow, _if2f, event,
					state, sourceMatch, targetMatch };
		}
		return null;
	}

	public static final Object[] pattern_EndEvent2FinalStateSeq_27_3_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_EndEvent2FinalStateSeq_27_3_bindingAndBlackFBBBBBBBBBBBBB(
			EndEvent2FinalStateSeq _this, IsApplicableMatchCC isApplicableMatch, Step step, FlowNode node, Flow flow,
			FN2S _n2s, SimpleBPMN.Process process, SequenceFlow inFlow, SF2F _if2f, EndEvent event, UCCondition state,
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_EndEvent2FinalStateSeq_27_3_binding = pattern_EndEvent2FinalStateSeq_27_3_bindingFBBBBBBBBBBBBB(
				_this, isApplicableMatch, step, node, flow, _n2s, process, inFlow, _if2f, event, state, sourceMatch,
				targetMatch);
		if (result_pattern_EndEvent2FinalStateSeq_27_3_binding != null) {
			CSP csp = (CSP) result_pattern_EndEvent2FinalStateSeq_27_3_binding[0];

			Object[] result_pattern_EndEvent2FinalStateSeq_27_3_black = pattern_EndEvent2FinalStateSeq_27_3_blackB(csp);
			if (result_pattern_EndEvent2FinalStateSeq_27_3_black != null) {
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_27_4_blackBB(IsApplicableRuleResult result,
			IsApplicableMatch isApplicableMatch) {
		return new Object[] { result, isApplicableMatch };
	}

	public static final Object[] pattern_EndEvent2FinalStateSeq_27_4_greenBB(IsApplicableRuleResult result,
			IsApplicableMatch isApplicableMatch) {
	...
	public static final IsApplicableRuleResult pattern_EndEvent2FinalStateSeq_27_5_expressionFB(
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_30_2_bindingFFFFFFFFFB(
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_30_2_blackBBBBBBBBBB(Step step, FlowNode node,
			Flow flow, FN2S _n2s, SimpleBPMN.Process process, SequenceFlow inFlow, SF2F _if2f, EndEvent event,
										...
										if (event.equals(inFlow.getTargetRef())) {
											if (flow.getFinalState().contains(state)) {
												if (inFlow.equals(_if2f.getSource())) {
													if (flow.equals(_if2f.getTarget())) {
														if (node.equals(inFlow.getSourceRef())) {
															return new Object[] { step, node, flow, _n2s, process,
																	inFlow, _if2f, event, state, isApplicableMatch };
														}
													}
												}
											}
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_30_2_bindingAndBlackFFFFFFFFFB(
			IsApplicableMatchCC isApplicableMatch) {
		Object[] result_pattern_EndEvent2FinalStateSeq_30_2_binding = pattern_EndEvent2FinalStateSeq_30_2_bindingFFFFFFFFFB(
				isApplicableMatch);
		if (result_pattern_EndEvent2FinalStateSeq_30_2_binding != null) {
			Step step = (Step) result_pattern_EndEvent2FinalStateSeq_30_2_binding[0];
			FlowNode node = (FlowNode) result_pattern_EndEvent2FinalStateSeq_30_2_binding[1];
			Flow flow = (Flow) result_pattern_EndEvent2FinalStateSeq_30_2_binding[2];
			FN2S _n2s = (FN2S) result_pattern_EndEvent2FinalStateSeq_30_2_binding[3];
			SimpleBPMN.Process process = (SimpleBPMN.Process) result_pattern_EndEvent2FinalStateSeq_30_2_binding[4];
			SequenceFlow inFlow = (SequenceFlow) result_pattern_EndEvent2FinalStateSeq_30_2_binding[5];
			SF2F _if2f = (SF2F) result_pattern_EndEvent2FinalStateSeq_30_2_binding[6];
			EndEvent event = (EndEvent) result_pattern_EndEvent2FinalStateSeq_30_2_binding[7];
			UCCondition state = (UCCondition) result_pattern_EndEvent2FinalStateSeq_30_2_binding[8];

			Object[] result_pattern_EndEvent2FinalStateSeq_30_2_black = pattern_EndEvent2FinalStateSeq_30_2_blackBBBBBBBBBB(
					step, node, flow, _n2s, process, inFlow, _if2f, event, state, isApplicableMatch);
			if (result_pattern_EndEvent2FinalStateSeq_30_2_black != null) {

				return new Object[] { step, node, flow, _n2s, process, inFlow, _if2f, event, state, isApplicableMatch };
			}
		}
		return null;
	}

	public static final Object[] pattern_EndEvent2FinalStateSeq_30_2_greenBBFF(EndEvent event, UCCondition state) {
	...
	public static final PerformRuleResult pattern_EndEvent2FinalStateSeq_30_3_expressionFB(PerformRuleResult result) {
		PerformRuleResult _result = result;
		return _result;
	}

	public static final Object[] pattern_EndEvent2FinalStateSeq_31_1_blackB(EndEvent2FinalStateSeq _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_EndEvent2FinalStateSeq_31_1_greenFF() {
		IsApplicableMatch isApplicableMatch = TGGRuntimeFactory.eINSTANCE.createIsApplicableMatch();
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_31_2_black_nac_0BB(ModelgeneratorRuleResult ruleResult,
			Step step) {
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_31_2_black_nac_1BB(ModelgeneratorRuleResult ruleResult,
			Flow flow) {
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_31_2_black_nac_2BB(ModelgeneratorRuleResult ruleResult,
			SF2F _if2f) {
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_31_2_black_nac_3BB(ModelgeneratorRuleResult ruleResult,
			SequenceFlow inFlow) {
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_31_2_black_nac_4BB(ModelgeneratorRuleResult ruleResult,
			FlowNode node) {
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_31_2_black_nac_5BB(ModelgeneratorRuleResult ruleResult,
			FN2S _n2s) {
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_31_2_black_nac_6BB(ModelgeneratorRuleResult ruleResult,
	...
	public static final Iterable<Object[]> pattern_EndEvent2FinalStateSeq_31_2_blackFFFFFFFFBB(
				...
				if (tmp_if2f instanceof SF2F) {
					...
					if (flow != null) {
						...
						if (inFlow != null) {
							FlowNode node = inFlow.getSourceRef();
							if (node != null) {
								if (pattern_EndEvent2FinalStateSeq_31_2_black_nac_2BB(ruleResult, _if2f) == null) {
									if (pattern_EndEvent2FinalStateSeq_31_2_black_nac_1BB(ruleResult, flow) == null) {
										if (pattern_EndEvent2FinalStateSeq_31_2_black_nac_3BB(ruleResult,
												inFlow) == null) {
											if (pattern_EndEvent2FinalStateSeq_31_2_black_nac_4BB(ruleResult,
													node) == null) {
												for (Step step : flow.getSteps()) {
													if (pattern_EndEvent2FinalStateSeq_31_2_black_nac_0BB(ruleResult,
															step) == null) {
														for (SimpleBPMN.Process process : org.moflon.core.utilities.eMoflonEMFUtil
																.getOppositeReferenceTyped(inFlow,
																		SimpleBPMN.Process.class, "flowElements")) {
															if (process.getFlowElements().contains(node)) {
																if (pattern_EndEvent2FinalStateSeq_31_2_black_nac_6BB(
																		ruleResult, process) == null) {
																	for (FN2S _n2s : org.moflon.core.utilities.eMoflonEMFUtil
																			.getOppositeReferenceTyped(node, FN2S.class,
																					"source")) {
																		if (step.equals(_n2s.getTarget())) {
																			if (pattern_EndEvent2FinalStateSeq_31_2_black_nac_5BB(
																					ruleResult, _n2s) == null) {
																				_result.add(new Object[] { _if2fList,
																						step, flow, _if2f, inFlow, node,
																						_n2s, process,
																						ruleEntryContainer,
																						ruleResult });
																			}
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_31_3_bindingFBBBBBBBBBB(EndEvent2FinalStateSeq _this,
			IsApplicableMatch isApplicableMatch, Step step, FlowNode node, Flow flow, FN2S _n2s,
			SimpleBPMN.Process process, SequenceFlow inFlow, SF2F _if2f, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, step, node, flow, _n2s, process,
				inFlow, _if2f, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, step, node, flow, _n2s, process, inFlow, _if2f,
					ruleResult };
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_31_3_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_EndEvent2FinalStateSeq_31_3_bindingAndBlackFBBBBBBBBBB(
			EndEvent2FinalStateSeq _this, IsApplicableMatch isApplicableMatch, Step step, FlowNode node, Flow flow,
			FN2S _n2s, SimpleBPMN.Process process, SequenceFlow inFlow, SF2F _if2f,
			ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_EndEvent2FinalStateSeq_31_3_binding = pattern_EndEvent2FinalStateSeq_31_3_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, step, node, flow, _n2s, process, inFlow, _if2f, ruleResult);
		if (result_pattern_EndEvent2FinalStateSeq_31_3_binding != null) {
			CSP csp = (CSP) result_pattern_EndEvent2FinalStateSeq_31_3_binding[0];

			Object[] result_pattern_EndEvent2FinalStateSeq_31_3_black = pattern_EndEvent2FinalStateSeq_31_3_blackB(csp);
			if (result_pattern_EndEvent2FinalStateSeq_31_3_black != null) {
	...
	public static final boolean pattern_EndEvent2FinalStateSeq_31_4_expressionFBB(EndEvent2FinalStateSeq _this,
			CSP csp) {
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_31_5_blackBBBBBBB(Step step, FlowNode node, Flow flow,
			FN2S _n2s, SimpleBPMN.Process process, SequenceFlow inFlow, SF2F _if2f) {
		return new Object[] { step, node, flow, _n2s, process, inFlow, _if2f };
	}

	public static final Object[] pattern_EndEvent2FinalStateSeq_31_6_blackBBBBBBBB(Step step, FlowNode node, Flow flow,
			FN2S _n2s, SimpleBPMN.Process process, SequenceFlow inFlow, SF2F _if2f,
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { step, node, flow, _n2s, process, inFlow, _if2f, ruleResult };
	}

	public static final Object[] pattern_EndEvent2FinalStateSeq_31_6_greenBBBBFFFBB(Step step, Flow flow,
		...
		return new Object[] { step, flow, process, inFlow, event, state, _e2s, ruleResult, csp };
	}

	public static final ModelgeneratorRuleResult pattern_EndEvent2FinalStateSeq_31_7_expressionFB(
			ModelgeneratorRuleResult ruleResult) {
