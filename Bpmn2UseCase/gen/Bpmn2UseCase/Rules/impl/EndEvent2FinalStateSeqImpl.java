...
public class EndEvent2FinalStateSeqImpl extends AbstractRuleImpl implements EndEvent2FinalStateSeq {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_1_3_greenBBBBBBBFFFFFF(ruleresult, flow, process,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_11_3_greenBBBBBBBFFFFFF(ruleresult, flow, process,
				inFlow, event, state, _e2s);
				// EMoflonEdge process__event____flowElements = (EMoflonEdge) result3_green[7];
				// EMoflonEdge inFlow__event____targetRef = (EMoflonEdge) result3_green[8];
				// EMoflonEdge event__inFlow____incoming = (EMoflonEdge) result3_green[9];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_12_2_blackBFBFFFBB(step,
			...
			for (Object[] result3_black : EndEvent2FinalStateSeqImpl
				...
				Object[] result3_green = EndEvent2FinalStateSeqImpl
						.pattern_EndEvent2FinalStateSeq_12_3_greenBBBBBBBBFFFFFFFFFFF(step, node, flow, _n2s, process,
								inFlow, _if2f, state);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[8];
				// EMoflonEdge flow__step____steps = (EMoflonEdge) result3_green[9];
				// EMoflonEdge _n2s__node____source = (EMoflonEdge) result3_green[10];
				...
				// EMoflonEdge flow__state____finalState = (EMoflonEdge) result3_green[14];
				...
				// EMoflonEdge inFlow__node____sourceRef = (EMoflonEdge) result3_green[17];
				// EMoflonEdge node__inFlow____outgoing = (EMoflonEdge) result3_green[18];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_107(EMoflonEdge _edge_finalState) {
		// prepare return value
		Object[] result1_bindingAndBlack = EndEvent2FinalStateSeqImpl
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		for (Object[] result2_black : EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_26_2_blackBBBFBBFBBBB(
		...
		for (Object[] result2_black : EndEvent2FinalStateSeqImpl
			...
			if (EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_30_4_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					// perform
					Object[] result6_black = EndEvent2FinalStateSeqImpl
							.pattern_EndEvent2FinalStateSeq_30_6_blackBBBBBBBB(step, node, flow, _n2s, process, inFlow,
									_if2f, ruleResult);
					if (result6_black == null) {
					...
					EndEvent2FinalStateSeqImpl.pattern_EndEvent2FinalStateSeq_30_6_greenBBBFFFBB(flow, process, inFlow,
							ruleResult, csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.END_EVENT2_FINAL_STATE_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_327__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_327((EMoflonEdge) arguments.get(0));
		case RulesPackage.END_EVENT2_FINAL_STATE_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_328__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_328((EMoflonEdge) arguments.get(0));
		case RulesPackage.END_EVENT2_FINAL_STATE_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_329__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_329((EMoflonEdge) arguments.get(0));
		case RulesPackage.END_EVENT2_FINAL_STATE_SEQ___IS_APPROPRIATE_BWD_EMOFLON_EDGE_107__EMOFLONEDGE:
	...
	public static final Iterable<Object[]> pattern_EndEvent2FinalStateSeq_2_2_blackFBFFBBFBB(FlowNode node,
		...
		if (!event.equals(node)) {
			for (FN2S _n2s : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(node, FN2S.class,
				...
				if (step != null) {
					boolean step__last = step.is__last();
					if (Boolean.valueOf(step__last).equals(Boolean.valueOf(true))) {
						for (SF2F _if2f : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(inFlow,
								SF2F.class, "source")) {
							Flow flow = _if2f.getTarget();
							if (flow != null) {
								_result.add(
										new Object[] { step, node, flow, _n2s, process, inFlow, _if2f, event, match });
							}
										...
										if (inFlow.equals(_if2f.getSource())) {
											if (flow.equals(_if2f.getTarget())) {
												if (node.equals(inFlow.getSourceRef())) {
													boolean step__last = step.is__last();
													if (Boolean.valueOf(step__last).equals(Boolean.valueOf(true))) {
														_result.add(new Object[] { step, node, flow, _n2s, process,
																inFlow, _if2f, event });
													}
	...
	public static final Iterable<Object[]> pattern_EndEvent2FinalStateSeq_12_2_blackBFBFFFBB(Step step, Flow flow,
		...
		if (Boolean.valueOf(step__last).equals(Boolean.valueOf(true))) {
			for (FN2S _n2s : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(step, FN2S.class,
				...
				if (node != null) {
					for (SF2F _if2f : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(flow,
							SF2F.class, "target")) {
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_12_3_greenBBBBBBBBFFFFFFFFFFF(Step step, FlowNode node,
			Flow flow, FN2S _n2s, SimpleBPMN.Process process, SequenceFlow inFlow, SF2F _if2f, UCCondition state) {
		IsApplicableMatch isApplicableMatch = TGGRuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge flow__step____steps = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge _n2s__node____source = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { step, node, flow, _n2s, process, inFlow, _if2f, state, isApplicableMatch,
				flow__step____steps, _n2s__node____source, _n2s__step____target, process__inFlow____flowElements,
				process__node____flowElements, flow__state____finalState, _if2f__inFlow____source,
				_if2f__flow____target, inFlow__node____sourceRef, node__inFlow____outgoing };
	}
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_23_2_black_nac_0B(UCCondition state) {
		for (UseCase __DEC_state_precondition_137958 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_23_2_black_nac_1BB(UCCondition state, Flow flow) {
		for (Flow __DEC_state_finalState_48967 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(state, Flow.class, "finalState")) {
			if (!flow.equals(__DEC_state_finalState_48967)) {
	...
	public static final Iterable<Object[]> pattern_EndEvent2FinalStateSeq_26_2_blackBBBFBBFBBBB(Step step,
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_29_2_bindingAndBlackFFFFFFFFFB(
		...
		if (result_pattern_EndEvent2FinalStateSeq_29_2_binding != null) {
			...
			FN2S _n2s = (FN2S) result_pattern_EndEvent2FinalStateSeq_29_2_binding[3];
			SimpleBPMN.Process process = (SimpleBPMN.Process) result_pattern_EndEvent2FinalStateSeq_29_2_binding[4];
			SequenceFlow inFlow = (SequenceFlow) result_pattern_EndEvent2FinalStateSeq_29_2_binding[5];
			SF2F _if2f = (SF2F) result_pattern_EndEvent2FinalStateSeq_29_2_binding[6];
				...
				if (tmp_if2f instanceof SF2F) {
					...
					if (flow != null) {
						...
						if (inFlow != null) {
							FlowNode node = inFlow.getSourceRef();
							if (node != null) {
								if (pattern_EndEvent2FinalStateSeq_30_2_black_nac_2BB(ruleResult, _if2f) == null) {
									if (pattern_EndEvent2FinalStateSeq_30_2_black_nac_1BB(ruleResult, flow) == null) {
										if (pattern_EndEvent2FinalStateSeq_30_2_black_nac_3BB(ruleResult,
												inFlow) == null) {
											if (pattern_EndEvent2FinalStateSeq_30_2_black_nac_4BB(ruleResult,
													node) == null) {
												for (Step step : flow.getSteps()) {
													boolean step__last = step.is__last();
													if (Boolean.valueOf(step__last).equals(Boolean.valueOf(true))) {
														if (pattern_EndEvent2FinalStateSeq_30_2_black_nac_0BB(
																			...
																			if (step.equals(_n2s.getTarget())) {
																				if (pattern_EndEvent2FinalStateSeq_30_2_black_nac_5BB(
																					...
																					_result.add(new Object[] {
																							_if2fList, step, flow,
																							_if2f, inFlow, node, _n2s,
																							process, ruleEntryContainer,
																							ruleResult });
																				}
																			}
																		}
	...
	public static final Object[] pattern_EndEvent2FinalStateSeq_30_6_greenBBBFFFBB(Flow flow,
