...
import bpmn2UseCase.Rules.ChoiceSeq;
...
public class ChoiceSeqImpl extends AbstractRuleImpl implements ChoiceSeq {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_20(EMoflonEdge _edge_next) {
		// prepare return value
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_21(EMoflonEdge _edge_steps) {
		// prepare return value
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_66(EMoflonEdge _edge_flowElements) {
		// prepare return value
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_67(EMoflonEdge _edge_flowElements) {
		// prepare return value
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_68(EMoflonEdge _edge_flowElements) {
		// prepare return value
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_69(EMoflonEdge _edge_sourceRef) {
		// prepare return value
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_70(EMoflonEdge _edge_outgoing) {
		// prepare return value
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_73(EMoflonEdge _edge___conv) {
		// prepare return value
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.CHOICE_SEQ___IS_APPROPRIATE_BWD_EMOFLON_EDGE_20__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_20((EMoflonEdge) arguments.get(0));
		case RulesPackage.CHOICE_SEQ___IS_APPROPRIATE_BWD_EMOFLON_EDGE_21__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_21((EMoflonEdge) arguments.get(0));
		case RulesPackage.CHOICE_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_66__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_66((EMoflonEdge) arguments.get(0));
		case RulesPackage.CHOICE_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_67__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_67((EMoflonEdge) arguments.get(0));
		case RulesPackage.CHOICE_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_68__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_68((EMoflonEdge) arguments.get(0));
		case RulesPackage.CHOICE_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_69__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_69((EMoflonEdge) arguments.get(0));
		case RulesPackage.CHOICE_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_70__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_70((EMoflonEdge) arguments.get(0));
		case RulesPackage.CHOICE_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_71__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_71((EMoflonEdge) arguments.get(0));
		case RulesPackage.CHOICE_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_72__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_72((EMoflonEdge) arguments.get(0));
		case RulesPackage.CHOICE_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_73__EMOFLONEDGE:
	...
	public static final Object[] pattern_ChoiceSeq_1_1_bindingAndBlackFFFFFFFFBFB(ChoiceSeq _this,
		...
		if (result_pattern_ChoiceSeq_1_1_binding != null) {
			...
			SimpleBPMN.Process process = (SimpleBPMN.Process) result_pattern_ChoiceSeq_1_1_binding[4];
	...
	public static final Object[] pattern_ChoiceSeq_11_1_blackBBBBBBBFB(FlowNode prevNode, Step prevStep, FN2S pn2ps,
			Flow flow, ChoiceStep step, SimpleBPMN.Process process, ChoiceSeq _this,
			IsApplicableMatch isApplicableMatch) {
		if (!prevStep.equals(step)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
	...
	public static final Object[] pattern_ChoiceSeq_11_1_bindingAndBlackFFFFFFBFB(ChoiceSeq _this,
		...
		if (result_pattern_ChoiceSeq_11_1_binding != null) {
			...
			SimpleBPMN.Process process = (SimpleBPMN.Process) result_pattern_ChoiceSeq_11_1_binding[5];
	...
	public static final Object[] pattern_ChoiceSeq_12_3_greenBBBBBBFFFFFFF(FlowNode prevNode, Step prevStep, FN2S pn2ps,
			Flow flow, ChoiceStep step, SimpleBPMN.Process process) {
		IsApplicableMatch isApplicableMatch = TGGRuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge prevStep__step____next = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge pn2ps__prevNode____source = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge pn2ps__prevStep____target = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final Object[] pattern_ChoiceSeq_20_2_black_nac_0BB(ChoiceStep step, Flow flow) {
		for (Flow __DEC_step_steps_792856 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(step,
				Flow.class, "steps")) {
			if (!flow.equals(__DEC_step_steps_792856)) {
	...
	public static final Object[] pattern_ChoiceSeq_20_2_black_nac_1BB(ChoiceStep step, Step prevStep) {
		if (!prevStep.equals(step)) {
			for (Step __DEC_step_next_978019 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(step,
					Step.class, "next")) {
				if (!step.equals(__DEC_step_next_978019)) {
					if (!prevStep.equals(__DEC_step_next_978019)) {
	...
	public static final Object[] pattern_ChoiceSeq_21_2_black_nac_0BB(ChoiceStep step, Flow flow) {
		for (Flow __DEC_step_steps_569823 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(step,
				Flow.class, "steps")) {
			if (!flow.equals(__DEC_step_steps_569823)) {
				return new Object[] { step, flow };
			}
		}
		return null;
	...
	public static final Object[] pattern_ChoiceSeq_21_2_black_nac_1BB(ChoiceStep step, Step prevStep) {
		if (!prevStep.equals(step)) {
			for (Step __DEC_step_next_523648 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(step,
					Step.class, "next")) {
				if (!step.equals(__DEC_step_next_523648)) {
					if (!prevStep.equals(__DEC_step_next_523648)) {
						return new Object[] { step, prevStep };
					}
				}
			}
	...
	public static final Object[] pattern_ChoiceSeq_22_2_black_nac_0BBBB(SequenceFlow sf1, FlowNode prevNode,
		...
		if (!egw.equals(prevNode)) {
			if (!ecgw.equals(prevNode)) {
				if (!ecgw.equals(egw)) {
					for (ExclusiveGateway __DEC_sf1_default_284080 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(sf1, ExclusiveGateway.class, "default")) {
						if (!prevNode.equals(__DEC_sf1_default_284080)) {
							if (!egw.equals(__DEC_sf1_default_284080)) {
								if (!ecgw.equals(__DEC_sf1_default_284080)) {
	...
	public static final Object[] pattern_ChoiceSeq_22_2_black_nac_1BB(SequenceFlow sf1, SimpleBPMN.Process process) {
		for (SimpleBPMN.Process __DEC_sf1_flowElements_125873 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(sf1, SimpleBPMN.Process.class, "flowElements")) {
			if (!process.equals(__DEC_sf1_flowElements_125873)) {
	...
	public static final Object[] pattern_ChoiceSeq_22_2_black_nac_2BB(ExclusiveGateway egw,
			SimpleBPMN.Process process) {
		for (SimpleBPMN.Process __DEC_egw_flowElements_130943 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(egw, SimpleBPMN.Process.class, "flowElements")) {
			if (!process.equals(__DEC_egw_flowElements_130943)) {
	...
	public static final Object[] pattern_ChoiceSeq_22_2_black_nac_3BBB(ExclusiveGateway egw, FlowNode prevNode,
		...
		if (!egw.equals(prevNode)) {
			if (!ecgw.equals(egw)) {
				if (!ecgw.equals(prevNode)) {
					for (Gateway __DEC_egw___conv_39229 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(egw, Gateway.class, "__conv")) {
						if (!egw.equals(__DEC_egw___conv_39229)) {
							if (!prevNode.equals(__DEC_egw___conv_39229)) {
								if (!ecgw.equals(__DEC_egw___conv_39229)) {
	...
	public static final Object[] pattern_ChoiceSeq_22_2_black_nac_4BBB(ExclusiveGateway ecgw, FlowNode prevNode,
		...
		if (!ecgw.equals(prevNode)) {
			if (!ecgw.equals(egw)) {
				if (!egw.equals(prevNode)) {
					Gateway __DEC_ecgw___conv_28889 = ecgw.get__conv();
					if (__DEC_ecgw___conv_28889 != null) {
						if (!ecgw.equals(__DEC_ecgw___conv_28889)) {
							if (!prevNode.equals(__DEC_ecgw___conv_28889)) {
								if (!egw.equals(__DEC_ecgw___conv_28889)) {
	...
	public static final Object[] pattern_ChoiceSeq_22_2_black_nac_5BB(ExclusiveGateway ecgw,
			SimpleBPMN.Process process) {
		for (SimpleBPMN.Process __DEC_ecgw_flowElements_116385 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(ecgw, SimpleBPMN.Process.class, "flowElements")) {
			if (!process.equals(__DEC_ecgw_flowElements_116385)) {
	...
	public static final Object[] pattern_ChoiceSeq_22_2_black_nac_6BBB(ExclusiveGateway ecgw, FlowNode prevNode,
		...
		if (!ecgw.equals(prevNode)) {
			if (!ecgw.equals(egw)) {
				if (!egw.equals(prevNode)) {
					for (Gateway __DEC_ecgw___conv_657626 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(ecgw, Gateway.class, "__conv")) {
						if (!ecgw.equals(__DEC_ecgw___conv_657626)) {
							if (!prevNode.equals(__DEC_ecgw___conv_657626)) {
								if (!egw.equals(__DEC_ecgw___conv_657626)) {
									return new Object[] { ecgw, prevNode, egw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_23_2_black_nac_0BBBB(SequenceFlow sf1, FlowNode prevNode,
		...
		if (!egw.equals(prevNode)) {
			if (!ecgw.equals(prevNode)) {
				if (!ecgw.equals(egw)) {
					for (ExclusiveGateway __DEC_sf1_default_570252 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(sf1, ExclusiveGateway.class, "default")) {
						if (!prevNode.equals(__DEC_sf1_default_570252)) {
							if (!egw.equals(__DEC_sf1_default_570252)) {
								if (!ecgw.equals(__DEC_sf1_default_570252)) {
									return new Object[] { sf1, prevNode, egw, ecgw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_23_2_black_nac_1BB(SequenceFlow sf1, SimpleBPMN.Process process) {
		for (SimpleBPMN.Process __DEC_sf1_flowElements_900323 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(sf1, SimpleBPMN.Process.class, "flowElements")) {
			if (!process.equals(__DEC_sf1_flowElements_900323)) {
				return new Object[] { sf1, process };
			}
		}
		return null;
	...
	public static final Object[] pattern_ChoiceSeq_23_2_black_nac_2BB(ExclusiveGateway egw,
			SimpleBPMN.Process process) {
		for (SimpleBPMN.Process __DEC_egw_flowElements_444928 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(egw, SimpleBPMN.Process.class, "flowElements")) {
			if (!process.equals(__DEC_egw_flowElements_444928)) {
				return new Object[] { egw, process };
			}
		}
		return null;
	...
	public static final Object[] pattern_ChoiceSeq_23_2_black_nac_3BBB(ExclusiveGateway egw, FlowNode prevNode,
		...
		if (!egw.equals(prevNode)) {
			if (!ecgw.equals(egw)) {
				if (!ecgw.equals(prevNode)) {
					for (Gateway __DEC_egw___conv_695263 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(egw, Gateway.class, "__conv")) {
						if (!egw.equals(__DEC_egw___conv_695263)) {
							if (!prevNode.equals(__DEC_egw___conv_695263)) {
								if (!ecgw.equals(__DEC_egw___conv_695263)) {
									return new Object[] { egw, prevNode, ecgw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_23_2_black_nac_4BBB(ExclusiveGateway ecgw, FlowNode prevNode,
		...
		if (!ecgw.equals(prevNode)) {
			if (!ecgw.equals(egw)) {
				if (!egw.equals(prevNode)) {
					Gateway __DEC_ecgw___conv_264443 = ecgw.get__conv();
					if (__DEC_ecgw___conv_264443 != null) {
						if (!ecgw.equals(__DEC_ecgw___conv_264443)) {
							if (!prevNode.equals(__DEC_ecgw___conv_264443)) {
								if (!egw.equals(__DEC_ecgw___conv_264443)) {
									return new Object[] { ecgw, prevNode, egw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_23_2_black_nac_5BB(ExclusiveGateway ecgw,
			SimpleBPMN.Process process) {
		for (SimpleBPMN.Process __DEC_ecgw_flowElements_550010 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(ecgw, SimpleBPMN.Process.class, "flowElements")) {
			if (!process.equals(__DEC_ecgw_flowElements_550010)) {
				return new Object[] { ecgw, process };
			}
		}
		return null;
	...
	public static final Object[] pattern_ChoiceSeq_23_2_black_nac_6BBB(ExclusiveGateway ecgw, FlowNode prevNode,
		...
		if (!ecgw.equals(prevNode)) {
			if (!ecgw.equals(egw)) {
				if (!egw.equals(prevNode)) {
					for (Gateway __DEC_ecgw___conv_895360 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(ecgw, Gateway.class, "__conv")) {
						if (!ecgw.equals(__DEC_ecgw___conv_895360)) {
							if (!prevNode.equals(__DEC_ecgw___conv_895360)) {
								if (!egw.equals(__DEC_ecgw___conv_895360)) {
									return new Object[] { ecgw, prevNode, egw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_24_2_black_nac_0BBBB(SequenceFlow sf1, FlowNode prevNode,
		...
		if (!egw.equals(prevNode)) {
			if (!ecgw.equals(prevNode)) {
				if (!ecgw.equals(egw)) {
					for (ExclusiveGateway __DEC_sf1_default_324609 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(sf1, ExclusiveGateway.class, "default")) {
						if (!prevNode.equals(__DEC_sf1_default_324609)) {
							if (!egw.equals(__DEC_sf1_default_324609)) {
								if (!ecgw.equals(__DEC_sf1_default_324609)) {
									return new Object[] { sf1, prevNode, egw, ecgw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_24_2_black_nac_1BB(SequenceFlow sf1, SimpleBPMN.Process process) {
		for (SimpleBPMN.Process __DEC_sf1_flowElements_463275 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(sf1, SimpleBPMN.Process.class, "flowElements")) {
			if (!process.equals(__DEC_sf1_flowElements_463275)) {
				return new Object[] { sf1, process };
			}
		}
		return null;
	...
	public static final Object[] pattern_ChoiceSeq_24_2_black_nac_2BB(ExclusiveGateway egw,
			SimpleBPMN.Process process) {
		for (SimpleBPMN.Process __DEC_egw_flowElements_522098 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(egw, SimpleBPMN.Process.class, "flowElements")) {
			if (!process.equals(__DEC_egw_flowElements_522098)) {
				return new Object[] { egw, process };
			}
		}
		return null;
	...
	public static final Object[] pattern_ChoiceSeq_24_2_black_nac_3BBB(ExclusiveGateway egw, FlowNode prevNode,
		...
		if (!egw.equals(prevNode)) {
			if (!ecgw.equals(egw)) {
				if (!ecgw.equals(prevNode)) {
					for (Gateway __DEC_egw___conv_853569 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(egw, Gateway.class, "__conv")) {
						if (!egw.equals(__DEC_egw___conv_853569)) {
							if (!prevNode.equals(__DEC_egw___conv_853569)) {
								if (!ecgw.equals(__DEC_egw___conv_853569)) {
									return new Object[] { egw, prevNode, ecgw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_24_2_black_nac_4BBB(ExclusiveGateway ecgw, FlowNode prevNode,
		...
		if (!ecgw.equals(prevNode)) {
			if (!ecgw.equals(egw)) {
				if (!egw.equals(prevNode)) {
					Gateway __DEC_ecgw___conv_923252 = ecgw.get__conv();
					if (__DEC_ecgw___conv_923252 != null) {
						if (!ecgw.equals(__DEC_ecgw___conv_923252)) {
							if (!prevNode.equals(__DEC_ecgw___conv_923252)) {
								if (!egw.equals(__DEC_ecgw___conv_923252)) {
									return new Object[] { ecgw, prevNode, egw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_24_2_black_nac_5BB(ExclusiveGateway ecgw,
			SimpleBPMN.Process process) {
		for (SimpleBPMN.Process __DEC_ecgw_flowElements_693334 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(ecgw, SimpleBPMN.Process.class, "flowElements")) {
			if (!process.equals(__DEC_ecgw_flowElements_693334)) {
				return new Object[] { ecgw, process };
			}
		}
		return null;
	...
	public static final Object[] pattern_ChoiceSeq_24_2_black_nac_6BBB(ExclusiveGateway ecgw, FlowNode prevNode,
		...
		if (!ecgw.equals(prevNode)) {
			if (!ecgw.equals(egw)) {
				if (!egw.equals(prevNode)) {
					for (Gateway __DEC_ecgw___conv_422087 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(ecgw, Gateway.class, "__conv")) {
						if (!ecgw.equals(__DEC_ecgw___conv_422087)) {
							if (!prevNode.equals(__DEC_ecgw___conv_422087)) {
								if (!egw.equals(__DEC_ecgw___conv_422087)) {
									return new Object[] { ecgw, prevNode, egw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_25_2_black_nac_0BBBB(SequenceFlow sf1, FlowNode prevNode,
		...
		if (!egw.equals(prevNode)) {
			if (!ecgw.equals(prevNode)) {
				if (!ecgw.equals(egw)) {
					for (ExclusiveGateway __DEC_sf1_default_935040 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(sf1, ExclusiveGateway.class, "default")) {
						if (!prevNode.equals(__DEC_sf1_default_935040)) {
							if (!egw.equals(__DEC_sf1_default_935040)) {
								if (!ecgw.equals(__DEC_sf1_default_935040)) {
									return new Object[] { sf1, prevNode, egw, ecgw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_25_2_black_nac_1BB(SequenceFlow sf1, SimpleBPMN.Process process) {
		for (SimpleBPMN.Process __DEC_sf1_flowElements_828915 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(sf1, SimpleBPMN.Process.class, "flowElements")) {
			if (!process.equals(__DEC_sf1_flowElements_828915)) {
				return new Object[] { sf1, process };
			}
		}
		return null;
	...
	public static final Object[] pattern_ChoiceSeq_25_2_black_nac_2BB(ExclusiveGateway egw,
			SimpleBPMN.Process process) {
		for (SimpleBPMN.Process __DEC_egw_flowElements_64378 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(egw, SimpleBPMN.Process.class, "flowElements")) {
			if (!process.equals(__DEC_egw_flowElements_64378)) {
				return new Object[] { egw, process };
			}
		}
		return null;
	...
	public static final Object[] pattern_ChoiceSeq_25_2_black_nac_3BBB(ExclusiveGateway egw, FlowNode prevNode,
		...
		if (!egw.equals(prevNode)) {
			if (!ecgw.equals(egw)) {
				if (!ecgw.equals(prevNode)) {
					for (Gateway __DEC_egw___conv_944065 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(egw, Gateway.class, "__conv")) {
						if (!egw.equals(__DEC_egw___conv_944065)) {
							if (!prevNode.equals(__DEC_egw___conv_944065)) {
								if (!ecgw.equals(__DEC_egw___conv_944065)) {
									return new Object[] { egw, prevNode, ecgw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_25_2_black_nac_4BBB(ExclusiveGateway ecgw, FlowNode prevNode,
		...
		if (!ecgw.equals(prevNode)) {
			if (!ecgw.equals(egw)) {
				if (!egw.equals(prevNode)) {
					Gateway __DEC_ecgw___conv_246802 = ecgw.get__conv();
					if (__DEC_ecgw___conv_246802 != null) {
						if (!ecgw.equals(__DEC_ecgw___conv_246802)) {
							if (!prevNode.equals(__DEC_ecgw___conv_246802)) {
								if (!egw.equals(__DEC_ecgw___conv_246802)) {
									return new Object[] { ecgw, prevNode, egw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_25_2_black_nac_5BB(ExclusiveGateway ecgw,
			SimpleBPMN.Process process) {
		for (SimpleBPMN.Process __DEC_ecgw_flowElements_618748 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(ecgw, SimpleBPMN.Process.class, "flowElements")) {
			if (!process.equals(__DEC_ecgw_flowElements_618748)) {
				return new Object[] { ecgw, process };
			}
		}
		return null;
	...
	public static final Object[] pattern_ChoiceSeq_25_2_black_nac_6BBB(ExclusiveGateway ecgw, FlowNode prevNode,
		...
		if (!ecgw.equals(prevNode)) {
			if (!ecgw.equals(egw)) {
				if (!egw.equals(prevNode)) {
					for (Gateway __DEC_ecgw___conv_262127 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(ecgw, Gateway.class, "__conv")) {
						if (!ecgw.equals(__DEC_ecgw___conv_262127)) {
							if (!prevNode.equals(__DEC_ecgw___conv_262127)) {
								if (!egw.equals(__DEC_ecgw___conv_262127)) {
									return new Object[] { ecgw, prevNode, egw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_26_2_black_nac_0BBBB(SequenceFlow sf1, FlowNode prevNode,
		...
		if (!egw.equals(prevNode)) {
			if (!ecgw.equals(prevNode)) {
				if (!ecgw.equals(egw)) {
					for (ExclusiveGateway __DEC_sf1_default_826433 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(sf1, ExclusiveGateway.class, "default")) {
						if (!prevNode.equals(__DEC_sf1_default_826433)) {
							if (!egw.equals(__DEC_sf1_default_826433)) {
								if (!ecgw.equals(__DEC_sf1_default_826433)) {
									return new Object[] { sf1, prevNode, egw, ecgw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_26_2_black_nac_1BB(SequenceFlow sf1, SimpleBPMN.Process process) {
		for (SimpleBPMN.Process __DEC_sf1_flowElements_97262 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(sf1, SimpleBPMN.Process.class, "flowElements")) {
			if (!process.equals(__DEC_sf1_flowElements_97262)) {
				return new Object[] { sf1, process };
			}
		}
		return null;
	...
	public static final Object[] pattern_ChoiceSeq_26_2_black_nac_2BB(ExclusiveGateway egw,
			SimpleBPMN.Process process) {
		for (SimpleBPMN.Process __DEC_egw_flowElements_967 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(egw, SimpleBPMN.Process.class, "flowElements")) {
			if (!process.equals(__DEC_egw_flowElements_967)) {
				return new Object[] { egw, process };
			}
		}
		return null;
	...
	public static final Object[] pattern_ChoiceSeq_26_2_black_nac_3BBB(ExclusiveGateway egw, FlowNode prevNode,
		...
		if (!egw.equals(prevNode)) {
			if (!ecgw.equals(egw)) {
				if (!ecgw.equals(prevNode)) {
					for (Gateway __DEC_egw___conv_457566 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(egw, Gateway.class, "__conv")) {
						if (!egw.equals(__DEC_egw___conv_457566)) {
							if (!prevNode.equals(__DEC_egw___conv_457566)) {
								if (!ecgw.equals(__DEC_egw___conv_457566)) {
									return new Object[] { egw, prevNode, ecgw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_26_2_black_nac_4BBB(ExclusiveGateway ecgw, FlowNode prevNode,
		...
		if (!ecgw.equals(prevNode)) {
			if (!ecgw.equals(egw)) {
				if (!egw.equals(prevNode)) {
					Gateway __DEC_ecgw___conv_354088 = ecgw.get__conv();
					if (__DEC_ecgw___conv_354088 != null) {
						if (!ecgw.equals(__DEC_ecgw___conv_354088)) {
							if (!prevNode.equals(__DEC_ecgw___conv_354088)) {
								if (!egw.equals(__DEC_ecgw___conv_354088)) {
									return new Object[] { ecgw, prevNode, egw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_26_2_black_nac_5BB(ExclusiveGateway ecgw,
			SimpleBPMN.Process process) {
		for (SimpleBPMN.Process __DEC_ecgw_flowElements_991843 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(ecgw, SimpleBPMN.Process.class, "flowElements")) {
			if (!process.equals(__DEC_ecgw_flowElements_991843)) {
				return new Object[] { ecgw, process };
			}
		}
		return null;
	...
	public static final Object[] pattern_ChoiceSeq_26_2_black_nac_6BBB(ExclusiveGateway ecgw, FlowNode prevNode,
		...
		if (!ecgw.equals(prevNode)) {
			if (!ecgw.equals(egw)) {
				if (!egw.equals(prevNode)) {
					for (Gateway __DEC_ecgw___conv_378691 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(ecgw, Gateway.class, "__conv")) {
						if (!ecgw.equals(__DEC_ecgw___conv_378691)) {
							if (!prevNode.equals(__DEC_ecgw___conv_378691)) {
								if (!egw.equals(__DEC_ecgw___conv_378691)) {
									return new Object[] { ecgw, prevNode, egw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_27_2_black_nac_0BBBB(SequenceFlow sf1, FlowNode prevNode,
		...
		if (!egw.equals(prevNode)) {
			if (!ecgw.equals(prevNode)) {
				if (!ecgw.equals(egw)) {
					for (ExclusiveGateway __DEC_sf1_default_619641 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(sf1, ExclusiveGateway.class, "default")) {
						if (!prevNode.equals(__DEC_sf1_default_619641)) {
							if (!egw.equals(__DEC_sf1_default_619641)) {
								if (!ecgw.equals(__DEC_sf1_default_619641)) {
									return new Object[] { sf1, prevNode, egw, ecgw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_27_2_black_nac_1BB(SequenceFlow sf1, SimpleBPMN.Process process) {
		for (SimpleBPMN.Process __DEC_sf1_flowElements_854102 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(sf1, SimpleBPMN.Process.class, "flowElements")) {
			if (!process.equals(__DEC_sf1_flowElements_854102)) {
				return new Object[] { sf1, process };
			}
		}
		return null;
	...
	public static final Object[] pattern_ChoiceSeq_27_2_black_nac_2BB(ExclusiveGateway egw,
			SimpleBPMN.Process process) {
		for (SimpleBPMN.Process __DEC_egw_flowElements_308015 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(egw, SimpleBPMN.Process.class, "flowElements")) {
			if (!process.equals(__DEC_egw_flowElements_308015)) {
				return new Object[] { egw, process };
			}
		}
		return null;
	...
	public static final Object[] pattern_ChoiceSeq_27_2_black_nac_3BBB(ExclusiveGateway egw, FlowNode prevNode,
		...
		if (!egw.equals(prevNode)) {
			if (!ecgw.equals(egw)) {
				if (!ecgw.equals(prevNode)) {
					for (Gateway __DEC_egw___conv_990548 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(egw, Gateway.class, "__conv")) {
						if (!egw.equals(__DEC_egw___conv_990548)) {
							if (!prevNode.equals(__DEC_egw___conv_990548)) {
								if (!ecgw.equals(__DEC_egw___conv_990548)) {
									return new Object[] { egw, prevNode, ecgw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_27_2_black_nac_4BBB(ExclusiveGateway ecgw, FlowNode prevNode,
		...
		if (!ecgw.equals(prevNode)) {
			if (!ecgw.equals(egw)) {
				if (!egw.equals(prevNode)) {
					Gateway __DEC_ecgw___conv_914446 = ecgw.get__conv();
					if (__DEC_ecgw___conv_914446 != null) {
						if (!ecgw.equals(__DEC_ecgw___conv_914446)) {
							if (!prevNode.equals(__DEC_ecgw___conv_914446)) {
								if (!egw.equals(__DEC_ecgw___conv_914446)) {
									return new Object[] { ecgw, prevNode, egw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_27_2_black_nac_5BB(ExclusiveGateway ecgw,
			SimpleBPMN.Process process) {
		for (SimpleBPMN.Process __DEC_ecgw_flowElements_742308 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(ecgw, SimpleBPMN.Process.class, "flowElements")) {
			if (!process.equals(__DEC_ecgw_flowElements_742308)) {
				return new Object[] { ecgw, process };
			}
		}
		return null;
	...
	public static final Object[] pattern_ChoiceSeq_27_2_black_nac_6BBB(ExclusiveGateway ecgw, FlowNode prevNode,
		...
		if (!ecgw.equals(prevNode)) {
			if (!ecgw.equals(egw)) {
				if (!egw.equals(prevNode)) {
					for (Gateway __DEC_ecgw___conv_130212 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(ecgw, Gateway.class, "__conv")) {
						if (!ecgw.equals(__DEC_ecgw___conv_130212)) {
							if (!prevNode.equals(__DEC_ecgw___conv_130212)) {
								if (!egw.equals(__DEC_ecgw___conv_130212)) {
									return new Object[] { ecgw, prevNode, egw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_28_2_black_nac_0BBBB(SequenceFlow sf1, FlowNode prevNode,
		...
		if (!egw.equals(prevNode)) {
			if (!ecgw.equals(prevNode)) {
				if (!ecgw.equals(egw)) {
					for (ExclusiveGateway __DEC_sf1_default_158594 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(sf1, ExclusiveGateway.class, "default")) {
						if (!prevNode.equals(__DEC_sf1_default_158594)) {
							if (!egw.equals(__DEC_sf1_default_158594)) {
								if (!ecgw.equals(__DEC_sf1_default_158594)) {
									return new Object[] { sf1, prevNode, egw, ecgw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_28_2_black_nac_1BB(SequenceFlow sf1, SimpleBPMN.Process process) {
		for (SimpleBPMN.Process __DEC_sf1_flowElements_101612 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(sf1, SimpleBPMN.Process.class, "flowElements")) {
			if (!process.equals(__DEC_sf1_flowElements_101612)) {
				return new Object[] { sf1, process };
			}
		}
		return null;
	...
	public static final Object[] pattern_ChoiceSeq_28_2_black_nac_2BB(ExclusiveGateway egw,
			SimpleBPMN.Process process) {
		for (SimpleBPMN.Process __DEC_egw_flowElements_69791 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(egw, SimpleBPMN.Process.class, "flowElements")) {
			if (!process.equals(__DEC_egw_flowElements_69791)) {
				return new Object[] { egw, process };
			}
		}
		return null;
	...
	public static final Object[] pattern_ChoiceSeq_28_2_black_nac_3BBB(ExclusiveGateway egw, FlowNode prevNode,
		...
		if (!egw.equals(prevNode)) {
			if (!ecgw.equals(egw)) {
				if (!ecgw.equals(prevNode)) {
					for (Gateway __DEC_egw___conv_343306 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(egw, Gateway.class, "__conv")) {
						if (!egw.equals(__DEC_egw___conv_343306)) {
							if (!prevNode.equals(__DEC_egw___conv_343306)) {
								if (!ecgw.equals(__DEC_egw___conv_343306)) {
									return new Object[] { egw, prevNode, ecgw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_28_2_black_nac_4BBB(ExclusiveGateway ecgw, FlowNode prevNode,
		...
		if (!ecgw.equals(prevNode)) {
			if (!ecgw.equals(egw)) {
				if (!egw.equals(prevNode)) {
					Gateway __DEC_ecgw___conv_581325 = ecgw.get__conv();
					if (__DEC_ecgw___conv_581325 != null) {
						if (!ecgw.equals(__DEC_ecgw___conv_581325)) {
							if (!prevNode.equals(__DEC_ecgw___conv_581325)) {
								if (!egw.equals(__DEC_ecgw___conv_581325)) {
									return new Object[] { ecgw, prevNode, egw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_28_2_black_nac_5BB(ExclusiveGateway ecgw,
			SimpleBPMN.Process process) {
		for (SimpleBPMN.Process __DEC_ecgw_flowElements_97337 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(ecgw, SimpleBPMN.Process.class, "flowElements")) {
			if (!process.equals(__DEC_ecgw_flowElements_97337)) {
				return new Object[] { ecgw, process };
			}
		}
		return null;
	...
	public static final Object[] pattern_ChoiceSeq_28_2_black_nac_6BBB(ExclusiveGateway ecgw, FlowNode prevNode,
		...
		if (!ecgw.equals(prevNode)) {
			if (!ecgw.equals(egw)) {
				if (!egw.equals(prevNode)) {
					for (Gateway __DEC_ecgw___conv_191152 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(ecgw, Gateway.class, "__conv")) {
						if (!ecgw.equals(__DEC_ecgw___conv_191152)) {
							if (!prevNode.equals(__DEC_ecgw___conv_191152)) {
								if (!egw.equals(__DEC_ecgw___conv_191152)) {
									return new Object[] { ecgw, prevNode, egw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_29_2_black_nac_0BBBB(SequenceFlow sf1, FlowNode prevNode,
		...
		if (!egw.equals(prevNode)) {
			if (!ecgw.equals(prevNode)) {
				if (!ecgw.equals(egw)) {
					for (ExclusiveGateway __DEC_sf1_default_232711 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(sf1, ExclusiveGateway.class, "default")) {
						if (!prevNode.equals(__DEC_sf1_default_232711)) {
							if (!egw.equals(__DEC_sf1_default_232711)) {
								if (!ecgw.equals(__DEC_sf1_default_232711)) {
									return new Object[] { sf1, prevNode, egw, ecgw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_29_2_black_nac_1BB(SequenceFlow sf1, SimpleBPMN.Process process) {
		for (SimpleBPMN.Process __DEC_sf1_flowElements_798031 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(sf1, SimpleBPMN.Process.class, "flowElements")) {
			if (!process.equals(__DEC_sf1_flowElements_798031)) {
				return new Object[] { sf1, process };
			}
		}
		return null;
	...
	public static final Object[] pattern_ChoiceSeq_29_2_black_nac_2BB(ExclusiveGateway egw,
			SimpleBPMN.Process process) {
		for (SimpleBPMN.Process __DEC_egw_flowElements_163569 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(egw, SimpleBPMN.Process.class, "flowElements")) {
			if (!process.equals(__DEC_egw_flowElements_163569)) {
				return new Object[] { egw, process };
			}
		}
		return null;
	...
	public static final Object[] pattern_ChoiceSeq_29_2_black_nac_3BBB(ExclusiveGateway egw, FlowNode prevNode,
		...
		if (!egw.equals(prevNode)) {
			if (!ecgw.equals(egw)) {
				if (!ecgw.equals(prevNode)) {
					for (Gateway __DEC_egw___conv_130487 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(egw, Gateway.class, "__conv")) {
						if (!egw.equals(__DEC_egw___conv_130487)) {
							if (!prevNode.equals(__DEC_egw___conv_130487)) {
								if (!ecgw.equals(__DEC_egw___conv_130487)) {
									return new Object[] { egw, prevNode, ecgw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_29_2_black_nac_4BBB(ExclusiveGateway ecgw, FlowNode prevNode,
		...
		if (!ecgw.equals(prevNode)) {
			if (!ecgw.equals(egw)) {
				if (!egw.equals(prevNode)) {
					Gateway __DEC_ecgw___conv_519860 = ecgw.get__conv();
					if (__DEC_ecgw___conv_519860 != null) {
						if (!ecgw.equals(__DEC_ecgw___conv_519860)) {
							if (!prevNode.equals(__DEC_ecgw___conv_519860)) {
								if (!egw.equals(__DEC_ecgw___conv_519860)) {
									return new Object[] { ecgw, prevNode, egw };
								}
							}
						}
	...
	public static final Object[] pattern_ChoiceSeq_29_2_black_nac_5BB(ExclusiveGateway ecgw,
			SimpleBPMN.Process process) {
		for (SimpleBPMN.Process __DEC_ecgw_flowElements_920468 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(ecgw, SimpleBPMN.Process.class, "flowElements")) {
			if (!process.equals(__DEC_ecgw_flowElements_920468)) {
				return new Object[] { ecgw, process };
			}
		}
		return null;
	...
	public static final Object[] pattern_ChoiceSeq_29_2_black_nac_6BBB(ExclusiveGateway ecgw, FlowNode prevNode,
		...
		if (!ecgw.equals(prevNode)) {
			if (!ecgw.equals(egw)) {
				if (!egw.equals(prevNode)) {
					for (Gateway __DEC_ecgw___conv_504141 : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(ecgw, Gateway.class, "__conv")) {
						if (!ecgw.equals(__DEC_ecgw___conv_504141)) {
							if (!prevNode.equals(__DEC_ecgw___conv_504141)) {
								if (!egw.equals(__DEC_ecgw___conv_504141)) {
									return new Object[] { ecgw, prevNode, egw };
								}
							}
						}
