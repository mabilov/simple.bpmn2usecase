 ...
 * @generated
 */
public class Task2NormalStepAfterPGImpl extends AbstractRuleImpl implements
		Task2NormalStepAfterPG {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public boolean isAppropriate_FWD(Match match, ParallelGateway node,
			...
			SequenceFlow sf2) {
		// initial bindings
		Object[] result1_black = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_0_1_blackBBBBBBB(this, match,
		...
		Object[] result2_bindingAndBlack = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_0_2_bindingAndBlackFBBBBBBB(
		...
		// Check CSP
		if (Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_0_3_expressionFBB(this, csp)) {

			// collect elements to be translated
			Object[] result4_black = Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_0_4_blackBBBBBB(match,
							node, process, sf1, task, sf2);
			...
			Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_0_4_greenBBBBBFFFFFF(match,
			...
			Object[] result5_black = Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_0_5_blackBBBBBB(match,
							node, process, sf1, task, sf2);
			...
			Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_0_5_greenBBBBFFFF(match,
							node, process, sf1);
			...
			Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_0_6_expressionBBBBBBB(this,
							match, node, process, sf1, task, sf2);
			return Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_0_7_expressionF();
		} else {
			return Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_0_8_expressionF();
		}
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_1_1_bindingAndBlackFFFFFFFBFB(
		...
		Object[] result1_green = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_1_1_greenBBFFBFB(flow, task,
						sf2, csp);
		...
		Object[] result2_black = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_1_2_blackBBBBB(task, step,
						_t2ns, sf2, _sf2f2);
		...
		Object[] result2_green = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_1_2_greenFBBBBB(task, step,
						_t2ns, sf2, _sf2f2);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		// bookkeeping for edges
		Object[] result3_black = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_1_3_blackBBBBBBBBBBB(
		...
		Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_1_3_greenBBBBBBBBBFFFFFFFFFFF(
		...
		// register objects
		Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_1_5_expressionBBBBBBBBBBBB(
						this, ruleresult, node, process, flow, sf1, task, step,
						_t2ns, sf2, _sf2f2, _sf2f1);
		return Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_1_6_expressionFB(ruleresult);
	}
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		Object[] result2_binding = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_2_2_bindingFFFFFB(match);
		...
		for (Object[] result2_black : Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_2_2_blackBBFBBBFB(node,
			...
			for (Object[] result3_black : Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_2_3_blackBBBBBBB(node,
							process, flow, sf1, task, sf2, _sf2f1)) {
				Object[] result3_green = Task2NormalStepAfterPGImpl
						.pattern_Task2NormalStepAfterPG_2_3_greenBBBBBBBFFFFFFFFFFFFF(
				...
				Object[] result4_bindingAndBlack = Task2NormalStepAfterPGImpl
						.pattern_Task2NormalStepAfterPG_2_4_bindingAndBlackFBBBBBBBBB(
				...
				// check CSP
				if (Task2NormalStepAfterPGImpl
						.pattern_Task2NormalStepAfterPG_2_5_expressionFBB(this,
								csp)) {

					// add match to rule result
					Object[] result6_black = Task2NormalStepAfterPGImpl
							.pattern_Task2NormalStepAfterPG_2_6_blackBB(
					...
					Task2NormalStepAfterPGImpl
							.pattern_Task2NormalStepAfterPG_2_6_greenBB(
									ruleresult, isApplicableMatch);
		...
		return Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_2_7_expressionFB(ruleresult);
	}
	...
	public boolean isAppropriate_BWD(Match match, Flow flow, NormalStep step) {
		// initial bindings
		Object[] result1_black = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_10_1_blackBBBB(this, match,
						flow, step);
		if (result1_black == null) {
			throw new RuntimeException(
					"Pattern matching in node [initial bindings] failed."
		...
		// Solve CSP
		Object[] result2_bindingAndBlack = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_10_2_bindingAndBlackFBBBB(this,
						match, flow, step);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [Solve CSP] failed."
		...
		// Check CSP
		if (Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_10_3_expressionFBB(this, csp)) {

			// collect elements to be translated
			Object[] result4_black = Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_10_4_blackBBB(match, flow,
							step);
			if (result4_black == null) {
				throw new RuntimeException(
						"Pattern matching in node [collect elements to be translated] failed."
			...
			Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_10_4_greenBBBF(match, flow,
							step);
			// EMoflonEdge flow__step____steps = (EMoflonEdge) result4_green[3];

			// collect context elements
			Object[] result5_black = Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_10_5_blackBBB(match, flow,
							step);
			if (result5_black == null) {
				throw new RuntimeException(
						"Pattern matching in node [collect context elements] failed."
			...
			Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_10_5_greenBB(match, flow);

			// register objects to match
			Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_10_6_expressionBBBB(this,
							match, flow, step);
			return Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_10_7_expressionF();
		} else {
			return Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_10_8_expressionF();
		}
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		// perform transformation
		Object[] result1_bindingAndBlack = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_11_1_bindingAndBlackFFFFFFBFB(
						this, isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [perform transformation] failed."
		...
		Object[] result1_green = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_11_1_greenBBBFBFFFB(process,
						flow, sf1, step, csp);
		...
		// collect translated elements
		Object[] result2_black = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_11_2_blackBBBBB(task, step,
						_t2ns, sf2, _sf2f2);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching in node [collect translated elements] failed."
		...
		Object[] result2_green = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_11_2_greenFBBBBB(task, step,
						_t2ns, sf2, _sf2f2);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		// bookkeeping for edges
		Object[] result3_black = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_11_3_blackBBBBBBBBBBB(
						ruleresult, node, process, flow, sf1, task, step,
						_t2ns, sf2, _sf2f2, _sf2f1);
		if (result3_black == null) {
			throw new RuntimeException(
		...
		Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_11_3_greenBBBBBBBBBFFFFFFFFFFF(
						ruleresult, process, flow, sf1, task, step, _t2ns, sf2,
						_sf2f2);
		// EMoflonEdge process__task____flowElements = (EMoflonEdge) result3_green[9];
		// EMoflonEdge process__sf2____flowElements = (EMoflonEdge) result3_green[10];
		...
		// register objects
		Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_11_5_expressionBBBBBBBBBBBB(
						this, ruleresult, node, process, flow, sf1, task, step,
						_t2ns, sf2, _sf2f2, _sf2f1);
		return Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_11_6_expressionFB(ruleresult);
	}
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		// ForEach core match
		Object[] result2_binding = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_12_2_bindingFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException("Binding in node core match failed."
					+ " Variables: " + "[match] = " + match + ".");
		}
		...
		for (Object[] result2_black : Task2NormalStepAfterPGImpl
			...
			for (Object[] result3_black : Task2NormalStepAfterPGImpl
				...
				// solve CSP
				Object[] result4_bindingAndBlack = Task2NormalStepAfterPGImpl
						.pattern_Task2NormalStepAfterPG_12_4_bindingAndBlackFBBBBBBBB(
								this, isApplicableMatch, node, process, flow,
								sf1, step, _sf2f1);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException(
				...
				// check CSP
				if (Task2NormalStepAfterPGImpl
						.pattern_Task2NormalStepAfterPG_12_5_expressionFBB(
								this, csp)) {

					// add match to rule result
					Object[] result6_black = Task2NormalStepAfterPGImpl
							.pattern_Task2NormalStepAfterPG_12_6_blackBB(
									ruleresult, isApplicableMatch);
					if (result6_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [add match to rule result] failed."
					...
					Task2NormalStepAfterPGImpl
							.pattern_Task2NormalStepAfterPG_12_6_greenBB(
									ruleresult, isApplicableMatch);
		...
		return Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_12_7_expressionFB(ruleresult);
	}
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_299(
		...
		Object[] result1_green = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_20_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_20_2_blackFFFFFB(_edge_flowElements)) {
			...
			Object[] result2_green = Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_20_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_20_3_expressionFBBBBBBB(
							this, match, node, process, sf1, task, sf2)) {
				// Ensure that the correct types of elements are matched
				if (Task2NormalStepAfterPGImpl
						.pattern_Task2NormalStepAfterPG_20_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = Task2NormalStepAfterPGImpl
							.pattern_Task2NormalStepAfterPG_20_5_blackBBB(
					...
					Task2NormalStepAfterPGImpl
							.pattern_Task2NormalStepAfterPG_20_5_greenBBB(
									match, __performOperation, __result);
		...
		return Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_20_6_expressionFB(__result);
	}
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_300(
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_21_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_21_2_blackFFFFFB(_edge_flowElements)) {
			ParallelGateway node = (ParallelGateway) result2_black[0];
			SimpleBPMN.Process process = (SimpleBPMN.Process) result2_black[1];
			SequenceFlow sf1 = (SequenceFlow) result2_black[2];
			Task task = (Task) result2_black[3];
			SequenceFlow sf2 = (SequenceFlow) result2_black[4];
			Object[] result2_green = Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_21_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_21_3_expressionFBBBBBBB(
							this, match, node, process, sf1, task, sf2)) {
				// Ensure that the correct types of elements are matched
				if (Task2NormalStepAfterPGImpl
						.pattern_Task2NormalStepAfterPG_21_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = Task2NormalStepAfterPGImpl
							.pattern_Task2NormalStepAfterPG_21_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					Task2NormalStepAfterPGImpl
							.pattern_Task2NormalStepAfterPG_21_5_greenBBB(
									match, __performOperation, __result);
		...
		return Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_21_6_expressionFB(__result);
	}
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_90(
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_22_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_22_2_blackFFB(_edge_steps)) {
			Flow flow = (Flow) result2_black[0];
			NormalStep step = (NormalStep) result2_black[1];
			Object[] result2_green = Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_22_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_22_3_expressionFBBBB(this,
							match, flow, step)) {
				// Ensure that the correct types of elements are matched
				if (Task2NormalStepAfterPGImpl
						.pattern_Task2NormalStepAfterPG_22_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = Task2NormalStepAfterPGImpl
							.pattern_Task2NormalStepAfterPG_22_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					Task2NormalStepAfterPGImpl
							.pattern_Task2NormalStepAfterPG_22_5_greenBBB(
									match, __performOperation, __result);
		...
		return Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_22_6_expressionFB(__result);
	}
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_301(
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_23_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_23_2_blackFFFFFB(_edge_targetRef)) {
			ParallelGateway node = (ParallelGateway) result2_black[0];
			SimpleBPMN.Process process = (SimpleBPMN.Process) result2_black[1];
			SequenceFlow sf1 = (SequenceFlow) result2_black[2];
			Task task = (Task) result2_black[3];
			SequenceFlow sf2 = (SequenceFlow) result2_black[4];
			Object[] result2_green = Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_23_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_23_3_expressionFBBBBBBB(
							this, match, node, process, sf1, task, sf2)) {
				// Ensure that the correct types of elements are matched
				if (Task2NormalStepAfterPGImpl
						.pattern_Task2NormalStepAfterPG_23_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = Task2NormalStepAfterPGImpl
							.pattern_Task2NormalStepAfterPG_23_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					Task2NormalStepAfterPGImpl
							.pattern_Task2NormalStepAfterPG_23_5_greenBBB(
									match, __performOperation, __result);
		...
		return Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_23_6_expressionFB(__result);
	}
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_302(
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_24_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_24_2_blackFFFFFB(_edge_incoming)) {
			ParallelGateway node = (ParallelGateway) result2_black[0];
			SimpleBPMN.Process process = (SimpleBPMN.Process) result2_black[1];
			SequenceFlow sf1 = (SequenceFlow) result2_black[2];
			Task task = (Task) result2_black[3];
			SequenceFlow sf2 = (SequenceFlow) result2_black[4];
			Object[] result2_green = Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_24_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_24_3_expressionFBBBBBBB(
							this, match, node, process, sf1, task, sf2)) {
				// Ensure that the correct types of elements are matched
				if (Task2NormalStepAfterPGImpl
						.pattern_Task2NormalStepAfterPG_24_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = Task2NormalStepAfterPGImpl
							.pattern_Task2NormalStepAfterPG_24_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					Task2NormalStepAfterPGImpl
							.pattern_Task2NormalStepAfterPG_24_5_greenBBB(
									match, __performOperation, __result);
		...
		return Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_24_6_expressionFB(__result);
	}
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_303(
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_25_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_25_2_blackFFFFFB(_edge_sourceRef)) {
			ParallelGateway node = (ParallelGateway) result2_black[0];
			SimpleBPMN.Process process = (SimpleBPMN.Process) result2_black[1];
			SequenceFlow sf1 = (SequenceFlow) result2_black[2];
			Task task = (Task) result2_black[3];
			SequenceFlow sf2 = (SequenceFlow) result2_black[4];
			Object[] result2_green = Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_25_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_25_3_expressionFBBBBBBB(
							this, match, node, process, sf1, task, sf2)) {
				// Ensure that the correct types of elements are matched
				if (Task2NormalStepAfterPGImpl
						.pattern_Task2NormalStepAfterPG_25_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = Task2NormalStepAfterPGImpl
							.pattern_Task2NormalStepAfterPG_25_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					Task2NormalStepAfterPGImpl
							.pattern_Task2NormalStepAfterPG_25_5_greenBBB(
									match, __performOperation, __result);
		...
		return Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_25_6_expressionFB(__result);
	}
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_304(
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_26_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_26_2_blackFFFFFB(_edge_outgoing)) {
			ParallelGateway node = (ParallelGateway) result2_black[0];
			SimpleBPMN.Process process = (SimpleBPMN.Process) result2_black[1];
			SequenceFlow sf1 = (SequenceFlow) result2_black[2];
			Task task = (Task) result2_black[3];
			SequenceFlow sf2 = (SequenceFlow) result2_black[4];
			Object[] result2_green = Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_26_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_26_3_expressionFBBBBBBB(
							this, match, node, process, sf1, task, sf2)) {
				// Ensure that the correct types of elements are matched
				if (Task2NormalStepAfterPGImpl
						.pattern_Task2NormalStepAfterPG_26_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = Task2NormalStepAfterPGImpl
							.pattern_Task2NormalStepAfterPG_26_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					Task2NormalStepAfterPGImpl
							.pattern_Task2NormalStepAfterPG_26_5_greenBBB(
									match, __performOperation, __result);
		...
		return Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_26_6_expressionFB(__result);
	}
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch,
		...
		// prepare
		Object[] result1_black = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_29_1_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException(
		...
		Object[] result1_green = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_29_1_greenF();
		IsApplicableRuleResult result = (IsApplicableRuleResult) result1_green[0];

		// ForEach match context
		Object[] result2_binding = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_29_2_bindingFFFFFFFBB(
		...
		for (Object[] result2_black : Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_29_2_blackBBBBBBBFBB(node,
						process, flow, sf1, task, step, sf2, sourceMatch,
						targetMatch)) {
			SF2F _sf2f1 = (SF2F) result2_black[7];
			Object[] result2_green = Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_29_2_greenBBBBBBBBBFB(node,
			...
			Object[] result3_bindingAndBlack = Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_29_3_bindingAndBlackFBBBBBBBBBBBB(
			...
			if (result3_bindingAndBlack != null) {
				...
				Object[] result4_black = Task2NormalStepAfterPGImpl
						.pattern_Task2NormalStepAfterPG_29_4_blackBB(result,
								isApplicableMatch);
				if (result4_black == null) {
					throw new RuntimeException(
				...
				Task2NormalStepAfterPGImpl
						.pattern_Task2NormalStepAfterPG_29_4_greenBB(result,
								isApplicableMatch);
		...
		return Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_29_5_expressionFB(result);
	}
	...
	public PerformRuleResult perform_CC(IsApplicableMatchCC isApplicableMatch) {
		// prepare
		Object[] result1_black = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_32_1_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		Object[] result2_bindingAndBlack = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_32_2_bindingAndBlackFFFFFFFFB(isApplicableMatch);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException(
		...
		Object[] result2_green = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_32_2_greenBBBBFFF(flow, task,
						step, sf2);
		...
		return Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_32_3_expressionFB(result);
	}
	...
	public ModelgeneratorRuleResult generateModel(
		...
		// create result
		Object[] result1_black = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_33_1_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException(
		...
		Object[] result1_green = Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_33_1_greenFF();
		IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result1_green[0];
		ModelgeneratorRuleResult ruleResult = (ModelgeneratorRuleResult) result1_green[1];

		// ForEach is applicable core
		for (Object[] result2_black : Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_33_2_blackFFFFFFBB(
			...
			// solve CSP
			Object[] result3_bindingAndBlack = Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_33_3_bindingAndBlackFBBBBBBBB(
							this, isApplicableMatch, node, process, flow, sf1,
							_sf2f1, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException(
			...
			// check CSP
			if (Task2NormalStepAfterPGImpl
					.pattern_Task2NormalStepAfterPG_33_4_expressionFBB(this,
							csp)) {
				// check nacs
				Object[] result5_black = Task2NormalStepAfterPGImpl
						.pattern_Task2NormalStepAfterPG_33_5_blackBBBBB(node,
								process, flow, sf1, _sf2f1);
				if (result5_black != null) {

					// perform
					Object[] result6_black = Task2NormalStepAfterPGImpl
							.pattern_Task2NormalStepAfterPG_33_6_blackBBBBBB(
					...
					Task2NormalStepAfterPGImpl
							.pattern_Task2NormalStepAfterPG_33_6_greenBBBFFFFFBB(
		...
		return Task2NormalStepAfterPGImpl
				.pattern_Task2NormalStepAfterPG_33_7_expressionFB(ruleResult);
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		case RulesPackage.TASK2_NORMAL_STEP_AFTER_PG___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_PARALLELGATEWAY_PROCESS_FLOW_SEQUENCEFLOW_TASK_SEQUENCEFLOW_SF2F:
		...
		case RulesPackage.TASK2_NORMAL_STEP_AFTER_PG___IS_APPROPRIATE_BWD__MATCH_FLOW_NORMALSTEP:
		...
		case RulesPackage.TASK2_NORMAL_STEP_AFTER_PG___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_FLOW_NORMALSTEP:
			registerObjectsToMatch_BWD((Match) arguments.get(0),
					(Flow) arguments.get(1), (NormalStep) arguments.get(2));
			return null;
		case RulesPackage.TASK2_NORMAL_STEP_AFTER_PG___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_FLOW_NORMALSTEP:
			return isAppropriate_solveCsp_BWD((Match) arguments.get(0),
					(Flow) arguments.get(1), (NormalStep) arguments.get(2));
		case RulesPackage.TASK2_NORMAL_STEP_AFTER_PG___IS_APPROPRIATE_CHECK_CSP_BWD__CSP:
			return isAppropriate_checkCsp_BWD((CSP) arguments.get(0));
		case RulesPackage.TASK2_NORMAL_STEP_AFTER_PG___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_PARALLELGATEWAY_PROCESS_FLOW_SEQUENCEFLOW_NORMALSTEP_SF2F:
		...
		case RulesPackage.TASK2_NORMAL_STEP_AFTER_PG___IS_APPROPRIATE_FWD_EMOFLON_EDGE_299__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_299((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.TASK2_NORMAL_STEP_AFTER_PG___IS_APPROPRIATE_FWD_EMOFLON_EDGE_300__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_300((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.TASK2_NORMAL_STEP_AFTER_PG___IS_APPROPRIATE_BWD_EMOFLON_EDGE_90__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_90((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.TASK2_NORMAL_STEP_AFTER_PG___IS_APPROPRIATE_FWD_EMOFLON_EDGE_301__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_301((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.TASK2_NORMAL_STEP_AFTER_PG___IS_APPROPRIATE_FWD_EMOFLON_EDGE_302__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_302((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.TASK2_NORMAL_STEP_AFTER_PG___IS_APPROPRIATE_FWD_EMOFLON_EDGE_303__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_303((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.TASK2_NORMAL_STEP_AFTER_PG___IS_APPROPRIATE_FWD_EMOFLON_EDGE_304__EMOFLONEDGE:
		...
		case RulesPackage.TASK2_NORMAL_STEP_AFTER_PG___IS_APPLICABLE_SOLVE_CSP_CC__ISAPPLICABLEMATCHCC_PARALLELGATEWAY_PROCESS_FLOW_SEQUENCEFLOW_TASK_NORMALSTEP_SEQUENCEFLOW_SF2F_MATCH_MATCH:
		...
		case RulesPackage.TASK2_NORMAL_STEP_AFTER_PG___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_PARALLELGATEWAY_PROCESS_FLOW_SEQUENCEFLOW_SF2F_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_0_1_blackBBBBBBB(
			Task2NormalStepAfterPG _this, Match match, ParallelGateway node,
			SimpleBPMN.Process process, SequenceFlow sf1, Task task,
			SequenceFlow sf2) {
		if (!sf1.equals(sf2)) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_0_2_bindingFBBBBBBB(
			Task2NormalStepAfterPG _this, Match match, ParallelGateway node,
			SimpleBPMN.Process process, SequenceFlow sf1, Task task,
			SequenceFlow sf2) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_0_2_blackB(
			CSP csp) {
	...
	public static final boolean pattern_Task2NormalStepAfterPG_0_3_expressionFBB(
			Task2NormalStepAfterPG _this, CSP csp) {
		boolean _localVariable_0 = _this.isAppropriate_checkCsp_FWD(csp);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_0_4_blackBBBBBB(
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_0_4_greenBBBBBFFFFFF(
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_0_5_blackBBBBBB(
			Match match, ParallelGateway node, SimpleBPMN.Process process,
			SequenceFlow sf1, Task task, SequenceFlow sf2) {
		if (!sf1.equals(sf2)) {
			return new Object[] { match, node, process, sf1, task, sf2 };
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_0_5_greenBBBBFFFF(
			Match match, ParallelGateway node, SimpleBPMN.Process process,
			SequenceFlow sf1) {
	...
	public static final void pattern_Task2NormalStepAfterPG_0_6_expressionBBBBBBB(
			Task2NormalStepAfterPG _this, Match match, ParallelGateway node,
			SimpleBPMN.Process process, SequenceFlow sf1, Task task,
			SequenceFlow sf2) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_1_1_blackBBBBBBBBFB(
			ParallelGateway node, SimpleBPMN.Process process, Flow flow,
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_1_1_bindingAndBlackFFFFFFFBFB(
			Task2NormalStepAfterPG _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_Task2NormalStepAfterPG_1_1_binding = pattern_Task2NormalStepAfterPG_1_1_bindingFFFFFFFB(isApplicableMatch);
		if (result_pattern_Task2NormalStepAfterPG_1_1_binding != null) {
			...
			SimpleBPMN.Process process = (SimpleBPMN.Process) result_pattern_Task2NormalStepAfterPG_1_1_binding[1];
			Flow flow = (Flow) result_pattern_Task2NormalStepAfterPG_1_1_binding[2];
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_1_1_greenBBFFBFB(
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_1_2_blackBBBBB(
			Task task, NormalStep step, T2NS _t2ns, SequenceFlow sf2,
			SF2F _sf2f2) {
		return new Object[] { task, step, _t2ns, sf2, _sf2f2 };
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_1_2_greenFBBBBB(
			Task task, NormalStep step, T2NS _t2ns, SequenceFlow sf2,
			SF2F _sf2f2) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_1_3_blackBBBBBBBBBBB(
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_1_3_greenBBBBBBBBBFFFFFFFFFFF(
	...
	public static final void pattern_Task2NormalStepAfterPG_1_5_expressionBBBBBBBBBBBB(
			Task2NormalStepAfterPG _this, PerformRuleResult ruleresult,
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_2_1_bindingFB(
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_2_1_blackFBB(
			EClass eClass, Task2NormalStepAfterPG _this) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_2_1_bindingAndBlackFFB(
			Task2NormalStepAfterPG _this) {
		Object[] result_pattern_Task2NormalStepAfterPG_2_1_binding = pattern_Task2NormalStepAfterPG_2_1_bindingFB(_this);
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_2_1_greenBF(
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_2_2_bindingFFFFFB(
			Match match) {
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepAfterPG_2_2_blackBBFBBBFB(
		...
		if (!sf1.equals(sf2)) {
			...
			if (Boolean.valueOf(nodeisDiverging).equals(Boolean.valueOf(true))) {
				for (SF2F _sf2f1 : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (flow != null) {
						_result.add(new Object[] { node, process, flow, sf1,
								task, sf2, _sf2f1, match });
					}
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepAfterPG_2_3_blackBBBBBBB(
			ParallelGateway node, SimpleBPMN.Process process, Flow flow,
			SequenceFlow sf1, Task task, SequenceFlow sf2, SF2F _sf2f1) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sf1.equals(sf2)) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_2_3_greenBBBBBBBFFFFFFFFFFFFF(
			ParallelGateway node, SimpleBPMN.Process process, Flow flow,
			SequenceFlow sf1, Task task, SequenceFlow sf2, SF2F _sf2f1) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_2_4_bindingFBBBBBBBBB(
			Task2NormalStepAfterPG _this, IsApplicableMatch isApplicableMatch,
			ParallelGateway node, SimpleBPMN.Process process, Flow flow,
			SequenceFlow sf1, Task task, SequenceFlow sf2, SF2F _sf2f1) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_2_4_blackB(
			CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final boolean pattern_Task2NormalStepAfterPG_2_5_expressionFBB(
			Task2NormalStepAfterPG _this, CSP csp) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_2_6_blackBB(
			IsApplicableRuleResult ruleresult,
			IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_2_6_greenBB(
			IsApplicableRuleResult ruleresult,
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_10_1_blackBBBB(
			Task2NormalStepAfterPG _this, Match match, Flow flow,
			NormalStep step) {
		return new Object[] { _this, match, flow, step };
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_10_2_bindingFBBBB(
			Task2NormalStepAfterPG _this, Match match, Flow flow,
			NormalStep step) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_10_2_blackB(
			CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_10_2_bindingAndBlackFBBBB(
			Task2NormalStepAfterPG _this, Match match, Flow flow,
			NormalStep step) {
	...
	public static final boolean pattern_Task2NormalStepAfterPG_10_3_expressionFBB(
			Task2NormalStepAfterPG _this, CSP csp) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_10_4_blackBBB(
			Match match, Flow flow, NormalStep step) {
		return new Object[] { match, flow, step };
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_10_4_greenBBBF(
			Match match, Flow flow, NormalStep step) {
		EMoflonEdge flow__step____steps = TGGRuntimeFactory.eINSTANCE
				.createEMoflonEdge();
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_10_5_blackBBB(
			Match match, Flow flow, NormalStep step) {
		return new Object[] { match, flow, step };
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_10_5_greenBB(
			Match match, Flow flow) {
		match.getContextNodes().add(flow);
		return new Object[] { match, flow };
	}

	public static final void pattern_Task2NormalStepAfterPG_10_6_expressionBBBB(
			Task2NormalStepAfterPG _this, Match match, Flow flow,
			NormalStep step) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_11_1_blackBBBBBBBFB(
			ParallelGateway node, SimpleBPMN.Process process, Flow flow,
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_11_1_bindingAndBlackFFFFFFBFB(
			Task2NormalStepAfterPG _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_Task2NormalStepAfterPG_11_1_binding = pattern_Task2NormalStepAfterPG_11_1_bindingFFFFFFB(isApplicableMatch);
		if (result_pattern_Task2NormalStepAfterPG_11_1_binding != null) {
			...
			SimpleBPMN.Process process = (SimpleBPMN.Process) result_pattern_Task2NormalStepAfterPG_11_1_binding[1];
			Flow flow = (Flow) result_pattern_Task2NormalStepAfterPG_11_1_binding[2];
			SequenceFlow sf1 = (SequenceFlow) result_pattern_Task2NormalStepAfterPG_11_1_binding[3];
			NormalStep step = (NormalStep) result_pattern_Task2NormalStepAfterPG_11_1_binding[4];
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_11_1_greenBBBFBFFFB(
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_11_2_blackBBBBB(
			Task task, NormalStep step, T2NS _t2ns, SequenceFlow sf2,
			SF2F _sf2f2) {
		return new Object[] { task, step, _t2ns, sf2, _sf2f2 };
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_11_2_greenFBBBBB(
			Task task, NormalStep step, T2NS _t2ns, SequenceFlow sf2,
			SF2F _sf2f2) {
		PerformRuleResult ruleresult = TGGRuntimeFactory.eINSTANCE
				.createPerformRuleResult();
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_11_3_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject node, EObject process,
			EObject flow, EObject sf1, EObject task, EObject step,
			EObject _t2ns, EObject sf2, EObject _sf2f2, EObject _sf2f1) {
		if (!node.equals(process)) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_11_3_greenBBBBBBBBBFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject process, EObject flow,
			EObject sf1, EObject task, EObject step, EObject _t2ns,
			EObject sf2, EObject _sf2f2) {
		EMoflonEdge process__task____flowElements = TGGRuntimeFactory.eINSTANCE
	...
	public static final void pattern_Task2NormalStepAfterPG_11_5_expressionBBBBBBBBBBBB(
			Task2NormalStepAfterPG _this, PerformRuleResult ruleresult,
			EObject node, EObject process, EObject flow, EObject sf1,
			EObject task, EObject step, EObject _t2ns, EObject sf2,
			EObject _sf2f2, EObject _sf2f1) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_12_1_bindingFB(
			Task2NormalStepAfterPG _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass eClass = _localVariable_0;
		if (eClass != null) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_12_1_blackFBB(
			EClass eClass, Task2NormalStepAfterPG _this) {
		for (EOperation performOperation : eClass.getEOperations()) {
			String performOperationname = performOperation.getName();
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_12_1_bindingAndBlackFFB(
			Task2NormalStepAfterPG _this) {
		Object[] result_pattern_Task2NormalStepAfterPG_12_1_binding = pattern_Task2NormalStepAfterPG_12_1_bindingFB(_this);
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_12_1_greenBF(
			EOperation performOperation) {
		IsApplicableRuleResult ruleresult = TGGRuntimeFactory.eINSTANCE
				.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = false;
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_12_2_bindingFFB(
			Match match) {
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepAfterPG_12_2_blackBFBFB(
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepAfterPG_12_3_blackFFBBBB(
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_12_3_greenBBBBBBFFFFFFFF(
			ParallelGateway node, SimpleBPMN.Process process, Flow flow,
			SequenceFlow sf1, NormalStep step, SF2F _sf2f1) {
		IsApplicableMatch isApplicableMatch = TGGRuntimeFactory.eINSTANCE
				.createIsApplicableMatch();
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_12_4_bindingFBBBBBBBB(
			Task2NormalStepAfterPG _this, IsApplicableMatch isApplicableMatch,
			ParallelGateway node, SimpleBPMN.Process process, Flow flow,
			SequenceFlow sf1, NormalStep step, SF2F _sf2f1) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_12_4_blackB(
			CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final boolean pattern_Task2NormalStepAfterPG_12_5_expressionFBB(
			Task2NormalStepAfterPG _this, CSP csp) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_12_6_blackBB(
			IsApplicableRuleResult ruleresult,
			IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_12_6_greenBB(
			IsApplicableRuleResult ruleresult,
			IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_20_1_bindingFB(
			Task2NormalStepAfterPG _this) {
		EClass _localVariable_0 = _this.eClass();
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_20_1_blackFBB(
			EClass __eClass, Task2NormalStepAfterPG _this) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_20_1_bindingAndBlackFFB(
			Task2NormalStepAfterPG _this) {
		Object[] result_pattern_Task2NormalStepAfterPG_20_1_binding = pattern_Task2NormalStepAfterPG_20_1_bindingFB(_this);
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_20_2_black_nac_0BB(
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepAfterPG_20_2_blackFFFFFB(
			EMoflonEdge _edge_flowElements) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
											...
											for (FlowElement tmpSf2 : process
												...
												if (tmpSf2 instanceof SequenceFlow) {
													...
													if (!sf1.equals(sf2)) {
														if (task.equals(sf2
																.getSourceRef())) {
															if (pattern_Task2NormalStepAfterPG_20_2_black_nac_0BB(
																	sf2, task) == null) {
																_result.add(new Object[] {
																		node,
																		process,
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_20_2_greenFB(
			EClass __eClass) {
	...
	public static final boolean pattern_Task2NormalStepAfterPG_20_3_expressionFBBBBBBB(
			Task2NormalStepAfterPG _this, Match match, ParallelGateway node,
			SimpleBPMN.Process process, SequenceFlow sf1, Task task,
			SequenceFlow sf2) {
	...
	public static final boolean pattern_Task2NormalStepAfterPG_20_4_expressionFBB(
			Task2NormalStepAfterPG _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_20_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_20_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
	...
	public static final EObjectContainer pattern_Task2NormalStepAfterPG_20_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_21_1_bindingFB(
			Task2NormalStepAfterPG _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_21_1_blackFBB(
			EClass __eClass, Task2NormalStepAfterPG _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_21_1_bindingAndBlackFFB(
			Task2NormalStepAfterPG _this) {
		Object[] result_pattern_Task2NormalStepAfterPG_21_1_binding = pattern_Task2NormalStepAfterPG_21_1_bindingFB(_this);
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_21_2_black_nac_0BB(
			SequenceFlow sf2, Task task) {
		if (task.equals(sf2.getTargetRef())) {
			return new Object[] { sf2, task };
		}
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepAfterPG_21_2_blackFFFFFB(
			EMoflonEdge _edge_flowElements) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		EObject tmpProcess = _edge_flowElements.getSrc();
		if (tmpProcess instanceof SimpleBPMN.Process) {
			...
			if (tmpSf2 instanceof SequenceFlow) {
				...
				if (process.getFlowElements().contains(sf2)) {
					...
					if (tmpTask instanceof Task) {
						Task task = (Task) tmpTask;
						if (process.getFlowElements().contains(task)) {
							if (pattern_Task2NormalStepAfterPG_21_2_black_nac_0BB(
									sf2, task) == null) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_21_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_Task2NormalStepAfterPG_21_3_expressionFBBBBBBB(
			Task2NormalStepAfterPG _this, Match match, ParallelGateway node,
			SimpleBPMN.Process process, SequenceFlow sf1, Task task,
			SequenceFlow sf2) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, node,
	...
	public static final boolean pattern_Task2NormalStepAfterPG_21_4_expressionFBB(
			Task2NormalStepAfterPG _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_21_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_21_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_Task2NormalStepAfterPG_21_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_22_1_bindingFB(
			Task2NormalStepAfterPG _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_22_1_blackFBB(
			EClass __eClass, Task2NormalStepAfterPG _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_22_1_bindingAndBlackFFB(
			Task2NormalStepAfterPG _this) {
		Object[] result_pattern_Task2NormalStepAfterPG_22_1_binding = pattern_Task2NormalStepAfterPG_22_1_bindingFB(_this);
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepAfterPG_22_2_blackFFB(
			EMoflonEdge _edge_steps) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_22_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_Task2NormalStepAfterPG_22_3_expressionFBBBB(
			Task2NormalStepAfterPG _this, Match match, Flow flow,
			NormalStep step) {
	...
	public static final boolean pattern_Task2NormalStepAfterPG_22_4_expressionFBB(
			Task2NormalStepAfterPG _this, Match match) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_22_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_22_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_Task2NormalStepAfterPG_22_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_23_1_bindingFB(
			Task2NormalStepAfterPG _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_23_1_blackFBB(
			EClass __eClass, Task2NormalStepAfterPG _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_23_1_bindingAndBlackFFB(
			Task2NormalStepAfterPG _this) {
		Object[] result_pattern_Task2NormalStepAfterPG_23_1_binding = pattern_Task2NormalStepAfterPG_23_1_bindingFB(_this);
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_23_2_black_nac_0BB(
			SequenceFlow sf2, Task task) {
		if (task.equals(sf2.getTargetRef())) {
			return new Object[] { sf2, task };
		}
					...
					if (tmpNode instanceof ParallelGateway) {
						...
						if (Boolean.valueOf(nodeisDiverging).equals(
							...
							for (SequenceFlow sf2 : task.getOutgoing()) {
								if (!sf1.equals(sf2)) {
									if (pattern_Task2NormalStepAfterPG_23_2_black_nac_0BB(
											sf2, task) == null) {
										for (SimpleBPMN.Process process : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_23_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_Task2NormalStepAfterPG_23_3_expressionFBBBBBBB(
			Task2NormalStepAfterPG _this, Match match, ParallelGateway node,
			SimpleBPMN.Process process, SequenceFlow sf1, Task task,
			SequenceFlow sf2) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, node,
	...
	public static final boolean pattern_Task2NormalStepAfterPG_23_4_expressionFBB(
			Task2NormalStepAfterPG _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_23_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_23_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_Task2NormalStepAfterPG_23_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_24_1_bindingFB(
			Task2NormalStepAfterPG _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_24_1_blackFBB(
			EClass __eClass, Task2NormalStepAfterPG _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_24_1_bindingAndBlackFFB(
			Task2NormalStepAfterPG _this) {
		Object[] result_pattern_Task2NormalStepAfterPG_24_1_binding = pattern_Task2NormalStepAfterPG_24_1_bindingFB(_this);
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_24_2_black_nac_0BB(
			SequenceFlow sf2, Task task) {
		if (task.equals(sf2.getTargetRef())) {
			return new Object[] { sf2, task };
		}
				...
				if (task.equals(sf1.getTargetRef())) {
					...
					if (tmpNode instanceof ParallelGateway) {
						...
						if (Boolean.valueOf(nodeisDiverging).equals(
							...
							for (SequenceFlow sf2 : task.getOutgoing()) {
								if (!sf1.equals(sf2)) {
									if (pattern_Task2NormalStepAfterPG_24_2_black_nac_0BB(
											sf2, task) == null) {
										for (SimpleBPMN.Process process : org.moflon.core.utilities.eMoflonEMFUtil
												.getOppositeReferenceTyped(
														task,
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_24_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_Task2NormalStepAfterPG_24_3_expressionFBBBBBBB(
			Task2NormalStepAfterPG _this, Match match, ParallelGateway node,
			SimpleBPMN.Process process, SequenceFlow sf1, Task task,
			SequenceFlow sf2) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, node,
	...
	public static final boolean pattern_Task2NormalStepAfterPG_24_4_expressionFBB(
			Task2NormalStepAfterPG _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_24_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_24_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_Task2NormalStepAfterPG_24_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_25_1_bindingFB(
			Task2NormalStepAfterPG _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_25_1_blackFBB(
			EClass __eClass, Task2NormalStepAfterPG _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_25_1_bindingAndBlackFFB(
			Task2NormalStepAfterPG _this) {
		Object[] result_pattern_Task2NormalStepAfterPG_25_1_binding = pattern_Task2NormalStepAfterPG_25_1_bindingFB(_this);
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_25_2_black_nac_0BB(
			SequenceFlow sf2, Task task) {
		if (task.equals(sf2.getTargetRef())) {
			return new Object[] { sf2, task };
		}
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepAfterPG_25_2_blackFFFFFB(
			EMoflonEdge _edge_sourceRef) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		...
		if (tmpSf2 instanceof SequenceFlow) {
			...
			if (tmpTask instanceof Task) {
				Task task = (Task) tmpTask;
				if (task.equals(sf2.getSourceRef())) {
					if (pattern_Task2NormalStepAfterPG_25_2_black_nac_0BB(sf2,
							task) == null) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_25_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_Task2NormalStepAfterPG_25_3_expressionFBBBBBBB(
			Task2NormalStepAfterPG _this, Match match, ParallelGateway node,
			SimpleBPMN.Process process, SequenceFlow sf1, Task task,
			SequenceFlow sf2) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, node,
	...
	public static final boolean pattern_Task2NormalStepAfterPG_25_4_expressionFBB(
			Task2NormalStepAfterPG _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_25_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_25_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_Task2NormalStepAfterPG_25_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_26_1_bindingFB(
			Task2NormalStepAfterPG _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_26_1_blackFBB(
			EClass __eClass, Task2NormalStepAfterPG _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_26_1_bindingAndBlackFFB(
			Task2NormalStepAfterPG _this) {
		Object[] result_pattern_Task2NormalStepAfterPG_26_1_binding = pattern_Task2NormalStepAfterPG_26_1_bindingFB(_this);
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_26_2_black_nac_0BB(
			SequenceFlow sf2, Task task) {
		if (task.equals(sf2.getTargetRef())) {
			return new Object[] { sf2, task };
		}
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepAfterPG_26_2_blackFFFFFB(
		...
		if (tmpTask instanceof Task) {
			...
			if (tmpSf2 instanceof SequenceFlow) {
				SequenceFlow sf2 = (SequenceFlow) tmpSf2;
				if (task.equals(sf2.getSourceRef())) {
					if (pattern_Task2NormalStepAfterPG_26_2_black_nac_0BB(sf2,
							task) == null) {
						for (SequenceFlow sf1 : task.getIncoming()) {
							if (!sf1.equals(sf2)) {
								FlowNode tmpNode = sf1.getSourceRef();
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_26_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_Task2NormalStepAfterPG_26_3_expressionFBBBBBBB(
			Task2NormalStepAfterPG _this, Match match, ParallelGateway node,
			SimpleBPMN.Process process, SequenceFlow sf1, Task task,
			SequenceFlow sf2) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, node,
	...
	public static final boolean pattern_Task2NormalStepAfterPG_26_4_expressionFBB(
			Task2NormalStepAfterPG _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_26_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_26_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_Task2NormalStepAfterPG_26_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_29_1_blackB(
			Task2NormalStepAfterPG _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_29_1_greenF() {
		IsApplicableRuleResult result = TGGRuntimeFactory.eINSTANCE
				.createIsApplicableRuleResult();
		return new Object[] { result };
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_29_2_bindingFFFFFFFBB(
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepAfterPG_29_2_blackBBBBBBBFBB(
			ParallelGateway node, SimpleBPMN.Process process, Flow flow,
			SequenceFlow sf1, Task task, NormalStep step, SequenceFlow sf2,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_29_2_greenBBBBBBBBBFB(
			ParallelGateway node, SimpleBPMN.Process process, Flow flow,
			SequenceFlow sf1, Task task, NormalStep step, SequenceFlow sf2,
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_29_3_bindingFBBBBBBBBBBBB(
			Task2NormalStepAfterPG _this,
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_29_3_blackB(
			CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_29_3_bindingAndBlackFBBBBBBBBBBBB(
			Task2NormalStepAfterPG _this,
			IsApplicableMatchCC isApplicableMatch, ParallelGateway node,
			SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, Task task,
			NormalStep step, SequenceFlow sf2, SF2F _sf2f1, Match sourceMatch,
			Match targetMatch) {
		Object[] result_pattern_Task2NormalStepAfterPG_29_3_binding = pattern_Task2NormalStepAfterPG_29_3_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, node, process, flow, sf1, task, step,
				sf2, _sf2f1, sourceMatch, targetMatch);
		if (result_pattern_Task2NormalStepAfterPG_29_3_binding != null) {
			CSP csp = (CSP) result_pattern_Task2NormalStepAfterPG_29_3_binding[0];

			Object[] result_pattern_Task2NormalStepAfterPG_29_3_black = pattern_Task2NormalStepAfterPG_29_3_blackB(csp);
			if (result_pattern_Task2NormalStepAfterPG_29_3_black != null) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_29_4_blackBB(
			IsApplicableRuleResult result, IsApplicableMatch isApplicableMatch) {
		return new Object[] { result, isApplicableMatch };
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_29_4_greenBB(
			IsApplicableRuleResult result, IsApplicableMatch isApplicableMatch) {
	...
	public static final IsApplicableRuleResult pattern_Task2NormalStepAfterPG_29_5_expressionFB(
			IsApplicableRuleResult result) {
		IsApplicableRuleResult _result = result;
		return _result;
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_32_1_blackB(
			Task2NormalStepAfterPG _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_32_2_bindingFFFFFFFFB(
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_32_2_blackBBBBBBBBB(
			ParallelGateway node, SimpleBPMN.Process process, Flow flow,
			SequenceFlow sf1, Task task, NormalStep step, SequenceFlow sf2,
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_32_2_bindingAndBlackFFFFFFFFB(
			IsApplicableMatchCC isApplicableMatch) {
		Object[] result_pattern_Task2NormalStepAfterPG_32_2_binding = pattern_Task2NormalStepAfterPG_32_2_bindingFFFFFFFFB(isApplicableMatch);
		if (result_pattern_Task2NormalStepAfterPG_32_2_binding != null) {
			ParallelGateway node = (ParallelGateway) result_pattern_Task2NormalStepAfterPG_32_2_binding[0];
			SimpleBPMN.Process process = (SimpleBPMN.Process) result_pattern_Task2NormalStepAfterPG_32_2_binding[1];
			Flow flow = (Flow) result_pattern_Task2NormalStepAfterPG_32_2_binding[2];
			SequenceFlow sf1 = (SequenceFlow) result_pattern_Task2NormalStepAfterPG_32_2_binding[3];
			Task task = (Task) result_pattern_Task2NormalStepAfterPG_32_2_binding[4];
			NormalStep step = (NormalStep) result_pattern_Task2NormalStepAfterPG_32_2_binding[5];
			SequenceFlow sf2 = (SequenceFlow) result_pattern_Task2NormalStepAfterPG_32_2_binding[6];
			SF2F _sf2f1 = (SF2F) result_pattern_Task2NormalStepAfterPG_32_2_binding[7];

			Object[] result_pattern_Task2NormalStepAfterPG_32_2_black = pattern_Task2NormalStepAfterPG_32_2_blackBBBBBBBBB(
					node, process, flow, sf1, task, step, sf2, _sf2f1,
					isApplicableMatch);
			if (result_pattern_Task2NormalStepAfterPG_32_2_black != null) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_32_2_greenBBBBFFF(
	...
	public static final PerformRuleResult pattern_Task2NormalStepAfterPG_32_3_expressionFB(
			PerformRuleResult result) {
		PerformRuleResult _result = result;
		return _result;
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_33_1_blackB(
			Task2NormalStepAfterPG _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_33_1_greenFF() {
		IsApplicableMatch isApplicableMatch = TGGRuntimeFactory.eINSTANCE
				.createIsApplicableMatch();
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_33_2_black_nac_0BB(
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_33_2_black_nac_1BB(
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_33_2_black_nac_2BB(
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_33_2_black_nac_3BB(
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_33_2_black_nac_4BB(
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepAfterPG_33_2_blackFFFFFFBB(
					...
					if (sf1 != null) {
						...
						if (flow != null) {
							...
							if (tmpNode instanceof ParallelGateway) {
								...
								if (Boolean.valueOf(nodeisDiverging).equals(
										Boolean.valueOf(true))) {
									if (pattern_Task2NormalStepAfterPG_33_2_black_nac_3BB(
											ruleResult, _sf2f1) == null) {
										if (pattern_Task2NormalStepAfterPG_33_2_black_nac_2BB(
												ruleResult, sf1) == null) {
											if (pattern_Task2NormalStepAfterPG_33_2_black_nac_4BB(
													ruleResult, flow) == null) {
												if (pattern_Task2NormalStepAfterPG_33_2_black_nac_0BB(
													...
													for (SimpleBPMN.Process process : org.moflon.core.utilities.eMoflonEMFUtil
														...
														if (process
																.getFlowElements()
																.contains(node)) {
															if (pattern_Task2NormalStepAfterPG_33_2_black_nac_1BB(
																	ruleResult,
																	process) == null) {
																_result.add(new Object[] {
																		_sf2f1List,
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_33_3_bindingFBBBBBBBB(
			Task2NormalStepAfterPG _this, IsApplicableMatch isApplicableMatch,
			ParallelGateway node, SimpleBPMN.Process process, Flow flow,
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_33_3_blackB(
			CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_Task2NormalStepAfterPG_33_3_bindingAndBlackFBBBBBBBB(
			Task2NormalStepAfterPG _this, IsApplicableMatch isApplicableMatch,
			ParallelGateway node, SimpleBPMN.Process process, Flow flow,
			SequenceFlow sf1, SF2F _sf2f1, ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_Task2NormalStepAfterPG_33_3_binding = pattern_Task2NormalStepAfterPG_33_3_bindingFBBBBBBBB(
				_this, isApplicableMatch, node, process, flow, sf1, _sf2f1,
				ruleResult);
		if (result_pattern_Task2NormalStepAfterPG_33_3_binding != null) {
			CSP csp = (CSP) result_pattern_Task2NormalStepAfterPG_33_3_binding[0];

			Object[] result_pattern_Task2NormalStepAfterPG_33_3_black = pattern_Task2NormalStepAfterPG_33_3_blackB(csp);
			if (result_pattern_Task2NormalStepAfterPG_33_3_black != null) {
	...
	public static final boolean pattern_Task2NormalStepAfterPG_33_4_expressionFBB(
			Task2NormalStepAfterPG _this, CSP csp) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_33_5_blackBBBBB(
			ParallelGateway node, SimpleBPMN.Process process, Flow flow,
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_33_6_blackBBBBBB(
			ParallelGateway node, SimpleBPMN.Process process, Flow flow,
			SequenceFlow sf1, SF2F _sf2f1, ModelgeneratorRuleResult ruleResult) {
		boolean nodeisDiverging = node.isIsDiverging();
		if (Boolean.valueOf(nodeisDiverging).equals(Boolean.valueOf(true))) {
	...
	public static final Object[] pattern_Task2NormalStepAfterPG_33_6_greenBBBFFFFFBB(
			SimpleBPMN.Process process, Flow flow, SequenceFlow sf1,
	...
	public static final ModelgeneratorRuleResult pattern_Task2NormalStepAfterPG_33_7_expressionFB(
			ModelgeneratorRuleResult ruleResult) {
