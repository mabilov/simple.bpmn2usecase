...
public class Task2NormalStepSeqImpl extends AbstractRuleImpl implements Task2NormalStepSeq {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_1_1_greenBFBBFBFB(prevStep, flow,
				task, sf2, csp);
		...
		Object[] result2_black = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_1_2_blackBBBBB(step, task, _t2ns,
				sf2, _sf2f2);
		...
		Object[] result2_green = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_1_2_greenFBBBBB(step, task, _t2ns,
				sf2, _sf2f2);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		// bookkeeping for edges
		Object[] result3_black = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_1_3_blackBBBBBBBBBBBBB(ruleresult,
				node, prevStep, _t2ps1, step, process, flow, sf1, task, _t2ns, sf2, _sf2f2, _sf2f1);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching in node [bookkeeping for edges] failed." + " Variables: "
					+ "[ruleresult] = " + ruleresult + ", " + "[node] = " + node + ", " + "[prevStep] = " + prevStep
					+ ", " + "[_t2ps1] = " + _t2ps1 + ", " + "[step] = " + step + ", " + "[process] = " + process + ", "
					+ "[flow] = " + flow + ", " + "[sf1] = " + sf1 + ", " + "[task] = " + task + ", " + "[_t2ns] = "
					+ _t2ns + ", " + "[sf2] = " + sf2 + ", " + "[_sf2f2] = " + _sf2f2 + ", " + "[_sf2f1] = " + _sf2f1
					+ ".");
		}
		Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_1_3_greenBBBBBBBBBBFFFFFFFFFFFF(ruleresult, prevStep, step,
				process, flow, sf1, task, _t2ns, sf2, _sf2f2);
		...
		// register objects
		Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_1_5_expressionBBBBBBBBBBBBBB(this, ruleresult, node, prevStep,
				_t2ps1, step, process, flow, sf1, task, _t2ns, sf2, _sf2f2, _sf2f1);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_2_2_blackBFFBFBBBFB(node,
			...
			for (Object[] result3_black : Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_2_3_blackBBBBBBBBB(node,
					prevStep, _t2ps1, process, flow, sf1, task, sf2, _sf2f1)) {
				Object[] result3_green = Task2NormalStepSeqImpl
						.pattern_Task2NormalStepSeq_2_3_greenBBBBBBBBBFFFFFFFFFFFFFFF(node, prevStep, _t2ps1, process,
				...
				Object[] result4_bindingAndBlack = Task2NormalStepSeqImpl
						.pattern_Task2NormalStepSeq_2_4_bindingAndBlackFBBBBBBBBBBB(this, isApplicableMatch, node,
								prevStep, _t2ps1, process, flow, sf1, task, sf2, _sf2f1);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException(
							"Pattern matching in node [solve CSP] failed." + " Variables: " + "[this] = " + this + ", "
									+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[node] = " + node + ", "
									+ "[prevStep] = " + prevStep + ", " + "[_t2ps1] = " + _t2ps1 + ", " + "[process] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Task node, NormalStep prevStep,
			T2NS _t2ps1, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, Task task, SequenceFlow sf2,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject node, EObject prevStep, EObject _t2ps1,
			EObject step, EObject process, EObject flow, EObject sf1, EObject task, EObject _t2ns, EObject sf2,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_11_1_greenBBBBFFFFB(step, process,
				flow, sf1, csp);
		...
		// collect translated elements
		Object[] result2_black = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_11_2_blackBBBBB(step, task, _t2ns,
				sf2, _sf2f2);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching in node [collect translated elements] failed." + " Variables: "
					+ "[step] = " + step + ", " + "[task] = " + task + ", " + "[_t2ns] = " + _t2ns + ", " + "[sf2] = "
		...
		Object[] result2_green = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_11_2_greenFBBBBB(step, task, _t2ns,
				sf2, _sf2f2);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
		...
		// perform postprocessing story node is empty
		// register objects
		Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_11_5_expressionBBBBBBBBBBBBBB(this, ruleresult, node,
				prevStep, _t2ps1, step, process, flow, sf1, task, _t2ns, sf2, _sf2f2, _sf2f1);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_12_2_blackFBFBBFFB(prevStep,
				step, flow, match)) {
			...
			// ForEach find context
			for (Object[] result3_black : Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_12_3_blackBBBBFBBB(node,
					prevStep, _t2ps1, step, flow, sf1, _sf2f1)) {
				SimpleBPMN.Process process = (SimpleBPMN.Process) result3_black[4];
				Object[] result3_green = Task2NormalStepSeqImpl
						.pattern_Task2NormalStepSeq_12_3_greenBBBBBBBBFFFFFFFFFFF(node, prevStep, _t2ps1, step, process,
								flow, sf1, _sf2f1);
				...
				// solve CSP
				Object[] result4_bindingAndBlack = Task2NormalStepSeqImpl
						.pattern_Task2NormalStepSeq_12_4_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch, node,
								prevStep, _t2ps1, step, process, flow, sf1, _sf2f1);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching in node [solve CSP] failed." + " Variables: "
							+ "[this] = " + this + ", " + "[isApplicableMatch] = " + isApplicableMatch + ", "
							+ "[node] = " + node + ", " + "[prevStep] = " + prevStep + ", " + "[_t2ps1] = " + _t2ps1
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Task node, NormalStep prevStep,
			T2NS _t2ps1, NormalStep step, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, SF2F _sf2f1) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject node, EObject prevStep, EObject _t2ps1,
			EObject step, EObject process, EObject flow, EObject sf1, EObject task, EObject _t2ns, EObject sf2,
			EObject _sf2f2, EObject _sf2f1) {
		ruleresult.registerObject("node", node);
		ruleresult.registerObject("prevStep", prevStep);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_107(EMoflonEdge _edge_flowElements) {
		// prepare return value
		Object[] result1_bindingAndBlack = Task2NormalStepSeqImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_108(EMoflonEdge _edge_targetRef) {
		// prepare return value
		Object[] result1_bindingAndBlack = Task2NormalStepSeqImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_109(EMoflonEdge _edge_incoming) {
		// prepare return value
		Object[] result1_bindingAndBlack = Task2NormalStepSeqImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_110(EMoflonEdge _edge_sourceRef) {
		// prepare return value
		Object[] result1_bindingAndBlack = Task2NormalStepSeqImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_111(EMoflonEdge _edge_outgoing) {
		// prepare return value
		Object[] result1_bindingAndBlack = Task2NormalStepSeqImpl
	...
	public AttributeConstraintsRuleResult checkAttributes_FWD(TripleMatch tripleMatch) {
		...
		Optional<TripleMatchNodeMapping> matchFor_t2ps1 = tripleMatch.getNodeMappings().stream()
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		for (Object[] result2_black : Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_30_2_blackBBFBBBBBBFBB(node,
				prevStep, step, process, flow, sf1, task, sf2, sourceMatch, targetMatch)) {
			T2NS _t2ps1 = (T2NS) result2_black[2];
			SF2F _sf2f1 = (SF2F) result2_black[9];
			Object[] result2_green = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_30_2_greenBBBBBBBBBBBFB(node,
					prevStep, _t2ps1, step, process, flow, sf1, task, sf2, _sf2f1, sourceMatch, targetMatch);
			...
			Object[] result3_bindingAndBlack = Task2NormalStepSeqImpl
					.pattern_Task2NormalStepSeq_30_3_bindingAndBlackFBBBBBBBBBBBBBB(this, isApplicableMatch, node,
							prevStep, _t2ps1, step, process, flow, sf1, task, sf2, _sf2f1, sourceMatch, targetMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(IsApplicableMatchCC isApplicableMatch, Task node, NormalStep prevStep,
			T2NS _t2ps1, NormalStep step, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, Task task,
	 ...
	 * @generated
	 */
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer, T2NS _t2ps1Parameter) {
		// create result
		...
		for (Object[] result2_black : Task2NormalStepSeqImpl
			...
			// solve CSP
			Object[] result3_bindingAndBlack = Task2NormalStepSeqImpl
					.pattern_Task2NormalStepSeq_34_3_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch, node, prevStep,
							_t2ps1, process, flow, sf1, _sf2f1, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching in node [solve CSP] failed." + " Variables: " + "[this] = "
						+ this + ", " + "[isApplicableMatch] = " + isApplicableMatch + ", " + "[node] = " + node + ", "
						+ "[prevStep] = " + prevStep + ", " + "[_t2ps1] = " + _t2ps1 + ", " + "[process] = " + process
						+ ", " + "[flow] = " + flow + ", " + "[sf1] = " + sf1 + ", " + "[_sf2f1] = " + _sf2f1 + ", "
			...
			if (Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_34_4_expressionFBB(this, csp)) {
				// check nacs
				Object[] result5_black = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_34_5_blackBBBBBBB(node,
						prevStep, _t2ps1, process, flow, sf1, _sf2f1);
				if (result5_black != null) {

					// perform
					Object[] result6_black = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_34_6_blackBBBBBBBB(node,
					...
					Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_34_6_greenBFBBBFFFFBB(prevStep, process, flow,
							sf1, ruleResult, csp);
	 ...
	 * @generated
	 */
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Task node, NormalStep prevStep,
			T2NS _t2ps1, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, SF2F _sf2f1,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TASK_NORMALSTEP_T2NS_PROCESS_FLOW_SEQUENCEFLOW_TASK_SEQUENCEFLOW_SF2F:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Task) arguments.get(1),
					(NormalStep) arguments.get(2), (T2NS) arguments.get(3), (SimpleBPMN.Process) arguments.get(4),
		...
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TASK_NORMALSTEP_T2NS_NORMALSTEP_PROCESS_FLOW_SEQUENCEFLOW_SF2F:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Task) arguments.get(1),
					(NormalStep) arguments.get(2), (T2NS) arguments.get(3), (NormalStep) arguments.get(4),
		...
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___IS_APPROPRIATE_BWD_EMOFLON_EDGE_31__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_31((EMoflonEdge) arguments.get(0));
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_106__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_106((EMoflonEdge) arguments.get(0));
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_107__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_107((EMoflonEdge) arguments.get(0));
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___IS_APPROPRIATE_BWD_EMOFLON_EDGE_32__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_32((EMoflonEdge) arguments.get(0));
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_108__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_108((EMoflonEdge) arguments.get(0));
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_109__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_109((EMoflonEdge) arguments.get(0));
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_110__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_110((EMoflonEdge) arguments.get(0));
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_111__EMOFLONEDGE:
		...
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___IS_APPLICABLE_SOLVE_CSP_CC__ISAPPLICABLEMATCHCC_TASK_NORMALSTEP_T2NS_NORMALSTEP_PROCESS_FLOW_SEQUENCEFLOW_TASK_SEQUENCEFLOW_SF2F_MATCH_MATCH:
			return isApplicable_solveCsp_CC((IsApplicableMatchCC) arguments.get(0), (Task) arguments.get(1),
					(NormalStep) arguments.get(2), (T2NS) arguments.get(3), (NormalStep) arguments.get(4),
					(SimpleBPMN.Process) arguments.get(5), (Flow) arguments.get(6), (SequenceFlow) arguments.get(7),
		...
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___GENERATE_MODEL__RULEENTRYCONTAINER_T2NS:
			return generateModel((RuleEntryContainer) arguments.get(0), (T2NS) arguments.get(1));
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TASK_NORMALSTEP_T2NS_PROCESS_FLOW_SEQUENCEFLOW_SF2F_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Task) arguments.get(1),
					(NormalStep) arguments.get(2), (T2NS) arguments.get(3), (SimpleBPMN.Process) arguments.get(4),
								...
								if (tmpTask instanceof Task) {
									...
									if (tmpSf2 instanceof SequenceFlow) {
										...
										if (tmp_sf2f1 instanceof SF2F) {
											...
											return new Object[] { node, prevStep, _t2ps1, process, flow, sf1, task, sf2,
	...
	public static final Object[] pattern_Task2NormalStepSeq_1_1_blackBBBBBBBBBBFB(Task node, NormalStep prevStep,
			T2NS _t2ps1, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, Task task, SequenceFlow sf2,
			...
			if (!sf1.equals(sf2)) {
				for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
					if (tmpCsp instanceof CSP) {
						CSP csp = (CSP) tmpCsp;
						return new Object[] { node, prevStep, _t2ps1, process, flow, sf1, task, sf2, _sf2f1, _this, csp,
								isApplicableMatch };
					}
				}
			}
	...
	public static final Object[] pattern_Task2NormalStepSeq_1_1_bindingAndBlackFFFFFFFFFBFB(Task2NormalStepSeq _this,
		...
		if (result_pattern_Task2NormalStepSeq_1_1_binding != null) {
			...
			Object[] result_pattern_Task2NormalStepSeq_1_1_black = pattern_Task2NormalStepSeq_1_1_blackBBBBBBBBBBFB(
					node, prevStep, _t2ps1, process, flow, sf1, task, sf2, _sf2f1, _this, isApplicableMatch);
	...
	public static final Object[] pattern_Task2NormalStepSeq_1_1_greenBFBBFBFB(NormalStep prevStep, Flow flow, Task task,
		...
		return new Object[] { prevStep, step, flow, task, _t2ns, sf2, _sf2f2, csp };
	}

	public static final Object[] pattern_Task2NormalStepSeq_1_2_blackBBBBB(NormalStep step, Task task, T2NS _t2ns,
			SequenceFlow sf2, SF2F _sf2f2) {
		return new Object[] { step, task, _t2ns, sf2, _sf2f2 };
	}

	public static final Object[] pattern_Task2NormalStepSeq_1_2_greenFBBBBB(NormalStep step, Task task, T2NS _t2ns,
			SequenceFlow sf2, SF2F _sf2f2) {
	...
	public static final Object[] pattern_Task2NormalStepSeq_1_3_blackBBBBBBBBBBBBB(PerformRuleResult ruleresult,
			EObject node, EObject prevStep, EObject _t2ps1, EObject step, EObject process, EObject flow, EObject sf1,
											...
											if (!prevStep.equals(task)) {
												if (!prevStep.equals(sf2)) {
													if (!_t2ps1.equals(node)) {
														if (!_t2ps1.equals(prevStep)) {
															if (!_t2ps1.equals(step)) {
																if (!_t2ps1.equals(process)) {
																	if (!_t2ps1.equals(flow)) {
																		if (!_t2ps1.equals(sf1)) {
																			if (!_t2ps1.equals(task)) {
																				if (!_t2ps1.equals(sf2)) {
																					if (!step.equals(task)) {
	...
	public static final Object[] pattern_Task2NormalStepSeq_1_3_greenBBBBBBBBBBFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject prevStep, EObject step, EObject process, EObject flow, EObject sf1,
			EObject task, EObject _t2ns, EObject sf2, EObject _sf2f2) {
		...
		return new Object[] { ruleresult, prevStep, step, process, flow, sf1, task, _t2ns, sf2, _sf2f2,
				prevStep__step____next, process__task____flowElements, process__sf2____flowElements,
				flow__step____steps, sf1__task____targetRef, task__sf1____incoming, sf2__task____sourceRef,
				task__sf2____outgoing, _t2ns__task____source, _t2ns__step____target, _sf2f2__sf2____source,
	...
	public static final void pattern_Task2NormalStepSeq_1_5_expressionBBBBBBBBBBBBBB(Task2NormalStepSeq _this,
			PerformRuleResult ruleresult, EObject node, EObject prevStep, EObject _t2ps1, EObject step, EObject process,
			EObject flow, EObject sf1, EObject task, EObject _t2ns, EObject sf2, EObject _sf2f2, EObject _sf2f1) {
		_this.registerObjects_FWD(ruleresult, node, prevStep, _t2ps1, step, process, flow, sf1, task, _t2ns, sf2,
				_sf2f2, _sf2f1);
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepSeq_2_2_blackBFFBFBBBFB(Task node,
			SimpleBPMN.Process process, SequenceFlow sf1, Task task, SequenceFlow sf2, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!node.equals(task)) {
			if (!sf1.equals(sf2)) {
				for (T2NS _t2ps1 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(node, T2NS.class,
						"source")) {
					...
					if (prevStep != null) {
						for (SF2F _sf2f1 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(sf1,
							...
							if (flow != null) {
								_result.add(new Object[] { node, prevStep, _t2ps1, process, flow, sf1, task, sf2,
										_sf2f1, match });
							}
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepSeq_2_3_blackBBBBBBBBB(Task node, NormalStep prevStep,
			T2NS _t2ps1, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, Task task, SequenceFlow sf2,
			SF2F _sf2f1) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!node.equals(task)) {
												...
												if (sf1.equals(_sf2f1.getSource())) {
													if (flow.equals(_sf2f1.getTarget())) {
														if (node.equals(sf1.getSourceRef())) {
															_result.add(new Object[] { node, prevStep, _t2ps1, process,
																	flow, sf1, task, sf2, _sf2f1 });
														}
													}
												}
	...
	public static final Object[] pattern_Task2NormalStepSeq_2_3_greenBBBBBBBBBFFFFFFFFFFFFFFF(Task node,
			NormalStep prevStep, T2NS _t2ps1, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, Task task,
			SequenceFlow sf2, SF2F _sf2f1) {
		IsApplicableMatch isApplicableMatch = TGGRuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge _t2ps1__node____source = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge _t2ps1__prevStep____target = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge process__task____flowElements = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge process__sf1____flowElements = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge process__node____flowElements = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge process__sf2____flowElements = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		isApplicableMatch.getAllContextElements().add(_t2ps1__prevStep____target);
		process__task____flowElements.setSrc(process);
		process__task____flowElements.setTrg(task);
		...
		_t2ps1__prevStep____target.setName(_t2ps1__prevStep____target_name_prime);
		process__task____flowElements.setName(process__task____flowElements_name_prime);
		process__sf1____flowElements.setName(process__sf1____flowElements_name_prime);
		process__node____flowElements.setName(process__node____flowElements_name_prime);
		process__sf2____flowElements.setName(process__sf2____flowElements_name_prime);
		...
		sf1__node____sourceRef.setName(sf1__node____sourceRef_name_prime);
		node__sf1____outgoing.setName(node__sf1____outgoing_name_prime);
		return new Object[] { node, prevStep, _t2ps1, process, flow, sf1, task, sf2, _sf2f1, isApplicableMatch,
				_t2ps1__node____source, _t2ps1__prevStep____target, process__task____flowElements,
	...
	public static final Object[] pattern_Task2NormalStepSeq_2_4_bindingFBBBBBBBBBBB(Task2NormalStepSeq _this,
			IsApplicableMatch isApplicableMatch, Task node, NormalStep prevStep, T2NS _t2ps1,
			SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, Task task, SequenceFlow sf2, SF2F _sf2f1) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, node, prevStep, _t2ps1, process, flow,
				sf1, task, sf2, _sf2f1);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, node, prevStep, _t2ps1, process, flow, sf1, task, sf2,
					_sf2f1 };
		}
		return null;
	}
	...
	public static final Object[] pattern_Task2NormalStepSeq_2_4_bindingAndBlackFBBBBBBBBBBB(Task2NormalStepSeq _this,
		...
		Object[] result_pattern_Task2NormalStepSeq_2_4_binding = pattern_Task2NormalStepSeq_2_4_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, node, prevStep, _t2ps1, process, flow, sf1, task, sf2, _sf2f1);
		if (result_pattern_Task2NormalStepSeq_2_4_binding != null) {
			...
			if (result_pattern_Task2NormalStepSeq_2_4_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, node, prevStep, _t2ps1, process, flow, sf1, task,
						sf2, _sf2f1 };
			}
		}
		return null;
						...
						if (tmpProcess instanceof SimpleBPMN.Process) {
							...
							if (tmpFlow instanceof Flow) {
								...
								if (tmpSf1 instanceof SequenceFlow) {
									...
									if (tmp_sf2f1 instanceof SF2F) {
										SF2F _sf2f1 = (SF2F) tmp_sf2f1;
										return new Object[] { node, prevStep, _t2ps1, step, process, flow, sf1, _sf2f1,
												isApplicableMatch };
									}
								}
							}
	...
	public static final Object[] pattern_Task2NormalStepSeq_11_1_blackBBBBBBBBBFB(Task node, NormalStep prevStep,
			T2NS _t2ps1, NormalStep step, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, SF2F _sf2f1,
			Task2NormalStepSeq _this, IsApplicableMatch isApplicableMatch) {
		if (!prevStep.equals(step)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { node, prevStep, _t2ps1, step, process, flow, sf1, _sf2f1, _this, csp,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_Task2NormalStepSeq_11_1_bindingAndBlackFFFFFFFFBFB(Task2NormalStepSeq _this,
		...
		if (result_pattern_Task2NormalStepSeq_11_1_binding != null) {
			...
			Object[] result_pattern_Task2NormalStepSeq_11_1_black = pattern_Task2NormalStepSeq_11_1_blackBBBBBBBBBFB(
					node, prevStep, _t2ps1, step, process, flow, sf1, _sf2f1, _this, isApplicableMatch);
	...
	public static final Object[] pattern_Task2NormalStepSeq_11_1_greenBBBBFFFFB(NormalStep step,
		...
		return new Object[] { step, process, flow, sf1, task, _t2ns, sf2, _sf2f2, csp };
	}

	public static final Object[] pattern_Task2NormalStepSeq_11_2_blackBBBBB(NormalStep step, Task task, T2NS _t2ns,
			SequenceFlow sf2, SF2F _sf2f2) {
		return new Object[] { step, task, _t2ns, sf2, _sf2f2 };
	}

	public static final Object[] pattern_Task2NormalStepSeq_11_2_greenFBBBBB(NormalStep step, Task task, T2NS _t2ns,
			SequenceFlow sf2, SF2F _sf2f2) {
		PerformRuleResult ruleresult = TGGRuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final void pattern_Task2NormalStepSeq_11_5_expressionBBBBBBBBBBBBBB(Task2NormalStepSeq _this,
			PerformRuleResult ruleresult, EObject node, EObject prevStep, EObject _t2ps1, EObject step, EObject process,
			EObject flow, EObject sf1, EObject task, EObject _t2ns, EObject sf2, EObject _sf2f2, EObject _sf2f1) {
		_this.registerObjects_BWD(ruleresult, node, prevStep, _t2ps1, step, process, flow, sf1, task, _t2ns, sf2,
				_sf2f2, _sf2f1);
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepSeq_12_2_blackFBFBBFFB(NormalStep prevStep,
			NormalStep step, Flow flow, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!prevStep.equals(step)) {
			for (T2NS _t2ps1 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(prevStep, T2NS.class,
					"target")) {
				...
				if (node != null) {
					for (SF2F _sf2f1 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(flow,
						...
						if (sf1 != null) {
							_result.add(new Object[] { node, prevStep, _t2ps1, step, flow, sf1, _sf2f1, match });
						}
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepSeq_12_3_blackBBBBFBBB(Task node, NormalStep prevStep,
			T2NS _t2ps1, NormalStep step, Flow flow, SequenceFlow sf1, SF2F _sf2f1) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!prevStep.equals(step)) {
									...
									if (node.equals(sf1.getSourceRef())) {
										for (SimpleBPMN.Process process : org.moflon.core.utilities.eMoflonEMFUtil
												.getOppositeReferenceTyped(sf1, SimpleBPMN.Process.class,
														"flowElements")) {
											if (process.getFlowElements().contains(node)) {
												_result.add(new Object[] { node, prevStep, _t2ps1, step, process, flow,
														sf1, _sf2f1 });
											}
										}
									}
	...
	public static final Object[] pattern_Task2NormalStepSeq_12_3_greenBBBBBBBBFFFFFFFFFFF(Task node,
			NormalStep prevStep, T2NS _t2ps1, NormalStep step, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1,
			SF2F _sf2f1) {
		IsApplicableMatch isApplicableMatch = TGGRuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge prevStep__step____next = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge _t2ps1__node____source = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		sf1__node____sourceRef.setName(sf1__node____sourceRef_name_prime);
		node__sf1____outgoing.setName(node__sf1____outgoing_name_prime);
		return new Object[] { node, prevStep, _t2ps1, step, process, flow, sf1, _sf2f1, isApplicableMatch,
				prevStep__step____next, _t2ps1__node____source, _t2ps1__prevStep____target,
				process__sf1____flowElements, process__node____flowElements, flow__step____steps, _sf2f1__sf1____source,
				_sf2f1__flow____target, sf1__node____sourceRef, node__sf1____outgoing };
	}

	public static final Object[] pattern_Task2NormalStepSeq_12_4_bindingFBBBBBBBBBB(Task2NormalStepSeq _this,
			IsApplicableMatch isApplicableMatch, Task node, NormalStep prevStep, T2NS _t2ps1, NormalStep step,
			SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, SF2F _sf2f1) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, node, prevStep, _t2ps1, step, process,
				flow, sf1, _sf2f1);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, node, prevStep, _t2ps1, step, process, flow, sf1,
					_sf2f1 };
		}
		return null;
	}
	...
	public static final Object[] pattern_Task2NormalStepSeq_12_4_bindingAndBlackFBBBBBBBBBB(Task2NormalStepSeq _this,
		...
		Object[] result_pattern_Task2NormalStepSeq_12_4_binding = pattern_Task2NormalStepSeq_12_4_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, node, prevStep, _t2ps1, step, process, flow, sf1, _sf2f1);
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepSeq_30_2_blackBBFBBBBBBFBB(Task node,
													...
													if (task.equals(sf2.getSourceRef())) {
														if (node.equals(sf1.getSourceRef())) {
															for (T2NS _t2ps1 : org.moflon.core.utilities.eMoflonEMFUtil
																	.getOppositeReferenceTyped(node, T2NS.class,
																			"source")) {
																if (prevStep.equals(_t2ps1.getTarget())) {
	...
	public static final Object[] pattern_Task2NormalStepSeq_30_2_greenBBBBBBBBBBBFB(Task node, NormalStep prevStep,
			T2NS _t2ps1, NormalStep step, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, Task task,
		...
		isApplicableMatch.getAllContextElements().add(_sf2f1);
		isApplicableMatch.setRuleName(isApplicableMatch_ruleName_prime);
		return new Object[] { node, prevStep, _t2ps1, step, process, flow, sf1, task, sf2, _sf2f1, sourceMatch,
	...
	public static final Object[] pattern_Task2NormalStepSeq_30_3_bindingFBBBBBBBBBBBBBB(Task2NormalStepSeq _this,
			IsApplicableMatchCC isApplicableMatch, Task node, NormalStep prevStep, T2NS _t2ps1, NormalStep step,
			SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, Task task, SequenceFlow sf2, SF2F _sf2f1,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_CC(isApplicableMatch, node, prevStep, _t2ps1, step, process,
				flow, sf1, task, sf2, _sf2f1, sourceMatch, targetMatch);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, node, prevStep, _t2ps1, step, process, flow, sf1, task,
	...
	public static final Object[] pattern_Task2NormalStepSeq_30_3_bindingAndBlackFBBBBBBBBBBBBBB(
			Task2NormalStepSeq _this, IsApplicableMatchCC isApplicableMatch, Task node, NormalStep prevStep,
			T2NS _t2ps1, NormalStep step, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, Task task,
			SequenceFlow sf2, SF2F _sf2f1, Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_Task2NormalStepSeq_30_3_binding = pattern_Task2NormalStepSeq_30_3_bindingFBBBBBBBBBBBBBB(
				_this, isApplicableMatch, node, prevStep, _t2ps1, step, process, flow, sf1, task, sf2, _sf2f1,
				sourceMatch, targetMatch);
	...
	public static final Object[] pattern_Task2NormalStepSeq_33_2_blackBBBBBBBBBBB(Task node, NormalStep prevStep,
			T2NS _t2ps1, NormalStep step, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, Task task,
													...
													if (task.equals(sf1.getTargetRef())) {
														if (task.equals(sf2.getSourceRef())) {
															if (sf1.equals(_sf2f1.getSource())) {
																if (flow.equals(_sf2f1.getTarget())) {
																	if (node.equals(sf1.getSourceRef())) {
																		return new Object[] { node, prevStep, _t2ps1,
	...
	public static final Object[] pattern_Task2NormalStepSeq_33_2_bindingAndBlackFFFFFFFFFFB(
		...
		if (result_pattern_Task2NormalStepSeq_33_2_binding != null) {
			...
			Object[] result_pattern_Task2NormalStepSeq_33_2_black = pattern_Task2NormalStepSeq_33_2_blackBBBBBBBBBBB(
					node, prevStep, _t2ps1, step, process, flow, sf1, task, sf2, _sf2f1, isApplicableMatch);
			if (result_pattern_Task2NormalStepSeq_33_2_black != null) {

				return new Object[] { node, prevStep, _t2ps1, step, process, flow, sf1, task, sf2, _sf2f1,
						isApplicableMatch };
			}
		}
		return null;
			...
			for (EObject tmp_t2ps1 : _t2ps1List.getEntryObjects()) {
				if (tmp_t2ps1 instanceof T2NS) {
					...
					if (node != null) {
						NormalStep prevStep = _t2ps1.getTarget();
						if (prevStep != null) {
							if (pattern_Task2NormalStepSeq_34_2_black_nac_1BB(ruleResult, _t2ps1) == null) {
								if (pattern_Task2NormalStepSeq_34_2_black_nac_0BB(ruleResult, node) == null) {
									if (pattern_Task2NormalStepSeq_34_2_black_nac_2BB(ruleResult, prevStep) == null) {
																...
																if (flow != null) {
																	if (pattern_Task2NormalStepSeq_34_2_black_nac_5BB(
																		...
																		if (pattern_Task2NormalStepSeq_34_2_black_nac_6BB(
																			...
																			_result.add(new Object[] { _t2ps1List, node,
																					_t2ps1, prevStep, process, sf1,
	...
	public static final Object[] pattern_Task2NormalStepSeq_34_3_bindingFBBBBBBBBBB(Task2NormalStepSeq _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, node, prevStep, _t2ps1, process,
				flow, sf1, _sf2f1, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, node, prevStep, _t2ps1, process, flow, sf1, _sf2f1,
					ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_Task2NormalStepSeq_34_3_bindingAndBlackFBBBBBBBBBB(Task2NormalStepSeq _this,
		...
		Object[] result_pattern_Task2NormalStepSeq_34_3_binding = pattern_Task2NormalStepSeq_34_3_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, node, prevStep, _t2ps1, process, flow, sf1, _sf2f1, ruleResult);
	...
	public static final Object[] pattern_Task2NormalStepSeq_34_5_blackBBBBBBB(Task node, NormalStep prevStep,
			T2NS _t2ps1, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, SF2F _sf2f1) {
		return new Object[] { node, prevStep, _t2ps1, process, flow, sf1, _sf2f1 };
	}

	public static final Object[] pattern_Task2NormalStepSeq_34_6_blackBBBBBBBB(Task node, NormalStep prevStep,
			T2NS _t2ps1, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, SF2F _sf2f1,
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { node, prevStep, _t2ps1, process, flow, sf1, _sf2f1, ruleResult };
	}

	public static final Object[] pattern_Task2NormalStepSeq_34_6_greenBFBBBFFFFBB(NormalStep prevStep,
		...
		return new Object[] { prevStep, step, process, flow, sf1, task, _t2ns, sf2, _sf2f2, ruleResult, csp };
	}
