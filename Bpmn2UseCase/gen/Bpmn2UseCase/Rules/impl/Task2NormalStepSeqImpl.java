...
public class Task2NormalStepSeqImpl extends AbstractRuleImpl implements Task2NormalStepSeq {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, Task node, SimpleBPMN.Process process, SequenceFlow sf1, Task task,
			SequenceFlow sf2) {
		// initial bindings
		Object[] result1_black = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_0_1_blackBBBBBBB(this, match, node,
		...
		Object[] result2_bindingAndBlack = Task2NormalStepSeqImpl
				.pattern_Task2NormalStepSeq_0_2_bindingAndBlackFBBBBBBB(this, match, node, process, sf1, task, sf2);
		...
		if (Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_0_3_expressionFBB(this, csp)) {
			...
			Object[] result4_black = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_0_4_blackBBBBBB(match, node,
					process, sf1, task, sf2);
			...
			Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_0_4_greenBBBBBFFFFFF(match, process, sf1, task, sf2);
			...
			Object[] result5_black = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_0_5_blackBBBBBB(match, node,
					process, sf1, task, sf2);
			...
			Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_0_5_greenBBBBFFFF(match, node, process, sf1);
			...
			Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_0_6_expressionBBBBBBB(this, match, node, process, sf1,
					task, sf2);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = Task2NormalStepSeqImpl
				.pattern_Task2NormalStepSeq_1_1_bindingAndBlackFFFFFFFFFBFB(this, isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching in node [perform transformation] failed." + " Variables: "
					+ "[this] = " + this + ", " + "[isApplicableMatch] = " + isApplicableMatch + ".");
		}
		FN2S _t2ps = (FN2S) result1_bindingAndBlack[0];
		...
		Object[] result1_green = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_1_1_greenBFFBBBFB(prevStep, flow,
				task, sf2, csp);
		...
		Object[] result2_black = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_1_2_blackBBBBB(step, _t2ns, task,
				sf2, _sf2f2);
		...
		Object[] result2_green = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_1_2_greenFBBBBB(step, _t2ns, task,
				sf2, _sf2f2);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		// bookkeeping for edges
		Object[] result3_black = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_1_3_blackBBBBBBBBBBBBB(ruleresult,
				_t2ps, node, prevStep, step, _t2ns, process, flow, sf1, task, sf2, _sf2f2, _sf2f1);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching in node [bookkeeping for edges] failed." + " Variables: "
					+ "[ruleresult] = " + ruleresult + ", " + "[_t2ps] = " + _t2ps + ", " + "[node] = " + node + ", "
					+ "[prevStep] = " + prevStep + ", " + "[step] = " + step + ", " + "[_t2ns] = " + _t2ns + ", "
					+ "[process] = " + process + ", " + "[flow] = " + flow + ", " + "[sf1] = " + sf1 + ", "
					+ "[task] = " + task + ", " + "[sf2] = " + sf2 + ", " + "[_sf2f2] = " + _sf2f2 + ", "
					+ "[_sf2f1] = " + _sf2f1 + ".");
		}
		Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_1_3_greenBBBBBBBBBBFFFFFFFFFFFF(ruleresult, prevStep, step,
				_t2ns, process, flow, sf1, task, sf2, _sf2f2);
		...
		// register objects
		Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_1_5_expressionBBBBBBBBBBBBBB(this, ruleresult, _t2ps, node,
				prevStep, step, _t2ns, process, flow, sf1, task, sf2, _sf2f2, _sf2f1);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		// ForEach core match
		Object[] result2_binding = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_2_2_bindingFFFFFB(match);
		...
		for (Object[] result2_black : Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_2_2_blackFBFBFBBBFB(node,
				process, sf1, task, sf2, match)) {
			FN2S _t2ps = (FN2S) result2_black[0];
			NormalStep prevStep = (NormalStep) result2_black[2];
			Flow flow = (Flow) result2_black[4];
			SF2F _sf2f1 = (SF2F) result2_black[8];
			// ForEach find context
			for (Object[] result3_black : Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_2_3_blackBBBBBBBBB(_t2ps,
					node, prevStep, process, flow, sf1, task, sf2, _sf2f1)) {
				Object[] result3_green = Task2NormalStepSeqImpl
						.pattern_Task2NormalStepSeq_2_3_greenBBBBBBBBBFFFFFFFFFFFFFFF(_t2ps, node, prevStep, process,
								flow, sf1, task, sf2, _sf2f1);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[9];
				// EMoflonEdge _t2ps__prevStep____target = (EMoflonEdge) result3_green[10];
				// EMoflonEdge _t2ps__node____source = (EMoflonEdge) result3_green[11];
				...
				Object[] result4_bindingAndBlack = Task2NormalStepSeqImpl
						.pattern_Task2NormalStepSeq_2_4_bindingAndBlackFBBBBBBBBBBB(this, isApplicableMatch, _t2ps,
								node, prevStep, process, flow, sf1, task, sf2, _sf2f1);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException(
							"Pattern matching in node [solve CSP] failed." + " Variables: " + "[this] = " + this + ", "
									+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[_t2ps] = " + _t2ps + ", "
									+ "[node] = " + node + ", " + "[prevStep] = " + prevStep + ", " + "[process] = "
									+ process + ", " + "[flow] = " + flow + ", " + "[sf1] = " + sf1 + ", " + "[task] = "
									+ task + ", " + "[sf2] = " + sf2 + ", " + "[_sf2f1] = " + _sf2f1 + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, FN2S _t2ps, Task node,
			NormalStep prevStep, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, Task task, SequenceFlow sf2,
		...
		isApplicableMatch.registerObject("_t2ps", _t2ps);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject _t2ps, EObject node, EObject prevStep,
			EObject step, EObject _t2ns, EObject process, EObject flow, EObject sf1, EObject task, EObject sf2,
			EObject _sf2f2, EObject _sf2f1) {
		ruleresult.registerObject("_t2ps", _t2ps);
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, NormalStep prevStep, NormalStep step, Flow flow) {
		// initial bindings
		Object[] result1_black = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_10_1_blackBBBBB(this, match,
				prevStep, step, flow);
		if (result1_black == null) {
		...
		// Solve CSP
		Object[] result2_bindingAndBlack = Task2NormalStepSeqImpl
				.pattern_Task2NormalStepSeq_10_2_bindingAndBlackFBBBBB(this, match, prevStep, step, flow);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching in node [Solve CSP] failed." + " Variables: " + "[this] = "
		...
		if (Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_10_3_expressionFBB(this, csp)) {
			...
			// collect elements to be translated
			Object[] result4_black = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_10_4_blackBBBB(match, prevStep,
					step, flow);
			if (result4_black == null) {
			...
			Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_10_4_greenBBBBFF(match, prevStep, step, flow);
			...
			// collect context elements
			Object[] result5_black = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_10_5_blackBBBB(match, prevStep,
					step, flow);
			if (result5_black == null) {
			...
			Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_10_5_greenBBB(match, prevStep, flow);

			// register objects to match
			Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_10_6_expressionBBBBB(this, match, prevStep, step, flow);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		// perform transformation
		Object[] result1_bindingAndBlack = Task2NormalStepSeqImpl
				.pattern_Task2NormalStepSeq_11_1_bindingAndBlackFFFFFFFFBFB(this, isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching in node [perform transformation] failed." + " Variables: "
					+ "[this] = " + this + ", " + "[isApplicableMatch] = " + isApplicableMatch + ".");
		}
		...
		Object[] result1_green = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_11_1_greenBFBBBFFFB(step, process,
				flow, sf1, csp);
		FN2S _t2ns = (FN2S) result1_green[1];
		Task task = (Task) result1_green[5];
		SequenceFlow sf2 = (SequenceFlow) result1_green[6];
		SF2F _sf2f2 = (SF2F) result1_green[7];

		// collect translated elements
		Object[] result2_black = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_11_2_blackBBBBB(step, _t2ns, task,
				sf2, _sf2f2);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching in node [collect translated elements] failed." + " Variables: "
					+ "[step] = " + step + ", " + "[_t2ns] = " + _t2ns + ", " + "[task] = " + task + ", " + "[sf2] = "
		...
		Object[] result2_green = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_11_2_greenFBBBBB(step, _t2ns, task,
				sf2, _sf2f2);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		// bookkeeping for edges
		Object[] result3_black = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_11_3_blackBBBBBBBBBBBBB(ruleresult,
				_t2ps, node, prevStep, step, _t2ns, process, flow, sf1, task, sf2, _sf2f2, _sf2f1);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching in node [bookkeeping for edges] failed." + " Variables: "
					+ "[ruleresult] = " + ruleresult + ", " + "[_t2ps] = " + _t2ps + ", " + "[node] = " + node + ", "
		...
		Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_11_3_greenBBBBBBBBBBFFFFFFFFFFFF(ruleresult, prevStep, step,
				_t2ns, process, flow, sf1, task, sf2, _sf2f2);
				// EMoflonEdge prevStep__step____next = (EMoflonEdge) result3_green[10];
				// EMoflonEdge _t2ns__task____source = (EMoflonEdge) result3_green[11];
				// EMoflonEdge _t2ns__step____target = (EMoflonEdge) result3_green[12];
		...
		// perform postprocessing story node is empty
		// register objects
		Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_11_5_expressionBBBBBBBBBBBBBB(this, ruleresult, _t2ps, node,
				prevStep, step, _t2ns, process, flow, sf1, task, sf2, _sf2f2, _sf2f1);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_12_2_blackFFBBBFFB(prevStep,
				step, flow, match)) {
			FN2S _t2ps = (FN2S) result2_black[0];
			...
			// ForEach find context
			for (Object[] result3_black : Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_12_3_blackBBBBFBBB(_t2ps,
					node, prevStep, step, flow, sf1, _sf2f1)) {
				SimpleBPMN.Process process = (SimpleBPMN.Process) result3_black[4];
				Object[] result3_green = Task2NormalStepSeqImpl
						.pattern_Task2NormalStepSeq_12_3_greenBBBBBBBBFFFFFFFFFFF(_t2ps, node, prevStep, step, process,
								flow, sf1, _sf2f1);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[8];
				// EMoflonEdge _t2ps__prevStep____target = (EMoflonEdge) result3_green[9];
				// EMoflonEdge _t2ps__node____source = (EMoflonEdge) result3_green[10];
				...
				// solve CSP
				Object[] result4_bindingAndBlack = Task2NormalStepSeqImpl
						.pattern_Task2NormalStepSeq_12_4_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch, _t2ps,
								node, prevStep, step, process, flow, sf1, _sf2f1);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching in node [solve CSP] failed." + " Variables: "
							+ "[this] = " + this + ", " + "[isApplicableMatch] = " + isApplicableMatch + ", "
							+ "[_t2ps] = " + _t2ps + ", " + "[node] = " + node + ", " + "[prevStep] = " + prevStep
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, NormalStep prevStep, NormalStep step, Flow flow) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, NormalStep prevStep, NormalStep step, Flow flow) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, FN2S _t2ps, Task node,
			NormalStep prevStep, NormalStep step, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1,
			SF2F _sf2f1) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject _t2ps, EObject node, EObject prevStep,
			EObject step, EObject _t2ns, EObject process, EObject flow, EObject sf1, EObject task, EObject sf2,
			EObject _sf2f2, EObject _sf2f1) {
		ruleresult.registerObject("_t2ps", _t2ps);
		ruleresult.registerObject("node", node);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_110(EMoflonEdge _edge_next) {
		// prepare return value
		Object[] result1_bindingAndBlack = Task2NormalStepSeqImpl
		...
		for (Object[] result2_black : Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_20_2_blackFFFB(_edge_next)) {
			...
			if (Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_20_3_expressionFBBBBB(this, match, prevStep, step,
					flow)) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_334(EMoflonEdge _edge_flowElements) {
		// prepare return value
		Object[] result1_bindingAndBlack = Task2NormalStepSeqImpl
		...
		for (Object[] result2_black : Task2NormalStepSeqImpl
			...
			// bookkeeping with generic isAppropriate method
			if (Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_21_3_expressionFBBBBBBB(this, match, node, process,
					sf1, task, sf2)) {
				// Ensure that the correct types of elements are matched
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_335(EMoflonEdge _edge_flowElements) {
		// prepare return value
		Object[] result1_bindingAndBlack = Task2NormalStepSeqImpl
		...
		for (Object[] result2_black : Task2NormalStepSeqImpl
			...
			// bookkeeping with generic isAppropriate method
			if (Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_22_3_expressionFBBBBBBB(this, match, node, process,
					sf1, task, sf2)) {
				// Ensure that the correct types of elements are matched
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_111(EMoflonEdge _edge_steps) {
		// prepare return value
		Object[] result1_bindingAndBlack = Task2NormalStepSeqImpl
		...
		// ForEach test core match and DECs
		for (Object[] result2_black : Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_23_2_blackFFFB(_edge_steps)) {
			NormalStep prevStep = (NormalStep) result2_black[0];
			NormalStep step = (NormalStep) result2_black[1];
			Flow flow = (Flow) result2_black[2];
			...
			// bookkeeping with generic isAppropriate method
			if (Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_23_3_expressionFBBBBB(this, match, prevStep, step,
					flow)) {
				// Ensure that the correct types of elements are matched
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_336(EMoflonEdge _edge_targetRef) {
		// prepare return value
		Object[] result1_bindingAndBlack = Task2NormalStepSeqImpl
		...
		for (Object[] result2_black : Task2NormalStepSeqImpl
			...
			// bookkeeping with generic isAppropriate method
			if (Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_24_3_expressionFBBBBBBB(this, match, node, process,
					sf1, task, sf2)) {
				// Ensure that the correct types of elements are matched
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_337(EMoflonEdge _edge_incoming) {
		// prepare return value
		Object[] result1_bindingAndBlack = Task2NormalStepSeqImpl
		...
		for (Object[] result2_black : Task2NormalStepSeqImpl
			...
			// bookkeeping with generic isAppropriate method
			if (Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_25_3_expressionFBBBBBBB(this, match, node, process,
					sf1, task, sf2)) {
				// Ensure that the correct types of elements are matched
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_338(EMoflonEdge _edge_sourceRef) {
		// prepare return value
		Object[] result1_bindingAndBlack = Task2NormalStepSeqImpl
		...
		for (Object[] result2_black : Task2NormalStepSeqImpl
			...
			// bookkeeping with generic isAppropriate method
			if (Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_26_3_expressionFBBBBBBB(this, match, node, process,
					sf1, task, sf2)) {
				// Ensure that the correct types of elements are matched
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_339(EMoflonEdge _edge_outgoing) {
		// prepare return value
		Object[] result1_bindingAndBlack = Task2NormalStepSeqImpl
		...
		for (Object[] result2_black : Task2NormalStepSeqImpl
			...
			// bookkeeping with generic isAppropriate method
			if (Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_27_3_expressionFBBBBBBB(this, match, node, process,
					sf1, task, sf2)) {
				// Ensure that the correct types of elements are matched
	...
	public AttributeConstraintsRuleResult checkAttributes_FWD(TripleMatch tripleMatch) {
		...
		Optional<TripleMatchNodeMapping> matchFor_t2ps = tripleMatch.getNodeMappings().stream()
				.filter(nm -> nm.getNodeName().equals("_t2ps")).findAny();
		Bpmn2UseCase.FN2S _t2ps = (Bpmn2UseCase.FN2S) matchFor_t2ps.get().getNode();
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result2_binding = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_30_2_bindingFFFFFFFFBB(sourceMatch,
				targetMatch);
		if (result2_binding == null) {
		...
		for (Object[] result2_black : Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_30_2_blackFBBBBBBBBFBB(node,
				prevStep, step, process, flow, sf1, task, sf2, sourceMatch, targetMatch)) {
			FN2S _t2ps = (FN2S) result2_black[0];
			SF2F _sf2f1 = (SF2F) result2_black[9];
			Object[] result2_green = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_30_2_greenBBBBBBBBBBBFB(_t2ps,
					node, prevStep, step, process, flow, sf1, task, sf2, _sf2f1, sourceMatch, targetMatch);
			...
			Object[] result3_bindingAndBlack = Task2NormalStepSeqImpl
					.pattern_Task2NormalStepSeq_30_3_bindingAndBlackFBBBBBBBBBBBBBB(this, isApplicableMatch, _t2ps,
							node, prevStep, step, process, flow, sf1, task, sf2, _sf2f1, sourceMatch, targetMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(IsApplicableMatchCC isApplicableMatch, FN2S _t2ps, Task node,
			NormalStep prevStep, NormalStep step, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, Task task,
	...
	public PerformRuleResult perform_CC(IsApplicableMatchCC isApplicableMatch) {
		...
		// FN2S _t2ps = (FN2S) result2_bindingAndBlack[0];
		...
		Object[] result2_green = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_33_2_greenBBBBFFF(step, flow, task,
				sf2);
	 ...
	 * @generated
	 */
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer, FN2S _t2psParameter) {
		// create result
		...
		for (Object[] result2_black : Task2NormalStepSeqImpl
				.pattern_Task2NormalStepSeq_34_2_blackFFFFFFFFBB(ruleEntryContainer, ruleResult)) {
			// RuleEntryList _t2psList = (RuleEntryList) result2_black[0];
			FN2S _t2ps = (FN2S) result2_black[1];
			NormalStep prevStep = (NormalStep) result2_black[2];
			Task node = (Task) result2_black[3];
			...
			// solve CSP
			Object[] result3_bindingAndBlack = Task2NormalStepSeqImpl
					.pattern_Task2NormalStepSeq_34_3_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch, _t2ps, node,
							prevStep, process, flow, sf1, _sf2f1, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching in node [solve CSP] failed." + " Variables: " + "[this] = "
						+ this + ", " + "[isApplicableMatch] = " + isApplicableMatch + ", " + "[_t2ps] = " + _t2ps
						+ ", " + "[node] = " + node + ", " + "[prevStep] = " + prevStep + ", " + "[process] = "
			...
			if (Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_34_4_expressionFBB(this, csp)) {
				// check nacs
				Object[] result5_black = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_34_5_blackBBBBBBB(_t2ps,
						node, prevStep, process, flow, sf1, _sf2f1);
				if (result5_black != null) {

					// perform
					Object[] result6_black = Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_34_6_blackBBBBBBBB(_t2ps,
							node, prevStep, process, flow, sf1, _sf2f1, ruleResult);
					if (result6_black == null) {
					...
					Task2NormalStepSeqImpl.pattern_Task2NormalStepSeq_34_6_greenBFFBBBFFFBB(prevStep, process, flow,
							sf1, ruleResult, csp);
	 ...
	 * @generated
	 */
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, FN2S _t2ps, Task node,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_FN2S_TASK_NORMALSTEP_PROCESS_FLOW_SEQUENCEFLOW_TASK_SEQUENCEFLOW_SF2F:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (FN2S) arguments.get(1),
					...
					(Flow) arguments.get(5), (SequenceFlow) arguments.get(6), (Task) arguments.get(7),
					(SequenceFlow) arguments.get(8), (SF2F) arguments.get(9));
		...
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_FN2S_TASK_NORMALSTEP_NORMALSTEP_PROCESS_FLOW_SEQUENCEFLOW_SF2F:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (FN2S) arguments.get(1),
					(Task) arguments.get(2), (NormalStep) arguments.get(3), (NormalStep) arguments.get(4),
		...
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___IS_APPROPRIATE_BWD_EMOFLON_EDGE_110__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_110((EMoflonEdge) arguments.get(0));
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_334__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_334((EMoflonEdge) arguments.get(0));
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_335__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_335((EMoflonEdge) arguments.get(0));
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___IS_APPROPRIATE_BWD_EMOFLON_EDGE_111__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_111((EMoflonEdge) arguments.get(0));
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_336__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_336((EMoflonEdge) arguments.get(0));
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_337__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_337((EMoflonEdge) arguments.get(0));
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_338__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_338((EMoflonEdge) arguments.get(0));
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_339__EMOFLONEDGE:
		...
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___IS_APPLICABLE_SOLVE_CSP_CC__ISAPPLICABLEMATCHCC_FN2S_TASK_NORMALSTEP_NORMALSTEP_PROCESS_FLOW_SEQUENCEFLOW_TASK_SEQUENCEFLOW_SF2F_MATCH_MATCH:
			return isApplicable_solveCsp_CC((IsApplicableMatchCC) arguments.get(0), (FN2S) arguments.get(1),
					(Task) arguments.get(2), (NormalStep) arguments.get(3), (NormalStep) arguments.get(4),
					(SimpleBPMN.Process) arguments.get(5), (Flow) arguments.get(6), (SequenceFlow) arguments.get(7),
					(Task) arguments.get(8), (SequenceFlow) arguments.get(9), (SF2F) arguments.get(10),
		...
		case RulesPackage.TASK2_NORMAL_STEP_SEQ___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_FN2S_TASK_NORMALSTEP_PROCESS_FLOW_SEQUENCEFLOW_SF2F_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_Task2NormalStepSeq_0_1_blackBBBBBBB(Task2NormalStepSeq _this, Match match,
			Task node, SimpleBPMN.Process process, SequenceFlow sf1, Task task, SequenceFlow sf2) {
		if (!node.equals(task)) {
			if (!sf1.equals(sf2)) {
	...
	public static final Object[] pattern_Task2NormalStepSeq_0_2_bindingFBBBBBBB(Task2NormalStepSeq _this, Match match,
			Task node, SimpleBPMN.Process process, SequenceFlow sf1, Task task, SequenceFlow sf2) {
	...
	public static final Object[] pattern_Task2NormalStepSeq_0_2_bindingAndBlackFBBBBBBB(Task2NormalStepSeq _this,
			Match match, Task node, SimpleBPMN.Process process, SequenceFlow sf1, Task task, SequenceFlow sf2) {
		Object[] result_pattern_Task2NormalStepSeq_0_2_binding = pattern_Task2NormalStepSeq_0_2_bindingFBBBBBBB(_this,
	...
	public static final Object[] pattern_Task2NormalStepSeq_0_4_blackBBBBBB(Match match, Task node,
	...
	public static final Object[] pattern_Task2NormalStepSeq_0_4_greenBBBBBFFFFFF(Match match,
			SimpleBPMN.Process process, SequenceFlow sf1, Task task, SequenceFlow sf2) {
	...
	public static final Object[] pattern_Task2NormalStepSeq_0_5_blackBBBBBB(Match match, Task node,
			SimpleBPMN.Process process, SequenceFlow sf1, Task task, SequenceFlow sf2) {
		if (!node.equals(task)) {
			if (!sf1.equals(sf2)) {
				return new Object[] { match, node, process, sf1, task, sf2 };
	...
	public static final Object[] pattern_Task2NormalStepSeq_0_5_greenBBBBFFFF(Match match, Task node,
	...
	public static final void pattern_Task2NormalStepSeq_0_6_expressionBBBBBBB(Task2NormalStepSeq _this, Match match,
			Task node, SimpleBPMN.Process process, SequenceFlow sf1, Task task, SequenceFlow sf2) {
	...
	public static final Object[] pattern_Task2NormalStepSeq_1_1_bindingFFFFFFFFFB(IsApplicableMatch isApplicableMatch) {
		EObject _localVariable_0 = isApplicableMatch.getObject("_t2ps");
		...
		EObject tmp_t2ps = _localVariable_0;
		...
		if (tmp_t2ps instanceof FN2S) {
			FN2S _t2ps = (FN2S) tmp_t2ps;
								...
								if (tmpTask instanceof Task) {
									...
									if (tmpSf2 instanceof SequenceFlow) {
										...
										if (tmp_sf2f1 instanceof SF2F) {
											...
											return new Object[] { _t2ps, node, prevStep, process, flow, sf1, task, sf2,
	...
	public static final Object[] pattern_Task2NormalStepSeq_1_1_blackBBBBBBBBBBFB(FN2S _t2ps, Task node,
			NormalStep prevStep, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, Task task, SequenceFlow sf2,
			SF2F _sf2f1, Task2NormalStepSeq _this, IsApplicableMatch isApplicableMatch) {
		if (!node.equals(task)) {
			if (!sf1.equals(sf2)) {
				for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
					if (tmpCsp instanceof CSP) {
						CSP csp = (CSP) tmpCsp;
						return new Object[] { _t2ps, node, prevStep, process, flow, sf1, task, sf2, _sf2f1, _this, csp,
								isApplicableMatch };
					}
				}
			}
	...
	public static final Object[] pattern_Task2NormalStepSeq_1_1_bindingAndBlackFFFFFFFFFBFB(Task2NormalStepSeq _this,
			IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_Task2NormalStepSeq_1_1_binding = pattern_Task2NormalStepSeq_1_1_bindingFFFFFFFFFB(
				isApplicableMatch);
		if (result_pattern_Task2NormalStepSeq_1_1_binding != null) {
			FN2S _t2ps = (FN2S) result_pattern_Task2NormalStepSeq_1_1_binding[0];
			Task node = (Task) result_pattern_Task2NormalStepSeq_1_1_binding[1];
			NormalStep prevStep = (NormalStep) result_pattern_Task2NormalStepSeq_1_1_binding[2];
			...
			Object[] result_pattern_Task2NormalStepSeq_1_1_black = pattern_Task2NormalStepSeq_1_1_blackBBBBBBBBBBFB(
					_t2ps, node, prevStep, process, flow, sf1, task, sf2, _sf2f1, _this, isApplicableMatch);
	...
	public static final Object[] pattern_Task2NormalStepSeq_1_1_greenBFFBBBFB(NormalStep prevStep, Flow flow, Task task,
		...
		return new Object[] { prevStep, step, _t2ns, flow, task, sf2, _sf2f2, csp };
	}

	public static final Object[] pattern_Task2NormalStepSeq_1_2_blackBBBBB(NormalStep step, FN2S _t2ns, Task task,
			SequenceFlow sf2, SF2F _sf2f2) {
		return new Object[] { step, _t2ns, task, sf2, _sf2f2 };
	}

	public static final Object[] pattern_Task2NormalStepSeq_1_2_greenFBBBBB(NormalStep step, FN2S _t2ns, Task task,
			SequenceFlow sf2, SF2F _sf2f2) {
	...
	public static final Object[] pattern_Task2NormalStepSeq_1_3_blackBBBBBBBBBBBBB(PerformRuleResult ruleresult,
			EObject _t2ps, EObject node, EObject prevStep, EObject step, EObject _t2ns, EObject process, EObject flow,
			EObject sf1, EObject task, EObject sf2, EObject _sf2f2, EObject _sf2f1) {
		if (!_t2ps.equals(node)) {
			if (!_t2ps.equals(prevStep)) {
				if (!_t2ps.equals(step)) {
					if (!_t2ps.equals(process)) {
						if (!_t2ps.equals(flow)) {
							if (!_t2ps.equals(sf1)) {
								if (!_t2ps.equals(task)) {
									if (!_t2ps.equals(sf2)) {
	...
	public static final Object[] pattern_Task2NormalStepSeq_1_3_greenBBBBBBBBBBFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject prevStep, EObject step, EObject _t2ns, EObject process, EObject flow,
			EObject sf1, EObject task, EObject sf2, EObject _sf2f2) {
		...
		return new Object[] { ruleresult, prevStep, step, _t2ns, process, flow, sf1, task, sf2, _sf2f2,
				prevStep__step____next, _t2ns__task____source, _t2ns__step____target, process__task____flowElements,
				process__sf2____flowElements, flow__step____steps, sf1__task____targetRef, task__sf1____incoming,
				sf2__task____sourceRef, task__sf2____outgoing, _sf2f2__sf2____source, _sf2f2__flow____target };
	}

	public static final void pattern_Task2NormalStepSeq_1_5_expressionBBBBBBBBBBBBBB(Task2NormalStepSeq _this,
			PerformRuleResult ruleresult, EObject _t2ps, EObject node, EObject prevStep, EObject step, EObject _t2ns,
			EObject process, EObject flow, EObject sf1, EObject task, EObject sf2, EObject _sf2f2, EObject _sf2f1) {
		_this.registerObjects_FWD(ruleresult, _t2ps, node, prevStep, step, _t2ns, process, flow, sf1, task, sf2, _sf2f2,
				_sf2f1);
	...
	public static final Object[] pattern_Task2NormalStepSeq_2_2_bindingFFFFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepSeq_2_2_blackFBFBFBBBFB(Task node,
			SimpleBPMN.Process process, SequenceFlow sf1, Task task, SequenceFlow sf2, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!node.equals(task)) {
			if (!sf1.equals(sf2)) {
				for (FN2S _t2ps : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(node, FN2S.class,
						"source")) {
					Step tmpPrevStep = _t2ps.getTarget();
					if (tmpPrevStep instanceof NormalStep) {
						NormalStep prevStep = (NormalStep) tmpPrevStep;
						for (SF2F _sf2f1 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(sf1,
							...
							if (flow != null) {
								_result.add(new Object[] { _t2ps, node, prevStep, process, flow, sf1, task, sf2, _sf2f1,
										match });
							}
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepSeq_2_3_blackBBBBBBBBB(FN2S _t2ps, Task node,
			NormalStep prevStep, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, Task task, SequenceFlow sf2,
			SF2F _sf2f1) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!node.equals(task)) {
			if (!sf1.equals(sf2)) {
				if (prevStep.equals(_t2ps.getTarget())) {
					if (node.equals(_t2ps.getSource())) {
												...
												if (sf1.equals(_sf2f1.getSource())) {
													if (flow.equals(_sf2f1.getTarget())) {
														if (node.equals(sf1.getSourceRef())) {
															_result.add(new Object[] { _t2ps, node, prevStep, process,
																	flow, sf1, task, sf2, _sf2f1 });
														}
													}
												}
	...
	public static final Object[] pattern_Task2NormalStepSeq_2_3_greenBBBBBBBBBFFFFFFFFFFFFFFF(FN2S _t2ps, Task node,
			NormalStep prevStep, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, Task task, SequenceFlow sf2,
			SF2F _sf2f1) {
		IsApplicableMatch isApplicableMatch = TGGRuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge _t2ps__prevStep____target = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge _t2ps__node____source = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge process__task____flowElements = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge process__sf1____flowElements = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge process__node____flowElements = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge process__sf2____flowElements = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		EMoflonEdge sf1__node____sourceRef = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge node__sf1____outgoing = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		String _t2ps__prevStep____target_name_prime = "target";
		String _t2ps__node____source_name_prime = "source";
		String process__task____flowElements_name_prime = "flowElements";
		String process__sf1____flowElements_name_prime = "flowElements";
		String process__node____flowElements_name_prime = "flowElements";
		String process__sf2____flowElements_name_prime = "flowElements";
		...
		String sf1__node____sourceRef_name_prime = "sourceRef";
		String node__sf1____outgoing_name_prime = "outgoing";
		isApplicableMatch.getAllContextElements().add(_t2ps);
		...
		_t2ps__prevStep____target.setSrc(_t2ps);
		_t2ps__prevStep____target.setTrg(prevStep);
		isApplicableMatch.getAllContextElements().add(_t2ps__prevStep____target);
		_t2ps__node____source.setSrc(_t2ps);
		_t2ps__node____source.setTrg(node);
		isApplicableMatch.getAllContextElements().add(_t2ps__node____source);
		process__task____flowElements.setSrc(process);
		process__task____flowElements.setTrg(task);
		...
		_t2ps__prevStep____target.setName(_t2ps__prevStep____target_name_prime);
		_t2ps__node____source.setName(_t2ps__node____source_name_prime);
		process__task____flowElements.setName(process__task____flowElements_name_prime);
		process__sf1____flowElements.setName(process__sf1____flowElements_name_prime);
		process__node____flowElements.setName(process__node____flowElements_name_prime);
		process__sf2____flowElements.setName(process__sf2____flowElements_name_prime);
		...
		sf1__node____sourceRef.setName(sf1__node____sourceRef_name_prime);
		node__sf1____outgoing.setName(node__sf1____outgoing_name_prime);
		return new Object[] { _t2ps, node, prevStep, process, flow, sf1, task, sf2, _sf2f1, isApplicableMatch,
				_t2ps__prevStep____target, _t2ps__node____source, process__task____flowElements,
				process__sf1____flowElements, process__node____flowElements, process__sf2____flowElements,
	...
	public static final Object[] pattern_Task2NormalStepSeq_2_4_bindingFBBBBBBBBBBB(Task2NormalStepSeq _this,
			IsApplicableMatch isApplicableMatch, FN2S _t2ps, Task node, NormalStep prevStep, SimpleBPMN.Process process,
			Flow flow, SequenceFlow sf1, Task task, SequenceFlow sf2, SF2F _sf2f1) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, _t2ps, node, prevStep, process, flow,
				sf1, task, sf2, _sf2f1);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, _t2ps, node, prevStep, process, flow, sf1, task, sf2,
					_sf2f1 };
		}
		return null;
	}
	...
	public static final Object[] pattern_Task2NormalStepSeq_2_4_bindingAndBlackFBBBBBBBBBBB(Task2NormalStepSeq _this,
			IsApplicableMatch isApplicableMatch, FN2S _t2ps, Task node, NormalStep prevStep, SimpleBPMN.Process process,
			Flow flow, SequenceFlow sf1, Task task, SequenceFlow sf2, SF2F _sf2f1) {
		Object[] result_pattern_Task2NormalStepSeq_2_4_binding = pattern_Task2NormalStepSeq_2_4_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, _t2ps, node, prevStep, process, flow, sf1, task, sf2, _sf2f1);
		if (result_pattern_Task2NormalStepSeq_2_4_binding != null) {
			...
			if (result_pattern_Task2NormalStepSeq_2_4_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, _t2ps, node, prevStep, process, flow, sf1, task,
						sf2, _sf2f1 };
			}
		}
		return null;
	...
	public static final Object[] pattern_Task2NormalStepSeq_10_1_blackBBBBB(Task2NormalStepSeq _this, Match match,
			NormalStep prevStep, NormalStep step, Flow flow) {
		if (!prevStep.equals(step)) {
	...
	public static final Object[] pattern_Task2NormalStepSeq_10_4_blackBBBB(Match match, NormalStep prevStep,
	...
	public static final Object[] pattern_Task2NormalStepSeq_10_4_greenBBBBFF(Match match, NormalStep prevStep,
			NormalStep step, Flow flow) {
		EMoflonEdge prevStep__step____next = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge flow__step____steps = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final Object[] pattern_Task2NormalStepSeq_10_5_blackBBBB(Match match, NormalStep prevStep,
			NormalStep step, Flow flow) {
		if (!prevStep.equals(step)) {
			return new Object[] { match, prevStep, step, flow };
		}
	...
	public static final Object[] pattern_Task2NormalStepSeq_10_5_greenBBB(Match match, NormalStep prevStep, Flow flow) {
	...
	public static final Object[] pattern_Task2NormalStepSeq_11_1_bindingFFFFFFFFB(IsApplicableMatch isApplicableMatch) {
		EObject _localVariable_0 = isApplicableMatch.getObject("_t2ps");
		EObject _localVariable_1 = isApplicableMatch.getObject("node");
		EObject _localVariable_2 = isApplicableMatch.getObject("prevStep");
						...
						if (tmpProcess instanceof SimpleBPMN.Process) {
							...
							if (tmpFlow instanceof Flow) {
								...
								if (tmpSf1 instanceof SequenceFlow) {
									...
									if (tmp_sf2f1 instanceof SF2F) {
										SF2F _sf2f1 = (SF2F) tmp_sf2f1;
										return new Object[] { _t2ps, node, prevStep, step, process, flow, sf1, _sf2f1,
												isApplicableMatch };
									}
								}
							}
	...
	public static final Object[] pattern_Task2NormalStepSeq_11_1_blackBBBBBBBBBFB(FN2S _t2ps, Task node,
			NormalStep prevStep, NormalStep step, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, SF2F _sf2f1,
			Task2NormalStepSeq _this, IsApplicableMatch isApplicableMatch) {
		if (!prevStep.equals(step)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { _t2ps, node, prevStep, step, process, flow, sf1, _sf2f1, _this, csp,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_Task2NormalStepSeq_11_1_bindingAndBlackFFFFFFFFBFB(Task2NormalStepSeq _this,
			IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_Task2NormalStepSeq_11_1_binding = pattern_Task2NormalStepSeq_11_1_bindingFFFFFFFFB(
				isApplicableMatch);
		if (result_pattern_Task2NormalStepSeq_11_1_binding != null) {
			FN2S _t2ps = (FN2S) result_pattern_Task2NormalStepSeq_11_1_binding[0];
			Task node = (Task) result_pattern_Task2NormalStepSeq_11_1_binding[1];
			NormalStep prevStep = (NormalStep) result_pattern_Task2NormalStepSeq_11_1_binding[2];
			...
			Object[] result_pattern_Task2NormalStepSeq_11_1_black = pattern_Task2NormalStepSeq_11_1_blackBBBBBBBBBFB(
					_t2ps, node, prevStep, step, process, flow, sf1, _sf2f1, _this, isApplicableMatch);
	...
	public static final Object[] pattern_Task2NormalStepSeq_11_1_greenBFBBBFFFB(NormalStep step,
		...
		return new Object[] { step, _t2ns, process, flow, sf1, task, sf2, _sf2f2, csp };
	}

	public static final Object[] pattern_Task2NormalStepSeq_11_2_blackBBBBB(NormalStep step, FN2S _t2ns, Task task,
			SequenceFlow sf2, SF2F _sf2f2) {
		return new Object[] { step, _t2ns, task, sf2, _sf2f2 };
	}

	public static final Object[] pattern_Task2NormalStepSeq_11_2_greenFBBBBB(NormalStep step, FN2S _t2ns, Task task,
			SequenceFlow sf2, SF2F _sf2f2) {
		PerformRuleResult ruleresult = TGGRuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final Object[] pattern_Task2NormalStepSeq_11_3_blackBBBBBBBBBBBBB(PerformRuleResult ruleresult,
			EObject _t2ps, EObject node, EObject prevStep, EObject step, EObject _t2ns, EObject process, EObject flow,
			EObject sf1, EObject task, EObject sf2, EObject _sf2f2, EObject _sf2f1) {
		if (!_t2ps.equals(node)) {
			if (!_t2ps.equals(prevStep)) {
	...
	public static final void pattern_Task2NormalStepSeq_11_5_expressionBBBBBBBBBBBBBB(Task2NormalStepSeq _this,
			PerformRuleResult ruleresult, EObject _t2ps, EObject node, EObject prevStep, EObject step, EObject _t2ns,
			EObject process, EObject flow, EObject sf1, EObject task, EObject sf2, EObject _sf2f2, EObject _sf2f1) {
		_this.registerObjects_BWD(ruleresult, _t2ps, node, prevStep, step, _t2ns, process, flow, sf1, task, sf2, _sf2f2,
				_sf2f1);
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepSeq_12_2_blackFFBBBFFB(NormalStep prevStep,
			NormalStep step, Flow flow, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!prevStep.equals(step)) {
			for (FN2S _t2ps : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(prevStep, FN2S.class,
					"target")) {
				FlowNode tmpNode = _t2ps.getSource();
				if (tmpNode instanceof Task) {
					Task node = (Task) tmpNode;
					for (SF2F _sf2f1 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(flow,
							SF2F.class, "target")) {
						SequenceFlow sf1 = _sf2f1.getSource();
						if (sf1 != null) {
							_result.add(new Object[] { _t2ps, node, prevStep, step, flow, sf1, _sf2f1, match });
						}
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepSeq_12_3_blackBBBBFBBB(FN2S _t2ps, Task node,
			NormalStep prevStep, NormalStep step, Flow flow, SequenceFlow sf1, SF2F _sf2f1) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!prevStep.equals(step)) {
			if (prevStep.equals(_t2ps.getTarget())) {
				if (node.equals(_t2ps.getSource())) {
									...
									if (node.equals(sf1.getSourceRef())) {
										for (SimpleBPMN.Process process : org.moflon.core.utilities.eMoflonEMFUtil
												.getOppositeReferenceTyped(sf1, SimpleBPMN.Process.class,
														"flowElements")) {
											if (process.getFlowElements().contains(node)) {
												_result.add(new Object[] { _t2ps, node, prevStep, step, process, flow,
														sf1, _sf2f1 });
											}
										}
									}
	...
	public static final Object[] pattern_Task2NormalStepSeq_12_3_greenBBBBBBBBFFFFFFFFFFF(FN2S _t2ps, Task node,
			NormalStep prevStep, NormalStep step, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1,
			SF2F _sf2f1) {
		IsApplicableMatch isApplicableMatch = TGGRuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge _t2ps__prevStep____target = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		sf1__node____sourceRef.setName(sf1__node____sourceRef_name_prime);
		node__sf1____outgoing.setName(node__sf1____outgoing_name_prime);
		return new Object[] { _t2ps, node, prevStep, step, process, flow, sf1, _sf2f1, isApplicableMatch,
				_t2ps__prevStep____target, _t2ps__node____source, prevStep__step____next, process__sf1____flowElements,
				process__node____flowElements, flow__step____steps, _sf2f1__sf1____source, _sf2f1__flow____target,
				sf1__node____sourceRef, node__sf1____outgoing };
	}

	public static final Object[] pattern_Task2NormalStepSeq_12_4_bindingFBBBBBBBBBB(Task2NormalStepSeq _this,
			IsApplicableMatch isApplicableMatch, FN2S _t2ps, Task node, NormalStep prevStep, NormalStep step,
			SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, SF2F _sf2f1) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, _t2ps, node, prevStep, step, process,
				flow, sf1, _sf2f1);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, _t2ps, node, prevStep, step, process, flow, sf1,
					_sf2f1 };
		}
		return null;
	}
	...
	public static final Object[] pattern_Task2NormalStepSeq_12_4_bindingAndBlackFBBBBBBBBBB(Task2NormalStepSeq _this,
			IsApplicableMatch isApplicableMatch, FN2S _t2ps, Task node, NormalStep prevStep, NormalStep step,
			SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, SF2F _sf2f1) {
		Object[] result_pattern_Task2NormalStepSeq_12_4_binding = pattern_Task2NormalStepSeq_12_4_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, _t2ps, node, prevStep, step, process, flow, sf1, _sf2f1);
	...
	public static final Object[] pattern_Task2NormalStepSeq_20_2_black_nac_0BB(Flow flow, NormalStep step) {
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepSeq_20_2_blackFFFB(EMoflonEdge _edge_next) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
				...
				if (!prevStep.equals(step)) {
					if (step.equals(prevStep.getNext())) {
						for (Flow flow : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(step,
								Flow.class, "steps")) {
							if (pattern_Task2NormalStepSeq_20_2_black_nac_0BB(flow, step) == null) {
	...
	public static final Object[] pattern_Task2NormalStepSeq_21_2_black_nac_0BB(SequenceFlow sf2, Task task) {
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepSeq_21_2_blackFFFFFB(EMoflonEdge _edge_flowElements) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
										...
										if (process.getFlowElements().contains(node)) {
											for (FlowElement tmpSf2 : process.getFlowElements()) {
												if (tmpSf2 instanceof SequenceFlow) {
													...
													if (!sf1.equals(sf2)) {
														if (task.equals(sf2.getSourceRef())) {
															if (pattern_Task2NormalStepSeq_21_2_black_nac_0BB(sf2,
																	task) == null) {
	...
	public static final boolean pattern_Task2NormalStepSeq_21_3_expressionFBBBBBBB(Task2NormalStepSeq _this,
			Match match, Task node, SimpleBPMN.Process process, SequenceFlow sf1, Task task, SequenceFlow sf2) {
	...
	public static final Object[] pattern_Task2NormalStepSeq_22_2_black_nac_0BB(SequenceFlow sf2, Task task) {
		if (task.equals(sf2.getTargetRef())) {
			return new Object[] { sf2, task };
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepSeq_22_2_blackFFFFFB(EMoflonEdge _edge_flowElements) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		EObject tmpProcess = _edge_flowElements.getSrc();
		if (tmpProcess instanceof SimpleBPMN.Process) {
			SimpleBPMN.Process process = (SimpleBPMN.Process) tmpProcess;
			...
			if (tmpSf2 instanceof SequenceFlow) {
				...
				if (process.getFlowElements().contains(sf2)) {
					...
					if (tmpTask instanceof Task) {
						Task task = (Task) tmpTask;
						if (process.getFlowElements().contains(task)) {
							if (pattern_Task2NormalStepSeq_22_2_black_nac_0BB(sf2, task) == null) {
								for (FlowElement tmpSf1 : process.getFlowElements()) {
									if (tmpSf1 instanceof SequenceFlow) {
										SequenceFlow sf1 = (SequenceFlow) tmpSf1;
										if (!sf1.equals(sf2)) {
	...
	public static final boolean pattern_Task2NormalStepSeq_22_3_expressionFBBBBBBB(Task2NormalStepSeq _this,
			Match match, Task node, SimpleBPMN.Process process, SequenceFlow sf1, Task task, SequenceFlow sf2) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, node, process, sf1, task, sf2);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_Task2NormalStepSeq_23_2_black_nac_0BB(Flow flow, NormalStep step) {
		if (step.equals(flow.get__first())) {
			return new Object[] { flow, step };
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepSeq_23_2_blackFFFB(EMoflonEdge _edge_steps) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		...
		if (tmpFlow instanceof Flow) {
			...
			if (tmpStep instanceof NormalStep) {
				NormalStep step = (NormalStep) tmpStep;
				if (flow.getSteps().contains(step)) {
					if (pattern_Task2NormalStepSeq_23_2_black_nac_0BB(flow, step) == null) {
	...
	public static final boolean pattern_Task2NormalStepSeq_23_3_expressionFBBBBB(Task2NormalStepSeq _this, Match match,
			NormalStep prevStep, NormalStep step, Flow flow) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, prevStep, step, flow);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_Task2NormalStepSeq_24_2_black_nac_0BB(SequenceFlow sf2, Task task) {
		if (task.equals(sf2.getTargetRef())) {
			return new Object[] { sf2, task };
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepSeq_24_2_blackFFFFFB(EMoflonEdge _edge_targetRef) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
					...
					if (tmpNode instanceof Task) {
						...
						if (!node.equals(task)) {
							for (SequenceFlow sf2 : task.getOutgoing()) {
								if (!sf1.equals(sf2)) {
									if (pattern_Task2NormalStepSeq_24_2_black_nac_0BB(sf2, task) == null) {
										for (SimpleBPMN.Process process : org.moflon.core.utilities.eMoflonEMFUtil
												.getOppositeReferenceTyped(sf1, SimpleBPMN.Process.class,
														"flowElements")) {
											if (process.getFlowElements().contains(task)) {
	...
	public static final boolean pattern_Task2NormalStepSeq_24_3_expressionFBBBBBBB(Task2NormalStepSeq _this,
			Match match, Task node, SimpleBPMN.Process process, SequenceFlow sf1, Task task, SequenceFlow sf2) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, node, process, sf1, task, sf2);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_Task2NormalStepSeq_25_2_black_nac_0BB(SequenceFlow sf2, Task task) {
		if (task.equals(sf2.getTargetRef())) {
			return new Object[] { sf2, task };
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepSeq_25_2_blackFFFFFB(EMoflonEdge _edge_incoming) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
				...
				if (task.equals(sf1.getTargetRef())) {
					...
					if (tmpNode instanceof Task) {
						...
						if (!node.equals(task)) {
							for (SequenceFlow sf2 : task.getOutgoing()) {
								if (!sf1.equals(sf2)) {
									if (pattern_Task2NormalStepSeq_25_2_black_nac_0BB(sf2, task) == null) {
										for (SimpleBPMN.Process process : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final boolean pattern_Task2NormalStepSeq_25_3_expressionFBBBBBBB(Task2NormalStepSeq _this,
			Match match, Task node, SimpleBPMN.Process process, SequenceFlow sf1, Task task, SequenceFlow sf2) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, node, process, sf1, task, sf2);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_Task2NormalStepSeq_26_2_black_nac_0BB(SequenceFlow sf2, Task task) {
		if (task.equals(sf2.getTargetRef())) {
			return new Object[] { sf2, task };
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepSeq_26_2_blackFFFFFB(EMoflonEdge _edge_sourceRef) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final boolean pattern_Task2NormalStepSeq_26_3_expressionFBBBBBBB(Task2NormalStepSeq _this,
			Match match, Task node, SimpleBPMN.Process process, SequenceFlow sf1, Task task, SequenceFlow sf2) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, node, process, sf1, task, sf2);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_Task2NormalStepSeq_27_2_black_nac_0BB(SequenceFlow sf2, Task task) {
		if (task.equals(sf2.getTargetRef())) {
			return new Object[] { sf2, task };
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepSeq_27_2_blackFFFFFB(EMoflonEdge _edge_outgoing) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final boolean pattern_Task2NormalStepSeq_27_3_expressionFBBBBBBB(Task2NormalStepSeq _this,
			Match match, Task node, SimpleBPMN.Process process, SequenceFlow sf1, Task task, SequenceFlow sf2) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, node, process, sf1, task, sf2);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_Task2NormalStepSeq_30_2_bindingFFFFFFFFBB(Match sourceMatch,
			Match targetMatch) {
						...
						if (tmpFlow instanceof Flow) {
							...
							if (tmpSf1 instanceof SequenceFlow) {
								...
								if (tmpTask instanceof Task) {
									...
									if (tmpSf2 instanceof SequenceFlow) {
										SequenceFlow sf2 = (SequenceFlow) tmpSf2;
										return new Object[] { node, prevStep, step, process, flow, sf1, task, sf2,
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepSeq_30_2_blackFBBBBBBBBFBB(Task node,
			NormalStep prevStep, NormalStep step, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, Task task,
										...
										if (process.getFlowElements().contains(sf2)) {
											if (flow.getSteps().contains(step)) {
												if (task.equals(sf1.getTargetRef())) {
													if (task.equals(sf2.getSourceRef())) {
														if (node.equals(sf1.getSourceRef())) {
															for (FN2S _t2ps : org.moflon.core.utilities.eMoflonEMFUtil
																	.getOppositeReferenceTyped(prevStep, FN2S.class,
																			"target")) {
																if (node.equals(_t2ps.getSource())) {
																	for (SF2F _sf2f1 : org.moflon.core.utilities.eMoflonEMFUtil
																			.getOppositeReferenceTyped(sf1, SF2F.class,
																					"source")) {
																		if (flow.equals(_sf2f1.getTarget())) {
																			_result.add(new Object[] { _t2ps, node,
																					prevStep, step, process, flow, sf1,
																					task, sf2, _sf2f1, sourceMatch,
																					targetMatch });
																		}
																	}
																}
	...
	public static final Object[] pattern_Task2NormalStepSeq_30_2_greenBBBBBBBBBBBFB(FN2S _t2ps, Task node,
			NormalStep prevStep, NormalStep step, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, Task task,
		...
		isApplicableMatch.getAllContextElements().add(_sf2f1);
		isApplicableMatch.setRuleName(isApplicableMatch_ruleName_prime);
		return new Object[] { _t2ps, node, prevStep, step, process, flow, sf1, task, sf2, _sf2f1, sourceMatch,
				isApplicableMatch, targetMatch };
	}

	public static final Object[] pattern_Task2NormalStepSeq_30_3_bindingFBBBBBBBBBBBBBB(Task2NormalStepSeq _this,
			IsApplicableMatchCC isApplicableMatch, FN2S _t2ps, Task node, NormalStep prevStep, NormalStep step,
			SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, Task task, SequenceFlow sf2, SF2F _sf2f1,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_CC(isApplicableMatch, _t2ps, node, prevStep, step, process,
				flow, sf1, task, sf2, _sf2f1, sourceMatch, targetMatch);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, _t2ps, node, prevStep, step, process, flow, sf1, task,
	...
	public static final Object[] pattern_Task2NormalStepSeq_30_3_bindingAndBlackFBBBBBBBBBBBBBB(
			Task2NormalStepSeq _this, IsApplicableMatchCC isApplicableMatch, FN2S _t2ps, Task node, NormalStep prevStep,
		...
		Object[] result_pattern_Task2NormalStepSeq_30_3_binding = pattern_Task2NormalStepSeq_30_3_bindingFBBBBBBBBBBBBBB(
				_this, isApplicableMatch, _t2ps, node, prevStep, step, process, flow, sf1, task, sf2, _sf2f1,
				sourceMatch, targetMatch);
								...
								if (tmpSf1 instanceof SequenceFlow) {
									...
									if (tmpTask instanceof Task) {
										...
										if (tmpSf2 instanceof SequenceFlow) {
											...
											if (tmp_sf2f1 instanceof SF2F) {
												SF2F _sf2f1 = (SF2F) tmp_sf2f1;
												return new Object[] { _t2ps, node, prevStep, step, process, flow, sf1,
														task, sf2, _sf2f1, isApplicableMatch };
											}
										}
									}
								}
	...
	public static final Object[] pattern_Task2NormalStepSeq_33_2_blackBBBBBBBBBBB(FN2S _t2ps, Task node,
			NormalStep prevStep, NormalStep step, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, Task task,
													...
													if (task.equals(sf1.getTargetRef())) {
														if (task.equals(sf2.getSourceRef())) {
															if (sf1.equals(_sf2f1.getSource())) {
																if (flow.equals(_sf2f1.getTarget())) {
																	if (node.equals(sf1.getSourceRef())) {
																		return new Object[] { _t2ps, node, prevStep,
																				step, process, flow, sf1, task, sf2,
																				_sf2f1, isApplicableMatch };
																	}
																}
															}
	...
	public static final Object[] pattern_Task2NormalStepSeq_33_2_bindingAndBlackFFFFFFFFFFB(
			IsApplicableMatchCC isApplicableMatch) {
		Object[] result_pattern_Task2NormalStepSeq_33_2_binding = pattern_Task2NormalStepSeq_33_2_bindingFFFFFFFFFFB(
				isApplicableMatch);
		if (result_pattern_Task2NormalStepSeq_33_2_binding != null) {
			FN2S _t2ps = (FN2S) result_pattern_Task2NormalStepSeq_33_2_binding[0];
			Task node = (Task) result_pattern_Task2NormalStepSeq_33_2_binding[1];
			NormalStep prevStep = (NormalStep) result_pattern_Task2NormalStepSeq_33_2_binding[2];
			...
			Object[] result_pattern_Task2NormalStepSeq_33_2_black = pattern_Task2NormalStepSeq_33_2_blackBBBBBBBBBBB(
					_t2ps, node, prevStep, step, process, flow, sf1, task, sf2, _sf2f1, isApplicableMatch);
			if (result_pattern_Task2NormalStepSeq_33_2_black != null) {

				return new Object[] { _t2ps, node, prevStep, step, process, flow, sf1, task, sf2, _sf2f1,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_Task2NormalStepSeq_33_2_greenBBBBFFF(NormalStep step, Flow flow, Task task,
			SequenceFlow sf2) {
	...
	public static final Object[] pattern_Task2NormalStepSeq_34_2_black_nac_0BB(ModelgeneratorRuleResult ruleResult,
			FN2S _t2ps) {
		if (ruleResult.getCorrObjects().contains(_t2ps)) {
			return new Object[] { ruleResult, _t2ps };
		}
		return null;
	}
	...
	public static final Object[] pattern_Task2NormalStepSeq_34_2_black_nac_5BB(ModelgeneratorRuleResult ruleResult,
			SF2F _sf2f1) {
	...
	public static final Object[] pattern_Task2NormalStepSeq_34_2_black_nac_6BB(ModelgeneratorRuleResult ruleResult,
			Flow flow) {
	...
	public static final Iterable<Object[]> pattern_Task2NormalStepSeq_34_2_blackFFFFFFFFBB(
		...
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		for (RuleEntryList _t2psList : ruleEntryContainer.getRuleEntryList()) {
			for (EObject tmp_t2ps : _t2psList.getEntryObjects()) {
				if (tmp_t2ps instanceof FN2S) {
					FN2S _t2ps = (FN2S) tmp_t2ps;
					Step tmpPrevStep = _t2ps.getTarget();
					if (tmpPrevStep instanceof NormalStep) {
						...
						if (tmpNode instanceof Task) {
							Task node = (Task) tmpNode;
							if (pattern_Task2NormalStepSeq_34_2_black_nac_0BB(ruleResult, _t2ps) == null) {
								if (pattern_Task2NormalStepSeq_34_2_black_nac_1BB(ruleResult, prevStep) == null) {
									if (pattern_Task2NormalStepSeq_34_2_black_nac_2BB(ruleResult, node) == null) {
											...
											if (pattern_Task2NormalStepSeq_34_2_black_nac_4BB(ruleResult,
												...
												for (SimpleBPMN.Process process : org.moflon.core.utilities.eMoflonEMFUtil
														.getOppositeReferenceTyped(node, SimpleBPMN.Process.class,
																"flowElements")) {
													if (process.getFlowElements().contains(sf1)) {
														if (pattern_Task2NormalStepSeq_34_2_black_nac_3BB(ruleResult,
																process) == null) {
															for (SF2F _sf2f1 : org.moflon.core.utilities.eMoflonEMFUtil
																	.getOppositeReferenceTyped(sf1, SF2F.class,
																			"source")) {
																...
																if (flow != null) {
																	if (pattern_Task2NormalStepSeq_34_2_black_nac_5BB(
																		...
																		if (pattern_Task2NormalStepSeq_34_2_black_nac_6BB(
																			...
																			_result.add(new Object[] { _t2psList, _t2ps,
																					prevStep, node, process, sf1,
																					_sf2f1, flow, ruleEntryContainer,
																					ruleResult });
																		}
																	}
																}
	...
	public static final Object[] pattern_Task2NormalStepSeq_34_3_bindingFBBBBBBBBBB(Task2NormalStepSeq _this,
			IsApplicableMatch isApplicableMatch, FN2S _t2ps, Task node, NormalStep prevStep, SimpleBPMN.Process process,
			Flow flow, SequenceFlow sf1, SF2F _sf2f1, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, _t2ps, node, prevStep, process, flow,
				sf1, _sf2f1, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, _t2ps, node, prevStep, process, flow, sf1, _sf2f1,
					ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_Task2NormalStepSeq_34_3_bindingAndBlackFBBBBBBBBBB(Task2NormalStepSeq _this,
			IsApplicableMatch isApplicableMatch, FN2S _t2ps, Task node, NormalStep prevStep, SimpleBPMN.Process process,
			Flow flow, SequenceFlow sf1, SF2F _sf2f1, ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_Task2NormalStepSeq_34_3_binding = pattern_Task2NormalStepSeq_34_3_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, _t2ps, node, prevStep, process, flow, sf1, _sf2f1, ruleResult);
	...
	public static final Object[] pattern_Task2NormalStepSeq_34_5_blackBBBBBBB(FN2S _t2ps, Task node,
			NormalStep prevStep, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, SF2F _sf2f1) {
		return new Object[] { _t2ps, node, prevStep, process, flow, sf1, _sf2f1 };
	}

	public static final Object[] pattern_Task2NormalStepSeq_34_6_blackBBBBBBBB(FN2S _t2ps, Task node,
			NormalStep prevStep, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, SF2F _sf2f1,
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { _t2ps, node, prevStep, process, flow, sf1, _sf2f1, ruleResult };
	}

	public static final Object[] pattern_Task2NormalStepSeq_34_6_greenBFFBBBFFFBB(NormalStep prevStep,
		...
		return new Object[] { prevStep, step, _t2ns, process, flow, sf1, task, sf2, _sf2f2, ruleResult, csp };
	}
