...
public class ParallelGateway2ParallelStepSeqImpl extends AbstractRuleImpl implements ParallelGateway2ParallelStepSeq {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = ParallelGateway2ParallelStepSeqImpl
				.pattern_ParallelGateway2ParallelStepSeq_1_1_greenBFBBFBFB(prevStep, flow, pgw, sf2, csp);
		...
		Object[] result2_black = ParallelGateway2ParallelStepSeqImpl
				.pattern_ParallelGateway2ParallelStepSeq_1_2_blackBBBBBB(step, pgw, _pg2ps, pcgw, sf2, _sf22f2);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching in node [collect translated elements] failed." + " Variables: "
					+ "[step] = " + step + ", " + "[pgw] = " + pgw + ", " + "[_pg2ps] = " + _pg2ps + ", " + "[pcgw] = "
					+ pcgw + ", " + "[sf2] = " + sf2 + ", " + "[_sf22f2] = " + _sf22f2 + ".");
		}
		Object[] result2_green = ParallelGateway2ParallelStepSeqImpl
				.pattern_ParallelGateway2ParallelStepSeq_1_2_greenFBBBBBB(step, pgw, _pg2ps, pcgw, sf2, _sf22f2);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		// bookkeeping for edges
		Object[] result3_black = ParallelGateway2ParallelStepSeqImpl
				.pattern_ParallelGateway2ParallelStepSeq_1_3_blackBBBBBBBBBBBBBB(ruleresult, node, prevStep, _t2ns1,
						step, process, flow, sf1, pgw, _pg2ps, _sf2f1, pcgw, sf2, _sf22f2);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching in node [bookkeeping for edges] failed." + " Variables: "
					+ "[ruleresult] = " + ruleresult + ", " + "[node] = " + node + ", " + "[prevStep] = " + prevStep
					+ ", " + "[_t2ns1] = " + _t2ns1 + ", " + "[step] = " + step + ", " + "[process] = " + process + ", "
					+ "[flow] = " + flow + ", " + "[sf1] = " + sf1 + ", " + "[pgw] = " + pgw + ", " + "[_pg2ps] = "
					+ _pg2ps + ", " + "[_sf2f1] = " + _sf2f1 + ", " + "[pcgw] = " + pcgw + ", " + "[sf2] = " + sf2
					+ ", " + "[_sf22f2] = " + _sf22f2 + ".");
		}
		ParallelGateway2ParallelStepSeqImpl.pattern_ParallelGateway2ParallelStepSeq_1_3_greenBBBBBBBBBBBFFFFFFFFFFFFFF(
				ruleresult, prevStep, step, process, flow, sf1, pgw, _pg2ps, pcgw, sf2, _sf22f2);
				...
				// EMoflonEdge _pg2ps__pgw____source = (EMoflonEdge) result3_green[19];
				// EMoflonEdge _pg2ps__step____target = (EMoflonEdge) result3_green[20];
		...
		ParallelGateway2ParallelStepSeqImpl.pattern_ParallelGateway2ParallelStepSeq_1_5_expressionBBBBBBBBBBBBBBB(this,
				ruleresult, node, prevStep, _t2ns1, step, process, flow, sf1, pgw, _pg2ps, _sf2f1, pcgw, sf2, _sf22f2);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ParallelGateway2ParallelStepSeqImpl
				.pattern_ParallelGateway2ParallelStepSeq_2_2_blackBFFBFBBFBBB(node, process, sf1, pgw, pcgw, sf2,
						match)) {
			...
			for (Object[] result3_black : ParallelGateway2ParallelStepSeqImpl
					.pattern_ParallelGateway2ParallelStepSeq_2_3_blackBBBBBBBBBB(node, prevStep, _t2ns1, process, flow,
							sf1, pgw, _sf2f1, pcgw, sf2)) {
				Object[] result3_green = ParallelGateway2ParallelStepSeqImpl
						.pattern_ParallelGateway2ParallelStepSeq_2_3_greenBBBBBBBBBBFFFFFFFFFFFFFFFFF(node, prevStep,
								_t2ns1, process, flow, sf1, pgw, _sf2f1, pcgw, sf2);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[10];
				// EMoflonEdge _t2ns1__node____source = (EMoflonEdge) result3_green[11];
				// EMoflonEdge _t2ns1__prevStep____target = (EMoflonEdge) result3_green[12];
				...
				Object[] result4_bindingAndBlack = ParallelGateway2ParallelStepSeqImpl
						.pattern_ParallelGateway2ParallelStepSeq_2_4_bindingAndBlackFBBBBBBBBBBBB(this,
								isApplicableMatch, node, prevStep, _t2ns1, process, flow, sf1, pgw, _sf2f1, pcgw, sf2);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching in node [solve CSP] failed." + " Variables: "
							+ "[this] = " + this + ", " + "[isApplicableMatch] = " + isApplicableMatch + ", "
							+ "[node] = " + node + ", " + "[prevStep] = " + prevStep + ", " + "[_t2ns1] = " + _t2ns1
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Task node, NormalStep prevStep,
			T2NS _t2ns1, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, ParallelGateway pgw, SF2F _sf2f1,
			ParallelGateway pcgw, SequenceFlow sf2) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject node, EObject prevStep, EObject _t2ns1,
			EObject step, EObject process, EObject flow, EObject sf1, EObject pgw, EObject _pg2ps, EObject _sf2f1,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = ParallelGateway2ParallelStepSeqImpl
				.pattern_ParallelGateway2ParallelStepSeq_11_1_greenBBBBFFFFFB(step, process, flow, sf1, csp);
		ParallelGateway pgw = (ParallelGateway) result1_green[4];
		PG2PS _pg2ps = (PG2PS) result1_green[5];
		...
		// collect translated elements
		Object[] result2_black = ParallelGateway2ParallelStepSeqImpl
				.pattern_ParallelGateway2ParallelStepSeq_11_2_blackBBBBBB(step, pgw, _pg2ps, pcgw, sf2, _sf22f2);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching in node [collect translated elements] failed." + " Variables: "
					+ "[step] = " + step + ", " + "[pgw] = " + pgw + ", " + "[_pg2ps] = " + _pg2ps + ", " + "[pcgw] = "
					+ pcgw + ", " + "[sf2] = " + sf2 + ", " + "[_sf22f2] = " + _sf22f2 + ".");
		...
		Object[] result2_green = ParallelGateway2ParallelStepSeqImpl
				.pattern_ParallelGateway2ParallelStepSeq_11_2_greenFBBBBBB(step, pgw, _pg2ps, pcgw, sf2, _sf22f2);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		// bookkeeping for edges
		Object[] result3_black = ParallelGateway2ParallelStepSeqImpl
				.pattern_ParallelGateway2ParallelStepSeq_11_3_blackBBBBBBBBBBBBBB(ruleresult, node, prevStep, _t2ns1,
						step, process, flow, sf1, pgw, _pg2ps, _sf2f1, pcgw, sf2, _sf22f2);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching in node [bookkeeping for edges] failed." + " Variables: "
					+ "[ruleresult] = " + ruleresult + ", " + "[node] = " + node + ", " + "[prevStep] = " + prevStep
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : ParallelGateway2ParallelStepSeqImpl
				.pattern_ParallelGateway2ParallelStepSeq_12_2_blackFBFBBFFB(prevStep, step, flow, match)) {
			...
			// ForEach find context
			for (Object[] result3_black : ParallelGateway2ParallelStepSeqImpl
					.pattern_ParallelGateway2ParallelStepSeq_12_3_blackBBBBFBBB(node, prevStep, _t2ns1, step, flow, sf1,
							_sf2f1)) {
				SimpleBPMN.Process process = (SimpleBPMN.Process) result3_black[4];
				Object[] result3_green = ParallelGateway2ParallelStepSeqImpl
						.pattern_ParallelGateway2ParallelStepSeq_12_3_greenBBBBBBBBFFFFFFFFFFF(node, prevStep, _t2ns1,
				...
				Object[] result4_bindingAndBlack = ParallelGateway2ParallelStepSeqImpl
						.pattern_ParallelGateway2ParallelStepSeq_12_4_bindingAndBlackFBBBBBBBBBB(this,
								isApplicableMatch, node, prevStep, _t2ns1, step, process, flow, sf1, _sf2f1);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching in node [solve CSP] failed." + " Variables: "
							+ "[this] = " + this + ", " + "[isApplicableMatch] = " + isApplicableMatch + ", "
							+ "[node] = " + node + ", " + "[prevStep] = " + prevStep + ", " + "[_t2ns1] = " + _t2ns1
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Task node, NormalStep prevStep,
			T2NS _t2ns1, ParallelStep step, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, SF2F _sf2f1) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject node, EObject prevStep, EObject _t2ns1,
			EObject step, EObject process, EObject flow, EObject sf1, EObject pgw, EObject _pg2ps, EObject _sf2f1,
			EObject pcgw, EObject sf2, EObject _sf22f2) {
		ruleresult.registerObject("node", node);
		ruleresult.registerObject("prevStep", prevStep);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_125(EMoflonEdge _edge_flowElements) {
		// prepare return value
		Object[] result1_bindingAndBlack = ParallelGateway2ParallelStepSeqImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_126(EMoflonEdge _edge_flowElements) {
		// prepare return value
		Object[] result1_bindingAndBlack = ParallelGateway2ParallelStepSeqImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_38(EMoflonEdge _edge_steps) {
		// prepare return value
		Object[] result1_bindingAndBlack = ParallelGateway2ParallelStepSeqImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_130(EMoflonEdge _edge_sourceRef) {
		// prepare return value
		Object[] result1_bindingAndBlack = ParallelGateway2ParallelStepSeqImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_131(EMoflonEdge _edge_outgoing) {
		// prepare return value
		Object[] result1_bindingAndBlack = ParallelGateway2ParallelStepSeqImpl
	...
	public AttributeConstraintsRuleResult checkAttributes_FWD(TripleMatch tripleMatch) {
		...
		Optional<TripleMatchNodeMapping> matchFor_t2ns1 = tripleMatch.getNodeMappings().stream()
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		for (Object[] result2_black : ParallelGateway2ParallelStepSeqImpl
				.pattern_ParallelGateway2ParallelStepSeq_32_2_blackBBFBBBBBFBBBB(node, prevStep, step, process, flow,
						sf1, pgw, pcgw, sf2, sourceMatch, targetMatch)) {
			T2NS _t2ns1 = (T2NS) result2_black[2];
			SF2F _sf2f1 = (SF2F) result2_black[8];
			Object[] result2_green = ParallelGateway2ParallelStepSeqImpl
					.pattern_ParallelGateway2ParallelStepSeq_32_2_greenBBBBBBBBBBBBFB(node, prevStep, _t2ns1, step,
			...
			Object[] result3_bindingAndBlack = ParallelGateway2ParallelStepSeqImpl
					.pattern_ParallelGateway2ParallelStepSeq_32_3_bindingAndBlackFBBBBBBBBBBBBBBB(this,
							isApplicableMatch, node, prevStep, _t2ns1, step, process, flow, sf1, pgw, _sf2f1, pcgw, sf2,
	...
	public CSP isApplicable_solveCsp_CC(IsApplicableMatchCC isApplicableMatch, Task node, NormalStep prevStep,
			T2NS _t2ns1, ParallelStep step, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1,
	...
	public PerformRuleResult perform_CC(IsApplicableMatchCC isApplicableMatch) {
		...
		// PG2PS _pg2ps = (PG2PS) result2_green[5];
	 ...
	 * @generated
	 */
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer, T2NS _t2ns1Parameter) {
		// create result
		Object[] result1_black = ParallelGateway2ParallelStepSeqImpl
		...
		for (Object[] result2_black : ParallelGateway2ParallelStepSeqImpl
			...
			Object[] result3_bindingAndBlack = ParallelGateway2ParallelStepSeqImpl
					.pattern_ParallelGateway2ParallelStepSeq_36_3_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch,
							node, prevStep, _t2ns1, process, flow, sf1, _sf2f1, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching in node [solve CSP] failed." + " Variables: " + "[this] = "
						+ this + ", " + "[isApplicableMatch] = " + isApplicableMatch + ", " + "[node] = " + node + ", "
						+ "[prevStep] = " + prevStep + ", " + "[_t2ns1] = " + _t2ns1 + ", " + "[process] = " + process
			...
			if (ParallelGateway2ParallelStepSeqImpl.pattern_ParallelGateway2ParallelStepSeq_36_4_expressionFBB(this,
				...
				// check nacs
				Object[] result5_black = ParallelGateway2ParallelStepSeqImpl
						.pattern_ParallelGateway2ParallelStepSeq_36_5_blackBBBBBBB(node, prevStep, _t2ns1, process,
								flow, sf1, _sf2f1);
				if (result5_black != null) {

					// perform
					Object[] result6_black = ParallelGateway2ParallelStepSeqImpl
							.pattern_ParallelGateway2ParallelStepSeq_36_6_blackBBBBBBBB(node, prevStep, _t2ns1, process,
					...
					ParallelGateway2ParallelStepSeqImpl.pattern_ParallelGateway2ParallelStepSeq_36_6_greenBFBBBFFFFFBB(
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Task node, NormalStep prevStep,
			T2NS _t2ns1, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, SF2F _sf2f1,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.PARALLEL_GATEWAY2_PARALLEL_STEP_SEQ___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TASK_NORMALSTEP_T2NS_PROCESS_FLOW_SEQUENCEFLOW_PARALLELGATEWAY_SF2F_PARALLELGATEWAY_SEQUENCEFLOW:
		...
		case RulesPackage.PARALLEL_GATEWAY2_PARALLEL_STEP_SEQ___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TASK_NORMALSTEP_T2NS_PARALLELSTEP_PROCESS_FLOW_SEQUENCEFLOW_SF2F:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Task) arguments.get(1),
					(NormalStep) arguments.get(2), (T2NS) arguments.get(3), (ParallelStep) arguments.get(4),
		...
		case RulesPackage.PARALLEL_GATEWAY2_PARALLEL_STEP_SEQ___IS_APPROPRIATE_BWD_EMOFLON_EDGE_37__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_37((EMoflonEdge) arguments.get(0));
		case RulesPackage.PARALLEL_GATEWAY2_PARALLEL_STEP_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_124__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_124((EMoflonEdge) arguments.get(0));
		case RulesPackage.PARALLEL_GATEWAY2_PARALLEL_STEP_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_125__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_125((EMoflonEdge) arguments.get(0));
		case RulesPackage.PARALLEL_GATEWAY2_PARALLEL_STEP_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_126__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_126((EMoflonEdge) arguments.get(0));
		case RulesPackage.PARALLEL_GATEWAY2_PARALLEL_STEP_SEQ___IS_APPROPRIATE_BWD_EMOFLON_EDGE_38__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_38((EMoflonEdge) arguments.get(0));
		case RulesPackage.PARALLEL_GATEWAY2_PARALLEL_STEP_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_127__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_127((EMoflonEdge) arguments.get(0));
		case RulesPackage.PARALLEL_GATEWAY2_PARALLEL_STEP_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_128__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_128((EMoflonEdge) arguments.get(0));
		case RulesPackage.PARALLEL_GATEWAY2_PARALLEL_STEP_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_129__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_129((EMoflonEdge) arguments.get(0));
		case RulesPackage.PARALLEL_GATEWAY2_PARALLEL_STEP_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_130__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_130((EMoflonEdge) arguments.get(0));
		case RulesPackage.PARALLEL_GATEWAY2_PARALLEL_STEP_SEQ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_131__EMOFLONEDGE:
		...
		case RulesPackage.PARALLEL_GATEWAY2_PARALLEL_STEP_SEQ___IS_APPLICABLE_SOLVE_CSP_CC__ISAPPLICABLEMATCHCC_TASK_NORMALSTEP_T2NS_PARALLELSTEP_PROCESS_FLOW_SEQUENCEFLOW_PARALLELGATEWAY_SF2F_PARALLELGATEWAY_SEQUENCEFLOW_MATCH_MATCH:
		...
		case RulesPackage.PARALLEL_GATEWAY2_PARALLEL_STEP_SEQ___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TASK_NORMALSTEP_T2NS_PROCESS_FLOW_SEQUENCEFLOW_SF2F_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_1_1_blackBBBBBBBBBBBFB(Task node,
			NormalStep prevStep, T2NS _t2ns1, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1,
			...
			if (!pcgw.equals(pgw)) {
				for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
					if (tmpCsp instanceof CSP) {
						CSP csp = (CSP) tmpCsp;
						return new Object[] { node, prevStep, _t2ns1, process, flow, sf1, pgw, _sf2f1, pcgw, sf2, _this,
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_1_1_bindingAndBlackFFFFFFFFFFBFB(
		...
		if (result_pattern_ParallelGateway2ParallelStepSeq_1_1_binding != null) {
			...
			Object[] result_pattern_ParallelGateway2ParallelStepSeq_1_1_black = pattern_ParallelGateway2ParallelStepSeq_1_1_blackBBBBBBBBBBBFB(
					node, prevStep, _t2ns1, process, flow, sf1, pgw, _sf2f1, pcgw, sf2, _this, isApplicableMatch);
			if (result_pattern_ParallelGateway2ParallelStepSeq_1_1_black != null) {
				...
				return new Object[] { node, prevStep, _t2ns1, process, flow, sf1, pgw, _sf2f1, pcgw, sf2, _this, csp,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_1_1_greenBFBBFBFB(NormalStep prevStep,
		...
		return new Object[] { prevStep, step, flow, pgw, _pg2ps, sf2, _sf22f2, csp };
	}

	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_1_2_blackBBBBBB(ParallelStep step,
			ParallelGateway pgw, PG2PS _pg2ps, ParallelGateway pcgw, SequenceFlow sf2, SF2F _sf22f2) {
		if (!pcgw.equals(pgw)) {
			return new Object[] { step, pgw, _pg2ps, pcgw, sf2, _sf22f2 };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_1_2_greenFBBBBBB(ParallelStep step,
		...
		return new Object[] { ruleresult, step, pgw, _pg2ps, pcgw, sf2, _sf22f2 };
	}

	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_1_3_blackBBBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject node, EObject prevStep, EObject _t2ns1, EObject step, EObject process,
			EObject flow, EObject sf1, EObject pgw, EObject _pg2ps, EObject _sf2f1, EObject pcgw, EObject sf2,
			EObject _sf22f2) {
														...
														if (!_t2ns1.equals(prevStep)) {
															if (!_t2ns1.equals(step)) {
																if (!_t2ns1.equals(process)) {
																	if (!_t2ns1.equals(flow)) {
																		if (!_t2ns1.equals(sf1)) {
																			if (!_t2ns1.equals(pgw)) {
																				if (!_t2ns1.equals(pcgw)) {
																					if (!_t2ns1.equals(sf2)) {
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_1_3_greenBBBBBBBBBBBFFFFFFFFFFFFFF(
			...
			EObject pgw, EObject _pg2ps, EObject pcgw, EObject sf2, EObject _sf22f2) {
		...
		return new Object[] { ruleresult, prevStep, step, process, flow, sf1, pgw, _pg2ps, pcgw, sf2, _sf22f2,
				prevStep__step____next, process__pgw____flowElements, process__pcgw____flowElements,
				process__sf2____flowElements, flow__step____steps, sf1__pgw____targetRef, pgw__sf1____incoming,
				pgw__pcgw______conv, _pg2ps__pgw____source, _pg2ps__step____target, sf2__pcgw____sourceRef,
	...
	public static final void pattern_ParallelGateway2ParallelStepSeq_1_5_expressionBBBBBBBBBBBBBBB(
			ParallelGateway2ParallelStepSeq _this, PerformRuleResult ruleresult, EObject node, EObject prevStep,
			EObject _t2ns1, EObject step, EObject process, EObject flow, EObject sf1, EObject pgw, EObject _pg2ps,
			EObject _sf2f1, EObject pcgw, EObject sf2, EObject _sf22f2) {
		_this.registerObjects_FWD(ruleresult, node, prevStep, _t2ns1, step, process, flow, sf1, pgw, _pg2ps, _sf2f1,
				pcgw, sf2, _sf22f2);
	...
	public static final Iterable<Object[]> pattern_ParallelGateway2ParallelStepSeq_2_2_blackBFFBFBBFBBB(Task node,
			SimpleBPMN.Process process, SequenceFlow sf1, ParallelGateway pgw, ParallelGateway pcgw, SequenceFlow sf2,
			Match match) {
			...
			if (!pcgw.equals(pgw)) {
				...
				if (Boolean.valueOf(pgwisDiverging).equals(Boolean.valueOf(true))) {
					...
					if (Boolean.valueOf(pcgwisDiverging).equals(false)) {
						for (T2NS _t2ns1 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(node,
								T2NS.class, "source")) {
							...
							if (prevStep != null) {
								for (SF2F _sf2f1 : org.moflon.core.utilities.eMoflonEMFUtil
									...
									if (flow != null) {
										_result.add(new Object[] { node, prevStep, _t2ns1, process, flow, sf1, pgw,
	...
	public static final Iterable<Object[]> pattern_ParallelGateway2ParallelStepSeq_2_3_blackBBBBBBBBBB(Task node,
			NormalStep prevStep, T2NS _t2ns1, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1,
			ParallelGateway pgw, SF2F _sf2f1, ParallelGateway pcgw, SequenceFlow sf2) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sf1.equals(sf2)) {
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_2_3_greenBBBBBBBBBBFFFFFFFFFFFFFFFFF(Task node,
			NormalStep prevStep, T2NS _t2ns1, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1,
			ParallelGateway pgw, SF2F _sf2f1, ParallelGateway pcgw, SequenceFlow sf2) {
		IsApplicableMatch isApplicableMatch = TGGRuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge _t2ns1__node____source = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge _t2ns1__prevStep____target = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge process__pgw____flowElements = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge process__sf1____flowElements = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge process__node____flowElements = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge process__pcgw____flowElements = TGGRuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		isApplicableMatch.getAllContextElements().add(_t2ns1__prevStep____target);
		process__pgw____flowElements.setSrc(process);
		process__pgw____flowElements.setTrg(pgw);
		...
		_t2ns1__prevStep____target.setName(_t2ns1__prevStep____target_name_prime);
		process__pgw____flowElements.setName(process__pgw____flowElements_name_prime);
		process__sf1____flowElements.setName(process__sf1____flowElements_name_prime);
		process__node____flowElements.setName(process__node____flowElements_name_prime);
		process__pcgw____flowElements.setName(process__pcgw____flowElements_name_prime);
		...
		sf2__pcgw____sourceRef.setName(sf2__pcgw____sourceRef_name_prime);
		pcgw__sf2____outgoing.setName(pcgw__sf2____outgoing_name_prime);
		return new Object[] { node, prevStep, _t2ns1, process, flow, sf1, pgw, _sf2f1, pcgw, sf2, isApplicableMatch,
				_t2ns1__node____source, _t2ns1__prevStep____target, process__pgw____flowElements,
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_2_4_bindingFBBBBBBBBBBBB(
			ParallelGateway2ParallelStepSeq _this, IsApplicableMatch isApplicableMatch, Task node, NormalStep prevStep,
			T2NS _t2ns1, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, ParallelGateway pgw, SF2F _sf2f1,
			ParallelGateway pcgw, SequenceFlow sf2) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, node, prevStep, _t2ns1, process, flow,
				sf1, pgw, _sf2f1, pcgw, sf2);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, node, prevStep, _t2ns1, process, flow, sf1, pgw,
					_sf2f1, pcgw, sf2 };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_2_4_bindingAndBlackFBBBBBBBBBBBB(
		...
		Object[] result_pattern_ParallelGateway2ParallelStepSeq_2_4_binding = pattern_ParallelGateway2ParallelStepSeq_2_4_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, node, prevStep, _t2ns1, process, flow, sf1, pgw, _sf2f1, pcgw, sf2);
						...
						if (tmpProcess instanceof SimpleBPMN.Process) {
							...
							if (tmpFlow instanceof Flow) {
								...
								if (tmpSf1 instanceof SequenceFlow) {
									...
									if (tmp_sf2f1 instanceof SF2F) {
										SF2F _sf2f1 = (SF2F) tmp_sf2f1;
										return new Object[] { node, prevStep, _t2ns1, step, process, flow, sf1, _sf2f1,
												isApplicableMatch };
									}
								}
							}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_11_1_blackBBBBBBBBBFB(Task node,
			NormalStep prevStep, T2NS _t2ns1, ParallelStep step, SimpleBPMN.Process process, Flow flow,
			SequenceFlow sf1, SF2F _sf2f1, ParallelGateway2ParallelStepSeq _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { node, prevStep, _t2ns1, step, process, flow, sf1, _sf2f1, _this, csp,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_11_1_bindingAndBlackFFFFFFFFBFB(
		...
		if (result_pattern_ParallelGateway2ParallelStepSeq_11_1_binding != null) {
			...
			Object[] result_pattern_ParallelGateway2ParallelStepSeq_11_1_black = pattern_ParallelGateway2ParallelStepSeq_11_1_blackBBBBBBBBBFB(
					node, prevStep, _t2ns1, step, process, flow, sf1, _sf2f1, _this, isApplicableMatch);
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_11_1_greenBBBBFFFFFB(ParallelStep step,
		...
		return new Object[] { step, process, flow, sf1, pgw, _pg2ps, pcgw, sf2, _sf22f2, csp };
	}
	...
	public static final void pattern_ParallelGateway2ParallelStepSeq_11_5_expressionBBBBBBBBBBBBBBB(
			...
			EObject _t2ns1, EObject step, EObject process, EObject flow, EObject sf1, EObject pgw, EObject _pg2ps,
			EObject _sf2f1, EObject pcgw, EObject sf2, EObject _sf22f2) {
		_this.registerObjects_BWD(ruleresult, node, prevStep, _t2ns1, step, process, flow, sf1, pgw, _pg2ps, _sf2f1,
				pcgw, sf2, _sf22f2);
	...
	public static final Iterable<Object[]> pattern_ParallelGateway2ParallelStepSeq_12_2_blackFBFBBFFB(
		...
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		for (T2NS _t2ns1 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(prevStep, T2NS.class,
				"target")) {
			...
			if (node != null) {
				for (SF2F _sf2f1 : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(flow, SF2F.class,
					...
					if (sf1 != null) {
						_result.add(new Object[] { node, prevStep, _t2ns1, step, flow, sf1, _sf2f1, match });
					}
	...
	public static final Iterable<Object[]> pattern_ParallelGateway2ParallelStepSeq_12_3_blackBBBBFBBB(Task node,
			NormalStep prevStep, T2NS _t2ns1, ParallelStep step, Flow flow, SequenceFlow sf1, SF2F _sf2f1) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
							...
							if (flow.equals(_sf2f1.getTarget())) {
								if (node.equals(sf1.getSourceRef())) {
									for (SimpleBPMN.Process process : org.moflon.core.utilities.eMoflonEMFUtil
										...
										if (process.getFlowElements().contains(node)) {
											_result.add(new Object[] { node, prevStep, _t2ns1, step, process, flow, sf1,
													_sf2f1 });
										}
									}
								}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_12_3_greenBBBBBBBBFFFFFFFFFFF(Task node,
			NormalStep prevStep, T2NS _t2ns1, ParallelStep step, SimpleBPMN.Process process, Flow flow,
		...
		sf1__node____sourceRef.setName(sf1__node____sourceRef_name_prime);
		node__sf1____outgoing.setName(node__sf1____outgoing_name_prime);
		return new Object[] { node, prevStep, _t2ns1, step, process, flow, sf1, _sf2f1, isApplicableMatch,
				prevStep__step____next, _t2ns1__node____source, _t2ns1__prevStep____target,
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_12_4_bindingFBBBBBBBBBB(
			ParallelGateway2ParallelStepSeq _this, IsApplicableMatch isApplicableMatch, Task node, NormalStep prevStep,
			T2NS _t2ns1, ParallelStep step, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, SF2F _sf2f1) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, node, prevStep, _t2ns1, step, process,
				flow, sf1, _sf2f1);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, node, prevStep, _t2ns1, step, process, flow, sf1,
					_sf2f1 };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_12_4_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_ParallelGateway2ParallelStepSeq_12_4_binding = pattern_ParallelGateway2ParallelStepSeq_12_4_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, node, prevStep, _t2ns1, step, process, flow, sf1, _sf2f1);
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_21_2_black_nac_0BB(ParallelGateway pgw,
		...
		if (!pcgw.equals(pgw)) {
			for (ParallelGateway __DEC_pgw___conv_377789 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(pgw, ParallelGateway.class, "__conv")) {
				if (!pgw.equals(__DEC_pgw___conv_377789)) {
					if (!pcgw.equals(__DEC_pgw___conv_377789)) {
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_21_2_black_nac_1BB(ParallelGateway pcgw,
			ParallelGateway pgw) {
		if (!pcgw.equals(pgw)) {
			ParallelGateway __DEC_pcgw___conv_690870 = pcgw.get__conv();
			if (__DEC_pcgw___conv_690870 != null) {
				if (!pcgw.equals(__DEC_pcgw___conv_690870)) {
					if (!pgw.equals(__DEC_pcgw___conv_690870)) {
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_21_2_black_nac_2BB(ParallelGateway pcgw,
			ParallelGateway pgw) {
		if (!pcgw.equals(pgw)) {
			for (ParallelGateway __DEC_pcgw___conv_125424 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(pcgw, ParallelGateway.class, "__conv")) {
				if (!pcgw.equals(__DEC_pcgw___conv_125424)) {
					if (!pgw.equals(__DEC_pcgw___conv_125424)) {
						return new Object[] { pcgw, pgw };
					}
				}
			}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_22_2_black_nac_0BB(ParallelGateway pgw,
			ParallelGateway pcgw) {
		if (!pcgw.equals(pgw)) {
			for (ParallelGateway __DEC_pgw___conv_167632 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(pgw, ParallelGateway.class, "__conv")) {
				if (!pgw.equals(__DEC_pgw___conv_167632)) {
					if (!pcgw.equals(__DEC_pgw___conv_167632)) {
						return new Object[] { pgw, pcgw };
					}
				}
			}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_22_2_black_nac_1BB(ParallelGateway pcgw,
			ParallelGateway pgw) {
		if (!pcgw.equals(pgw)) {
			ParallelGateway __DEC_pcgw___conv_639442 = pcgw.get__conv();
			if (__DEC_pcgw___conv_639442 != null) {
				if (!pcgw.equals(__DEC_pcgw___conv_639442)) {
					if (!pgw.equals(__DEC_pcgw___conv_639442)) {
						return new Object[] { pcgw, pgw };
					}
				}
			}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_22_2_black_nac_2BB(ParallelGateway pcgw,
			ParallelGateway pgw) {
		if (!pcgw.equals(pgw)) {
			for (ParallelGateway __DEC_pcgw___conv_891322 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(pcgw, ParallelGateway.class, "__conv")) {
				if (!pcgw.equals(__DEC_pcgw___conv_891322)) {
					if (!pgw.equals(__DEC_pcgw___conv_891322)) {
						return new Object[] { pcgw, pgw };
					}
				}
			}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_23_2_black_nac_0BB(ParallelGateway pgw,
			ParallelGateway pcgw) {
		if (!pcgw.equals(pgw)) {
			for (ParallelGateway __DEC_pgw___conv_282829 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(pgw, ParallelGateway.class, "__conv")) {
				if (!pgw.equals(__DEC_pgw___conv_282829)) {
					if (!pcgw.equals(__DEC_pgw___conv_282829)) {
						return new Object[] { pgw, pcgw };
					}
				}
			}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_23_2_black_nac_1BB(ParallelGateway pcgw,
			ParallelGateway pgw) {
		if (!pcgw.equals(pgw)) {
			ParallelGateway __DEC_pcgw___conv_506380 = pcgw.get__conv();
			if (__DEC_pcgw___conv_506380 != null) {
				if (!pcgw.equals(__DEC_pcgw___conv_506380)) {
					if (!pgw.equals(__DEC_pcgw___conv_506380)) {
						return new Object[] { pcgw, pgw };
					}
				}
			}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_23_2_black_nac_2BB(ParallelGateway pcgw,
			ParallelGateway pgw) {
		if (!pcgw.equals(pgw)) {
			for (ParallelGateway __DEC_pcgw___conv_740862 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(pcgw, ParallelGateway.class, "__conv")) {
				if (!pcgw.equals(__DEC_pcgw___conv_740862)) {
					if (!pgw.equals(__DEC_pcgw___conv_740862)) {
						return new Object[] { pcgw, pgw };
					}
				}
			}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_25_2_black_nac_0BB(ParallelGateway pgw,
			ParallelGateway pcgw) {
		if (!pcgw.equals(pgw)) {
			for (ParallelGateway __DEC_pgw___conv_511349 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(pgw, ParallelGateway.class, "__conv")) {
				if (!pgw.equals(__DEC_pgw___conv_511349)) {
					if (!pcgw.equals(__DEC_pgw___conv_511349)) {
						return new Object[] { pgw, pcgw };
					}
				}
			}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_25_2_black_nac_1BB(ParallelGateway pcgw,
			ParallelGateway pgw) {
		if (!pcgw.equals(pgw)) {
			ParallelGateway __DEC_pcgw___conv_230737 = pcgw.get__conv();
			if (__DEC_pcgw___conv_230737 != null) {
				if (!pcgw.equals(__DEC_pcgw___conv_230737)) {
					if (!pgw.equals(__DEC_pcgw___conv_230737)) {
						return new Object[] { pcgw, pgw };
					}
				}
			}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_25_2_black_nac_2BB(ParallelGateway pcgw,
			ParallelGateway pgw) {
		if (!pcgw.equals(pgw)) {
			for (ParallelGateway __DEC_pcgw___conv_470464 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(pcgw, ParallelGateway.class, "__conv")) {
				if (!pcgw.equals(__DEC_pcgw___conv_470464)) {
					if (!pgw.equals(__DEC_pcgw___conv_470464)) {
						return new Object[] { pcgw, pgw };
					}
				}
			}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_26_2_black_nac_0BB(ParallelGateway pgw,
			ParallelGateway pcgw) {
		if (!pcgw.equals(pgw)) {
			for (ParallelGateway __DEC_pgw___conv_419734 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(pgw, ParallelGateway.class, "__conv")) {
				if (!pgw.equals(__DEC_pgw___conv_419734)) {
					if (!pcgw.equals(__DEC_pgw___conv_419734)) {
						return new Object[] { pgw, pcgw };
					}
				}
			}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_26_2_black_nac_1BB(ParallelGateway pcgw,
			ParallelGateway pgw) {
		if (!pcgw.equals(pgw)) {
			ParallelGateway __DEC_pcgw___conv_751691 = pcgw.get__conv();
			if (__DEC_pcgw___conv_751691 != null) {
				if (!pcgw.equals(__DEC_pcgw___conv_751691)) {
					if (!pgw.equals(__DEC_pcgw___conv_751691)) {
						return new Object[] { pcgw, pgw };
					}
				}
			}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_26_2_black_nac_2BB(ParallelGateway pcgw,
			ParallelGateway pgw) {
		if (!pcgw.equals(pgw)) {
			for (ParallelGateway __DEC_pcgw___conv_936232 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(pcgw, ParallelGateway.class, "__conv")) {
				if (!pcgw.equals(__DEC_pcgw___conv_936232)) {
					if (!pgw.equals(__DEC_pcgw___conv_936232)) {
						return new Object[] { pcgw, pgw };
					}
				}
			}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_27_2_black_nac_0BB(ParallelGateway pgw,
			ParallelGateway pcgw) {
		if (!pcgw.equals(pgw)) {
			for (ParallelGateway __DEC_pgw___conv_741813 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(pgw, ParallelGateway.class, "__conv")) {
				if (!pgw.equals(__DEC_pgw___conv_741813)) {
					if (!pcgw.equals(__DEC_pgw___conv_741813)) {
						return new Object[] { pgw, pcgw };
					}
				}
			}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_27_2_black_nac_1BB(ParallelGateway pcgw,
			ParallelGateway pgw) {
		if (!pcgw.equals(pgw)) {
			ParallelGateway __DEC_pcgw___conv_721068 = pcgw.get__conv();
			if (__DEC_pcgw___conv_721068 != null) {
				if (!pcgw.equals(__DEC_pcgw___conv_721068)) {
					if (!pgw.equals(__DEC_pcgw___conv_721068)) {
						return new Object[] { pcgw, pgw };
					}
				}
			}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_27_2_black_nac_2BB(ParallelGateway pcgw,
			ParallelGateway pgw) {
		if (!pcgw.equals(pgw)) {
			for (ParallelGateway __DEC_pcgw___conv_69197 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(pcgw, ParallelGateway.class, "__conv")) {
				if (!pcgw.equals(__DEC_pcgw___conv_69197)) {
					if (!pgw.equals(__DEC_pcgw___conv_69197)) {
						return new Object[] { pcgw, pgw };
					}
				}
			}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_28_2_black_nac_0BB(ParallelGateway pgw,
			ParallelGateway pcgw) {
		if (!pcgw.equals(pgw)) {
			for (ParallelGateway __DEC_pgw___conv_901700 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(pgw, ParallelGateway.class, "__conv")) {
				if (!pgw.equals(__DEC_pgw___conv_901700)) {
					if (!pcgw.equals(__DEC_pgw___conv_901700)) {
						return new Object[] { pgw, pcgw };
					}
				}
			}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_28_2_black_nac_1BB(ParallelGateway pcgw,
			ParallelGateway pgw) {
		if (!pcgw.equals(pgw)) {
			ParallelGateway __DEC_pcgw___conv_564737 = pcgw.get__conv();
			if (__DEC_pcgw___conv_564737 != null) {
				if (!pcgw.equals(__DEC_pcgw___conv_564737)) {
					if (!pgw.equals(__DEC_pcgw___conv_564737)) {
						return new Object[] { pcgw, pgw };
					}
				}
			}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_28_2_black_nac_2BB(ParallelGateway pcgw,
			ParallelGateway pgw) {
		if (!pcgw.equals(pgw)) {
			for (ParallelGateway __DEC_pcgw___conv_117147 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(pcgw, ParallelGateway.class, "__conv")) {
				if (!pcgw.equals(__DEC_pcgw___conv_117147)) {
					if (!pgw.equals(__DEC_pcgw___conv_117147)) {
						return new Object[] { pcgw, pgw };
					}
				}
			}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_29_2_black_nac_0BB(ParallelGateway pgw,
			ParallelGateway pcgw) {
		if (!pcgw.equals(pgw)) {
			for (ParallelGateway __DEC_pgw___conv_973755 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(pgw, ParallelGateway.class, "__conv")) {
				if (!pgw.equals(__DEC_pgw___conv_973755)) {
					if (!pcgw.equals(__DEC_pgw___conv_973755)) {
						return new Object[] { pgw, pcgw };
					}
				}
			}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_29_2_black_nac_1BB(ParallelGateway pcgw,
			ParallelGateway pgw) {
		if (!pcgw.equals(pgw)) {
			ParallelGateway __DEC_pcgw___conv_623349 = pcgw.get__conv();
			if (__DEC_pcgw___conv_623349 != null) {
				if (!pcgw.equals(__DEC_pcgw___conv_623349)) {
					if (!pgw.equals(__DEC_pcgw___conv_623349)) {
						return new Object[] { pcgw, pgw };
					}
				}
			}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_29_2_black_nac_2BB(ParallelGateway pcgw,
			ParallelGateway pgw) {
		if (!pcgw.equals(pgw)) {
			for (ParallelGateway __DEC_pcgw___conv_564231 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(pcgw, ParallelGateway.class, "__conv")) {
				if (!pcgw.equals(__DEC_pcgw___conv_564231)) {
					if (!pgw.equals(__DEC_pcgw___conv_564231)) {
						return new Object[] { pcgw, pgw };
					}
				}
			}
	...
	public static final Iterable<Object[]> pattern_ParallelGateway2ParallelStepSeq_32_2_blackBBFBBBBBFBBBB(Task node,
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_32_2_greenBBBBBBBBBBBBFB(Task node,
			NormalStep prevStep, T2NS _t2ns1, ParallelStep step, SimpleBPMN.Process process, Flow flow,
			SequenceFlow sf1, ParallelGateway pgw, SF2F _sf2f1, ParallelGateway pcgw, SequenceFlow sf2,
		...
		isApplicableMatch.getAllContextElements().add(_sf2f1);
		isApplicableMatch.setRuleName(isApplicableMatch_ruleName_prime);
		return new Object[] { node, prevStep, _t2ns1, step, process, flow, sf1, pgw, _sf2f1, pcgw, sf2, sourceMatch,
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_32_3_bindingFBBBBBBBBBBBBBBB(
			ParallelGateway2ParallelStepSeq _this, IsApplicableMatchCC isApplicableMatch, Task node,
			NormalStep prevStep, T2NS _t2ns1, ParallelStep step, SimpleBPMN.Process process, Flow flow,
			SequenceFlow sf1, ParallelGateway pgw, SF2F _sf2f1, ParallelGateway pcgw, SequenceFlow sf2,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_CC(isApplicableMatch, node, prevStep, _t2ns1, step, process,
				flow, sf1, pgw, _sf2f1, pcgw, sf2, sourceMatch, targetMatch);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, node, prevStep, _t2ns1, step, process, flow, sf1, pgw,
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_32_3_bindingAndBlackFBBBBBBBBBBBBBBB(
		...
		Object[] result_pattern_ParallelGateway2ParallelStepSeq_32_3_binding = pattern_ParallelGateway2ParallelStepSeq_32_3_bindingFBBBBBBBBBBBBBBB(
				_this, isApplicableMatch, node, prevStep, _t2ns1, step, process, flow, sf1, pgw, _sf2f1, pcgw, sf2,
				sourceMatch, targetMatch);
									...
									if (tmpPgw instanceof ParallelGateway) {
										...
										if (tmp_sf2f1 instanceof SF2F) {
											...
											if (tmpPcgw instanceof ParallelGateway) {
												...
												if (tmpSf2 instanceof SequenceFlow) {
													SequenceFlow sf2 = (SequenceFlow) tmpSf2;
													return new Object[] { node, prevStep, _t2ns1, step, process, flow,
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_35_2_blackBBBBBBBBBBBB(Task node,
			NormalStep prevStep, T2NS _t2ns1, ParallelStep step, SimpleBPMN.Process process, Flow flow,
			SequenceFlow sf1, ParallelGateway pgw, SF2F _sf2f1, ParallelGateway pcgw, SequenceFlow sf2,
			IsApplicableMatchCC isApplicableMatch) {
		if (!sf1.equals(sf2)) {
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_35_2_bindingAndBlackFFFFFFFFFFFB(
		...
		if (result_pattern_ParallelGateway2ParallelStepSeq_35_2_binding != null) {
			Task node = (Task) result_pattern_ParallelGateway2ParallelStepSeq_35_2_binding[0];
			NormalStep prevStep = (NormalStep) result_pattern_ParallelGateway2ParallelStepSeq_35_2_binding[1];
			T2NS _t2ns1 = (T2NS) result_pattern_ParallelGateway2ParallelStepSeq_35_2_binding[2];
			...
			Object[] result_pattern_ParallelGateway2ParallelStepSeq_35_2_black = pattern_ParallelGateway2ParallelStepSeq_35_2_blackBBBBBBBBBBBB(
					node, prevStep, _t2ns1, step, process, flow, sf1, pgw, _sf2f1, pcgw, sf2, isApplicableMatch);
			if (result_pattern_ParallelGateway2ParallelStepSeq_35_2_black != null) {

				return new Object[] { node, prevStep, _t2ns1, step, process, flow, sf1, pgw, _sf2f1, pcgw, sf2,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_35_2_greenBBBBFFF(ParallelStep step, Flow flow,
		...
		_sf22f2.setSource(sf2);
		_sf22f2.setTarget(flow);
		return new Object[] { step, flow, pgw, sf2, result, _pg2ps, _sf22f2 };
	}
					...
					if (node != null) {
						...
						if (prevStep != null) {
							if (pattern_ParallelGateway2ParallelStepSeq_36_2_black_nac_1BB(ruleResult,
									_t2ns1) == null) {
								if (pattern_ParallelGateway2ParallelStepSeq_36_2_black_nac_0BB(ruleResult,
										node) == null) {
									if (pattern_ParallelGateway2ParallelStepSeq_36_2_black_nac_2BB(ruleResult,
											prevStep) == null) {
										for (SequenceFlow sf1 : node.getOutgoing()) {
											if (pattern_ParallelGateway2ParallelStepSeq_36_2_black_nac_4BB(ruleResult,
													sf1) == null) {
												for (SimpleBPMN.Process process : org.moflon.core.utilities.eMoflonEMFUtil
														.getOppositeReferenceTyped(node, SimpleBPMN.Process.class,
																"flowElements")) {
													if (process.getFlowElements().contains(sf1)) {
														if (pattern_ParallelGateway2ParallelStepSeq_36_2_black_nac_3BB(
															...
															for (SF2F _sf2f1 : org.moflon.core.utilities.eMoflonEMFUtil
																...
																if (flow != null) {
																	if (pattern_ParallelGateway2ParallelStepSeq_36_2_black_nac_5BB(
																		...
																		if (pattern_ParallelGateway2ParallelStepSeq_36_2_black_nac_6BB(
																				ruleResult, flow) == null) {
																			_result.add(new Object[] { _t2ns1List, node,
																					_t2ns1, prevStep, process, sf1,
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_36_3_bindingFBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, node, prevStep, _t2ns1, process,
				flow, sf1, _sf2f1, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, node, prevStep, _t2ns1, process, flow, sf1, _sf2f1,
					ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_36_3_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_ParallelGateway2ParallelStepSeq_36_3_binding = pattern_ParallelGateway2ParallelStepSeq_36_3_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, node, prevStep, _t2ns1, process, flow, sf1, _sf2f1, ruleResult);
	...
	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_36_5_blackBBBBBBB(Task node,
			NormalStep prevStep, T2NS _t2ns1, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, SF2F _sf2f1) {
		return new Object[] { node, prevStep, _t2ns1, process, flow, sf1, _sf2f1 };
	}

	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_36_6_blackBBBBBBBB(Task node,
			NormalStep prevStep, T2NS _t2ns1, SimpleBPMN.Process process, Flow flow, SequenceFlow sf1, SF2F _sf2f1,
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { node, prevStep, _t2ns1, process, flow, sf1, _sf2f1, ruleResult };
	}

	public static final Object[] pattern_ParallelGateway2ParallelStepSeq_36_6_greenBFBBBFFFFFBB(NormalStep prevStep,
		...
		return new Object[] { prevStep, step, process, flow, sf1, pgw, _pg2ps, pcgw, sf2, _sf22f2, ruleResult, csp };
	}
