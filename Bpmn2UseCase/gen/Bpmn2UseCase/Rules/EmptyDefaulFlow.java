...
public interface EmptyDefaulFlow extends EObject, AbstractRule {
	 ...
	 * @generated
	 */
	boolean isAppropriate_FWD(Match match, ExclusiveGateway gw, SimpleBPMN.Process process, ExclusiveGateway gcw,
			SequenceFlow sf);
	 ...
	 * @generated
	 */
	void registerObjectsToMatch_FWD(Match match, ExclusiveGateway gw, SimpleBPMN.Process process, ExclusiveGateway gcw,
			SequenceFlow sf);
	 ...
	 * @generated
	 */
	CSP isAppropriate_solveCsp_FWD(Match match, ExclusiveGateway gw, SimpleBPMN.Process process, ExclusiveGateway gcw,
			SequenceFlow sf);
