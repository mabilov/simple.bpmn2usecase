...
public class Bpmn2UseCaseTrafoScalabilityTest extends DebugSynchronizationHelper{

   public Bpmn2UseCaseTrafoScalabilityTest()
   {
   ...
   {
      Bpmn2UseCaseTrafoScalabilityTest helper = new Bpmn2UseCaseTrafoScalabilityTest();
      ...
      ModelGenerator gen = new ModelGenerator(Bpmn2UseCasePackage.eINSTANCE, controller, false, true);
   ...
   private static PrintWriter createWriter(int modelElementCount, DomainType domainType) throws IOException
   {
      ...
      file.mkdirs();
      String fileName = folderName + "/Bpmn2UseCase_" + modelElementCount + "_" + fwdBwd + ".txt";
